...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{tabular}{|l|c|}
      ...
      Local history, global table & 79.8\% \\
      Local history \& tables & 83.5\% \\
      Global history, local tables & \textbf{84.3\%} \\
      \hline
    \end{tabular}
    ...
    \begin{center}
      ...
      \begin{tikzpicture}[scale=0.7]
        ...
        % Legend box with clear background
        \fill[white] (7.2, 3.8) rectangle (9, 4.8);
        \draw[black] (7.2, 3.8) rectangle (9, 4.8);
        \fill[blue!60] (7.4, 4.4) rectangle (7.7, 4.6);
        \node[right] at (7.7, 4.5) {\tiny 2-bit counter};
        \fill[red!60] (7.4, 4) rectangle (7.7, 4.2);
        \node[right] at (7.7, 4.1) {\tiny Local hist.};
      \end{tikzpicture}
    \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{|l|c|c|c|}
      ...
      \hline
      All wrong & 0.0\% & 16,000,005 & baseline \\
      Bimodal & 78.9\% & 4,226,005 & 379\% \\
      Local & 83.5\% & 3,470,005 & 461\% \\
      Global hist + local count & 84.3\% & 3,342,005 & 479\% \\
      Perfect & 100.0\% & 1,000,005 & 1600\% \\
      \hline
    \end{tabular}
  \end{center}
