...
\usetikzlibrary{shapes.geometric, shapes.arrows, arrows, positioning, fit, backgrounds, calc, patterns}
...
\begin{tikzpicture}[
  ...
  % Level 1 - positioned relative to root and each other
  \node[box, anchor=north west, yshift=-0.2cm] (frontend) at (root.south west) {Frontend Bound};
  \node[box, anchor=west, right=0.1cm of frontend.east] (badspec) {Bad Speculation};
  \node[box, anchor=west, right=0.1cm of badspec.east] (retiring) {Retiring};
  \node[box, text width=4cm, align=center, anchor=west, right=0.1cm of retiring.east] (backend) {Backend Bound};

  % Level 2 - Frontend
  \node[smallbox, anchor=north west, below=0.1cm of frontend.south west] (latency) {Frontend Latency};
  \node[smallbox, anchor=west, right=0.1cm of latency.east] (bandwidth) {Band-width};
  ...
  \node[smallbox, below=0.1cm of memory.south, xshift=-1.2cm] {Stores Bound};
  \node[smallbox, below=0.1cm of memory.south, xshift=-0.3cm] {L1 Bound};
  \node[smallbox, below=0.1cm of memory.south, xshift=0.6cm] {L2 Bound};
  \node[smallbox, below=0.1cm of memory.south, xshift=1.5cm] {L3 Bound};
  \node[smallbox, below=0.1cm of memory.south, xshift=2.4cm] {Ext. Memory Bound};
