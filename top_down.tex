...
\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
  ...
  % Mux (trapezoid) - selecting between µop cache and ID
  \path[draw, fill=green!20] 
    (2.2,0.7) -- (2.2,-0.7) -- (3.0,-0.2) -- (3.0,0.2) -- cycle;
  ...
  \draw[->, thick] (id) -- (2.2,0);
  \draw[->, thick] (uopcache) -- (2.2,0.4);
  \draw[->, thick] (3.0,0) -- (uopqueue);
