...
\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
  ...
  % µop cache
  \node[draw, rectangle, fill=orange!30, minimum width=1.2cm, minimum height=0.7cm, align=center] (uopcache) at (2.8,1) {µop\\cache};
  
  % Trapezoid for µop queue - custom shape
  \begin{scope}
    \path[draw, fill=lightgray!50] 
      (3.3,0.4) -- (4.8,0.8) -- (4.8,-0.8) -- (3.3,-0.4) -- cycle;
    \node[align=center] at (4.05,0) {µop\\queue};
  \end{scope}
  ...
  \draw[->, thick] (id) -- (3.3,0);
  \draw[->, thick] (uopcache) -- (3.5,0.3);
  
  % Main connection with 4 µops label
  \draw[->, thick] (4.8,0) -- (6.5,0);
  \draw[thick] (5.55,0.2) -- (5.75,-0.2);
  \draw[thick] (5.55,-0.2) -- (5.75,0.2);
  \node[above] at (5.65,0.25) {\small 4};
  \node[below] at (5.65,-0.25) {\small µops};
  ...
  % IDQ Empty indicator
  \node[rectangle, rounded corners=2pt, fill=red, text=white, font=\small\bfseries, inner sep=4pt] at (4.1,1.8) {IDQ Empty};
  \draw[->, line width=2pt, red] (4.1,1.52) -- (4.1,0.85);
  
  % Alloc Stall indicator  
  \node[rectangle, rounded corners=2pt, fill=red, text=white, font=\small\bfseries, inner sep=4pt] at (5.8,1.8) {Alloc Stall};
  \draw[->, line width=2pt, red] (5.8,1.52) -- (5.8,0.25);
