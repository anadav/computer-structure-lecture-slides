...
\begin{tikzpicture}[scale=0.9, every node/.style={scale=0.9}]
  ...
  \draw[->, thick] (6.5,0) -- ++(0.5, 0) |- (rs.east); 
  \draw[->, thick] (6.5,0) -- ++(0.5, 0) |- (lb.east); 
  \draw[->, thick] (6.5,0) -- ++(0.5, 0) |- (sb.east); 
  \draw[->, thick] (6.5,0) -- ++(0.5, 0) |- (rob.east); 
  ...
  \node[single arrow, fill=red, text=white, font=\footnotesize\bfseries, minimum height=0.8cm, minimum width=1.5cm,
        single arrow head extend=0.15cm, inner sep=2pt, shape border rotate=180, anchor=west] (allocstall) at (idqempty.east) {Alloc Stall};
