...
\node[fetch, anchor=west] (f1) at (1, 0.8) {Inst\\Fetch};
...
\draw[->] ([xshift=-3mm]f1ins.north west) -- node[left, rotate=90, anchor=center] {\tiny program execution order} ([xshift=-3mm]f3ins.south west);
...
\node[fetch, anchor=west] (pf1) at (1, -3.1) {Inst\\Fetch};
...
% Vertical arrow for execution order - relative to instructions
\draw[->] ([xshift=-3mm]pf1ins.north west) -- node[left, rotate=90, anchor=center] {\tiny program execution order} ([xshift=-3mm]pf3ins.south west);
