...
\node[reg, anchor=west] (r1b) at (m1.east) {WB};
...
\node[reg, anchor=west] (r2b) at (m2.east) {WB};
...
\node[preg, anchor=west] (pr1b) at (pm1.east) {WB};

% Second instruction (pipelined - starts after first Inst Fetch)
\node[pfetch, anchor=north west] (pf2) at (pr1a.south east) {IF};
...
\node[preg, anchor=west] (pr2b) at (pm2.east) {WB};

% Third instruction (pipelined - starts after second Inst Fetch)
\node[pfetch, anchor=north west] (pf3) at (pr2a.south east) {IF};
...
\node[preg, anchor=west] (pr3b) at (pm3.east) {WB};
