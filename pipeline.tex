...
\begin{frame}{Control Hazard on Branches}
    ...
    \begin{tikzpicture}[
        ...
        % Decode Stage
        \node[component, fill=pink!30, minimum width=1.2cm, minimum height=1.8cm] (RF) at (4.5,2.6) {};
        \node[align=center] at ([yshift=-10]RF.north) {\footnotesize register\\[-3pt]\footnotesize file};
        ...
        \node[port, anchor=east] (rf_src1_data) at ([xshift=6mm, yshift=0.7mm]RF.center) {src1};
        \node[port, anchor=east] (rf_data1) at ([xshift=6mm, yshift=-0.8mm]RF.center) {data};
        ...
        \draw[->] ([yshift=-0.1mm]rf_data1.east) -- ([yshift=-0.1]rf_data1.east -| L2.west);
        \draw[->] (rf_data2.east) -- (rf_data2.east -| L2.west);
        \draw[->] (SignExt.east) -- (SignExt.east -| L2.west);
        
        % From L2 to Execute components
        \draw[->] ([yshift=-0.1mm]rf_data1.east -| L2.east) -- ++(0.2,0) |- (alu_input1);
