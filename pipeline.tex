...
% Timing annotations
\draw[<->] 
  ([yshift=-2mm]f1.south west) 
  -- node[below]{\scriptsize 8 ns} 
  ([yshift=-2mm]r1b.south east);

\draw[<->] 
  ([yshift=-2mm]f2.south west) 
  -- node[below]{\scriptsize 8 ns} 
  ([yshift=-2mm]r2b.south east);
...
% Second instruction (pipelined - starts after first Inst Fetch, with vertical spacing)
...
% Third instruction (pipelined - starts after second Inst Fetch, with vertical spacing)
