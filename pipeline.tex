...
\newcommand{\drawPipelineDiagram}[1][0,0]{%
    ...
    \begin{tikzpicture}[shift={(#1)},
        ...
        \node[muxdemux, muxdemux def={Lh=2, Rh=4, NL=1, NR=2, NB=1, w=1}, external pins width = 0,
        ...
        \node[muxdemux, muxdemux def={Lh=4, NL=2, Rh=2, NR=1, NB=0, NT=0, w=1.5, inset w=0.5, inset Lh=2, inset Rh=1.5},
        ...
        \node[muxdemux, muxdemux def={Lh=4, NL=2, Rh=2, NR=1, NB=1, w=1.5, inset w=0.5, inset Lh=2, inset Rh=1.5},
              external pins width = 0, scale=0.4, fill=blue!15] (ex_adder) at ($(L2.east)!0.5!(L3.west) + (0,1.56)$) {};
        ...
        \node[muxdemux, muxdemux def={Lh=4, Rh=2, NL=2, NR=1, NB=0, NT=0, w=1}, 
              external pins width = 0, scale=0.6, fill=green!20] (exemux) at ($(L2.east)!0.5!(L3.west) + (0,-0.32)$) {};
        ...
        \node[muxdemux, muxdemux def={Lh=4, Rh=2, NL=2, NR=1, w=1}, 
              external pins width = 0, scale=0.6, fill=green!20] (wbmux) at ($(L4.east) + (0.8,-0.21)$) {};
