...
\begin{frame}{Control Hazard on Branches}
    ...
    \begin{tikzpicture}[
        ...
        \coordinate (rf_selector) at ([xshift=-0.7cm, yshift=-0.7cm]RF.center);
        ...
        \node[port, anchor=east] (rf_data1) at ([xshift=0.6cm, yshift=-0.08cm]RF.center) {data};
        \node[port, anchor=east] (rf_src2_data) at ([xshift=0.6cm, yshift=-0.3cm]RF.center) {src2};
        \node[port, anchor=east] (rf_data2) at ([xshift=0.6cm, yshift=-0.45cm]RF.center) {data};
