...
\newcommand{\placeMux}[4][0]{%
    ...
    \ifnum#1=90
        ...
        \coordinate (#3mux_in1) at ([yshift=-2mm]#3mux.south);
        \coordinate (#3mux_in2) at ([yshift=2mm]#3mux.south);
    ...
    \else\ifnum#1=180
        ...
        \coordinate (#3mux_in1) at ([yshift=2mm]#3mux.west);
        \coordinate (#3mux_in2) at ([yshift=-2mm]#3mux.west);
...
\begin{frame}{Control Hazard on Branches}
    ...
    \begin{tikzpicture}[
        ...
        \draw[blue, thick, ->] (fe_adder_output) -- (fe_adder_output |- pcmux_in2) -- (pcmux_in2);
