...
\begin{frame}{Control Hazard on Branches}
    ...
    \begin{tikzpicture}[
        ...
        \coordinate (pcmux_in1) at ([xshift=-2mm]pcmux.north);
        \coordinate (pcmux_in2) at ([xshift=2mm]pcmux.north);
        \coordinate (pcmux_in3) at (pcmux.south);
        \coordinate (pcmux_out) at (pcmux.west);
        ...
        \begin{scope}[shift={(7,3.8)}, scale=0.8]
        ...
        \coordinate (exemux_in1) at ([yshift=4]exemux.south);
        \coordinate (exemux_in2) at ([yshift=-4]exemux.south);
        \coordinate (exemux_out) at (exemux.north);
        ...
        \coordinate (wbmux_in1) at (wbmux.north);
        \coordinate (wbmux_in2) at (wbmux.south);
        \coordinate (wbmux_out) at (wbmux.east);
