...
\newcommand{\placeMux}[4][0]{%
    \node[trapezium, trapezium left angle=70, trapezium right angle=70,
          trapezium stretches=true, minimum height=0.3, minimum width=1,
    ...
    \ifnum#1=90
        ...
        \coordinate (#3mux_in1) at ([yshift=-0.2]#3mux.south);
        \coordinate (#3mux_in2) at ([yshift=0.2]#3mux.south);
    ...
    \else\ifnum#1=180
        ...
        \coordinate (#3mux_in1) at ([yshift=0.2]#3mux.west);
        \coordinate (#3mux_in2) at ([yshift=-0.2]#3mux.west);
   ...
   \else\ifnum#1=270
    ...
    \else
        ...
        \coordinate (#3mux_in1) at ([yshift=0.2]#3mux.east);
        \coordinate (#3mux_in2) at ([yshift=-0.2]#3mux.east);
...
\begin{frame}{A Basic Processor}
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \node[draw, rectangle, minimum width=12, minimum height=6, dashed, align=center] {
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[scale=0.9]
        \node[draw, fill=orange!30, minimum width=2, minimum height=1] (chassis) {chassis};
        \node[draw, fill=green!30, minimum width=3, minimum height=1, right=0.5 of chassis] (engine) {engine};
        \node[draw, fill=blue!30, minimum width=2, minimum height=1, right=0.5 of engine] (finish) {finish};
        
        \node[above=0.1 of chassis] {1 hour};
        \node[above=0.1 of engine] {2 hours};
        \node[above=0.1 of finish] {1 hour};
        
        \node[below=0.5 of chassis] {Car 1};
    \end{tikzpicture}
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \node[draw, dashed, minimum width=10, minimum height=2] {
...
\begin{frame}{Pipelined CPU}
    ...
    \begin{tikzpicture}[scale=0.7]
        ...
        \node[draw, rectangle, minimum width=14, minimum height=7, dashed, align=center] {
...
\begin{frame}{Pipeline Example: cycle 1}
    \begin{columns}
        ...
        \begin{tikzpicture}[scale=0.6]
            \node[draw, dashed, minimum width=8, minimum height=3, align=center] {
...
\begin{frame}{RAW Dependency}
    \begin{columns}
        ...
        \begin{tikzpicture}[scale=0.5]
            ...
            \node[draw, fill=red!30, minimum width=6, minimum height=3] {
                RAW Hazard Area
            };
        \end{tikzpicture}
    \end{columns}
...
\begin{frame}{Using Bypass to Solve RAW Dependency}
    ...
    \centering
    \begin{tikzpicture}[scale=0.7]
        \node[draw, dashed, minimum width=10, minimum height=4] {
...
then stall
    ...
    \centering
    \begin{tikzpicture}[scale=0.6]
        \node[draw, fill=gray!30, minimum width=2, minimum height=1] {bubble};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Control Hazard on Branches}
    ...
    \scalebox{0.85}{%
    \begin{tikzpicture}[
        component/.style={draw, thick, minimum height=0.8},
        latch/.style={draw, thick, fill=yellow!20, minimum width=0.2, minimum height=4},
        stage/.style={font=\bfseries},
        label/.style={font=\tiny},
        port/.style={font=\tiny, inner sep=0.035}
    ]
        % Stage labels
        ...
        \node[component, fill=blue!20, minimum width=0.6, minimum height=0.6] (PC) at (0.5,2) {\small PC};


        % ICache
        \node[component, fill=purple!20, minimum width=1.2, minimum height=2] (ICache) at (2,2) {};
        \node[align=center] at (2,2.6) {\footnotesize inst.\\[-0.14]\footnotesize cache};
        ...
        % Decode Stage
        \node[component, fill=pink!30, minimum width=1.2, minimum height=1.8] (RF) at (4.5,2.6) {};
        \node[align=center] at ([yshift=-0.35]RF.north) {\footnotesize register\\[-0.11]\footnotesize file};
        ...
        \node[port] (rf_src1) at ([xshift=-0.4, yshift=0.1]RF.center) {~src1};
        \node[port] (rf_src2) at ([xshift=-0.4, yshift=-0.3]RF.center) {~src2};
        \node[port] (rf_dst) at ([xshift=-0.35, yshift=-0.7]RF.center) {dst};
        
        % Register file selector coordinate (slightly left of dst)
        \coordinate (rf_selector) at ([xshift=-0.7, yshift=-0.7]RF.center);
        
        % Register file output ports (right side, aligned to right edge)
        \node[port, anchor=east] (rf_src1_data) at ([xshift=0.6, yshift=0.07]RF.center) {src1};
        \node[port, anchor=east] (rf_data1) at ([xshift=0.6, yshift=-0.08]RF.center) {data};
        \node[port, anchor=east] (rf_src2_data) at ([xshift=0.6, yshift=-0.3]RF.center) {src2};
        \node[port, anchor=east] (rf_data2) at ([xshift=0.6, yshift=-0.45]RF.center) {data};
        
        % Sign extension - moved slightly right
        \node[component, fill=green!20, ellipse, minimum width=0.4, minimum height=0.3, align=center] (SignExt) at (5.1,0.7) {
            \scriptsize sign\\[-0.25]\scriptsize ext.
        };
        ...
        % Memory Stage
        \node[component, fill=brown!20, minimum width=1.2, minimum height=2] (DCache) at (10.8,2) {};
        \node[align=center] at (10.8,2.6) {\footnotesize data\\[-0.14]\footnotesize cache};

        % Data Cache ports (aligned to left side of box)
        \node[port, anchor=west] (dc_addr) at ([xshift=-0.62, yshift=0]DCache.center) {address};
        \node[port, anchor=west] (dc_data) at ([xshift=-0.62, yshift=-0.7]DCache.center) {data};

        % DCache output port
        \node[port, anchor=east] (dc_data_out) at ([xshift=0.65, yshift=0]DCache.center){};
        
        % Write Back Stage MUX (rotate=-90: output on east, inputs on north/south)
        \placeMux[270]{13.5,2}{wb}{green!20}
        ...
        \draw[->] (ICache -| L1.east) -- ++(0.3,0) node[yshift=0.55,rotate=90,above] {\tiny{}instruction}; 


        % From Register File outputs to L2
        \draw[->] ([yshift=-0.01]rf_data1.east) -- ([yshift=-0.01]rf_data1.east -| L2.west);
        \draw[->] (rf_data2.east) -- (rf_data2.east -| L2.west);
        \draw[->] (SignExt.east) -- (SignExt.east -| L2.west);
        
        % From L2 to Execute components
        \draw[->] ([yshift=-0.01]rf_data1.east -| L2.east) -- ++(0.2,0) |- (alu_input1);
...
\begin{frame}{Using The BTB}
    \centering
    \tiny
    \begin{tikzpicture}[scale=0.8, node distance=0.5]
        ...
        \draw[->] (hit) -| node[right] {no} ([xshift=6.5]inc);
