...
\newcommand{\drawPipelineDiagram}[1][0,0]{%
    ...
    \begin{tikzpicture}[shift={(#1)},
        ...
        \node[muxdemux, muxdemux def={Lh=2, Rh=4, NL=1, NR=2, NB=1, w=1}, 
              scale=0.6, fill=blue!20] (pcmux) at ($(origin) + (0.3,4.5)$) {};
        \node[font=\tiny] at (pcmux.center) {MUX};
        ...
        \node[muxdemux, muxdemux def={Lh=4, NL=2, Rh=2, NR=1, NB=1, w=1.5, inset w=0.5, inset Lh=2, inset Rh=1.5},
              scale=0.4, fill=blue!15] (fe_adder) at ($(PC.center) + (0.7,1.8)$) {};
        \node[font=\tiny] at (fe_adder.center) {+};
        \coordinate (fe_adder_input1) at (fe_adder.lpin 1);
        \coordinate (fe_adder_input2) at (fe_adder.lpin 2);
        \coordinate (fe_adder_output) at (fe_adder.rpin 1);
        ...
        \node[muxdemux, muxdemux def={Lh=4, NL=2, Rh=2, NR=1, NB=1, w=1.5, inset w=0.5, inset Lh=2, inset Rh=1.5},
              scale=0.4, fill=blue!15] (ex_adder) at ($(L2.east)!0.5!(L3.west) + (0,1.56)$) {};
        \node[font=\tiny] at (ex_adder.center) {+};
        \coordinate (ex_adder_input1) at (ex_adder.lpin 1);
        \coordinate (ex_adder_input2) at (ex_adder.lpin 2);
        \coordinate (ex_adder_output) at (ex_adder.rpin 1);
        ...
        \node[muxdemux, muxdemux def={Lh=4, Rh=2, NL=2, NR=1, w=1}, 
              scale=0.6, fill=green!20] (exemux) at ($(L2.east)!0.5!(L3.west) + (0,-0.32)$) {};
        \node[font=\tiny] at (exemux.center) {MUX};
        \coordinate (exemux_in1) at (exemux.lpin 1);
        \coordinate (exemux_in2) at (exemux.lpin 2);
        \coordinate (exemux_out) at (exemux.rpin 1);
        ...
        \node[muxdemux, muxdemux def={Lh=5, NL=2, Rh=2, NR=1, NB=2, NT=1, w=2, inset w=1, inset Lh=2, inset Rh=0, square pins=1},
              scale=0.5, fill=green!15] (ALU) at ($(L2.east)!0.65!(L3.west) + (0,0)$) {};
        \node[rotate=90, font=\tiny] at (ALU.center) {ALU};
        \coordinate (alu_input1) at (ALU.lpin 1);
        \coordinate (alu_input2) at (ALU.lpin 2);
        \coordinate (alu_output) at (ALU.rpin 1);
        ...
        \node[muxdemux, muxdemux def={Lh=4, Rh=2, NL=2, NR=1, w=1}, 
              scale=0.6, fill=green!20] (wbmux) at ($(L4.east) + (0.8,-0.21)$) {};
        \node[font=\tiny] at (wbmux.center) {MUX};
        \coordinate (wbmux_in1) at (wbmux.lpin 1);
        \coordinate (wbmux_in2) at (wbmux.lpin 2);
        \coordinate (wbmux_out) at (wbmux.rpin 1);
