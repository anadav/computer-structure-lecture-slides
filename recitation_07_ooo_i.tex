...
\pgfkeys{
    ...
    default/.style = {
        % RAT registers
        R1 = {}, R2 = {}, R3 = {}, R4 = {},
        % ROB cells (2 columns x 8 rows: instruction, status)
        rob01 = {}, rob02 = {},
        rob11 = {}, rob12 = {},
        rob21 = {}, rob22 = {},
        rob31 = {}, rob32 = {},
...
\newcommand{\OOODiagram}[1][]{%
    ...
    %
    % ROB (Reorder Buffer) - 3 columns (label, instruction, status)
    \matrix[matrix of nodes,
            column sep=-\pgflinewidth,
            row sep=-\pgflinewidth,
            inner sep=0pt,
    ...
    |[cell]| \scriptsize RB5 \& |[cell]| \scriptsize \robFiveOne  \& |[cell]| \scriptsize \robFiveTwo \\
    |[cell]| \scriptsize RB6 \& |[cell]| \scriptsize \robSixOne   \& |[cell]| \scriptsize \robSixTwo \\
    |[cell]| \scriptsize RB7 \& |[cell]| \scriptsize \robSevenOne \& |[cell]| \scriptsize \robSevenTwo \\
    };
    %
    % Instruction Queue - positioned right of RAT
    \node[cell, right=3cm of rat.north east, anchor=north west, font=\scriptsize, align=left, text width=3cm] (instq) {\instQueue};
    \node[above=0.1cm of instq, font=\small] {\textbf{Instruction Q}};
    %
...
\begin{frame}{Cycle 1: Initial State}
    ...
    \OOODiagram[
        R1={}, R2={}, R3={}, R4={},
        instq={DIV R2,R4,R3\\LD R3,R4(50)\\DIV R1,R2,R3\\ADD R2,R4,R3\\SUB R3,R2,R3}
    ]
...
\begin{frame}{Cycle 2: Decode First Instruction}
    ...
    \OOODiagram[
        R1={}, R2={\newentrya{RB0}}, R3={}, R4={},
        rob01={\newentrya{DIV R2,R4,R3}}, rob02={\newentrya{INV}},
        rs1={\newentrya{RB0=R4/R3}},
        instq={LD R3,R4(50)\\DIV R1,R2,R3\\ADD R2,R4,R3\\SUB R3,R2,R3}
    ]
...
\begin{frame}{Cycle 2: Fetch Second Instruction}
    ...
    \OOODiagram[
        ...
        rob01={\oldentry{DIV}}, rob02={\oldentry{R4,R3}},
        rob11={\newentryb{LD}}, rob12={\newentryb{R4(50)}},
        rs1={\oldentry{RB0=R4/R3}},
        mob1={\newentryb{RB1=R4(50)}},
        instq={DIV R1,R2,R3\\ADD R2,R4,R3\\SUB R3,R2,R3}
    ]
...
\begin{frame}{Cycle 3: Execution Starts}
    ...
    \OOODiagram[
        ...
        rob01={\oldentry{DIV}}, rob02={\oldentry{R4,R3}},
        rob11={\oldentry{LD}}, rob12={\oldentry{R4(50)}},
        exec1={\newentrya{RB0 (1/4)}},
        exec2={\newentryb{RB1 (1/2)}},
        instq={DIV R1,R2,R3\\ADD R2,R4,R3\\SUB R3,R2,R3}
    ]
...
\begin{frame}{Cycle 3: Decode Third Instruction}
    ...
    \OOODiagram[
        ...
        instq={ADD R2,R4,R3\\SUB R3,R2,R3}
    ]
...
\begin{frame}{Cycle 3: Fetch Fourth Instruction}
    ...
    \OOODiagram[
        ...
        rob01={\oldentry{DIV}}, rob02={\oldentry{R4,R3}},
        rob11={\oldentry{LD}}, rob12={\oldentry{R4(50)}},
        rob21={\oldentry{DIV}}, rob22={\oldentry{RB0,RB1}},
        rob31={\newentryb{ADD}}, rob32={\newentryb{R4,RB1}},
...
\begin{frame}{Cycle 4: Execution Continues}
    ...
    \OOODiagram[
        ...
        rob11={\oldentry{LD}}, rob12={\oldentry{R4(50)}},
        rob21={\oldentry{DIV}}, rob22={\oldentry{RB0,RB1}},
        rob31={\oldentry{ADD}}, rob32={\oldentry{R4,RB1}},
        rob41={\newentrya{SUB}}, rob42={\newentrya{RB3,RB1}},
        rs2={\oldentry{RB2=RB0/RB1}},
...
\begin{frame}{Cycle 5: LD Completes, Unblocks Dependents}
    ...
    \OOODiagram[
        ...
        rob11={\oldentry{LD}}, rob12={\oldentry{R4(50)}},
        rob21={\oldentry{DIV}}, rob22={\oldentry{RB0,RB1}},
        rob31={\oldentry{ADD}}, rob32={\srcentrya{R4,V1}},
        rob41={\oldentry{SUB}}, rob42={\srcentrya{RB3,V1}},
        rs2={\oldentry{RB2=RB0/RB1}},
...
\begin{frame}{Cycle 6: First DIV Completes}
    ...
    \OOODiagram[
        ...
        rob01={\oldentry{DIV}}, rob02={\oldentry{R4,R3}},
        rob11={\oldentry{LD}}, rob12={\oldentry{R4(50)}},
        rob21={\oldentry{DIV}}, rob22={\srcentrya{V0,V1}},
        rob31={\oldentry{ADD}}, rob32={\oldentry{R4,V1}},
        rob41={\oldentry{SUB}}, rob42={\srcentryb{V3,V1}},
