...
\newcommand{\OOODiagram}[1][]{%
    ...
    \matrix[matrix of nodes,
            ...
            anchor=north west,
            nodes={cell, font=\scriptsize, text width=3cm, align=left, minimum height=3mm, text height=1ex, text depth=0.25ex},
    ...
    \matrix[matrix of nodes,
            ...
            anchor=north west,
            nodes={cell, font=\tiny\ttfamily, text width=2.5cm, align=left},
    ...
    \node[cell, right=0.5cm of rs.north east, anchor=north west, font=\tiny\ttfamily, text width=2cm, align=left] (mob) {\mobOne};
...
\begin{frame}{Notation for Cycle-by-Cycle Walkthrough}
    \begin{block}{Execution Status Notation}
        In the \textbf{Execute} section, we show operations currently being executed with their \textbf{remaining cycle count} in parentheses.
...
\begin{frame}{Cycle 2: Decode First Instruction}
    ...
    \begin{block}{Actions}
        \begin{itemize}
            ...
            \item \textbf{RS:} Add entry RB0$\leftarrow$R4/R3 (operands ready)
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Cycle 2: Fetch Second Instruction}
    ...
    \OOODiagram[
        ...
        rob11={\newentryb{R3$\leftarrow$LD R4(50)}}, rob12={\newentryb{INV}},
        rs1={\oldentry{RB0$\leftarrow$R4/R3}},
        mob1={\newentryb{RB1=R4(50)}},
...
\begin{frame}{Cycle 3: Decode Third Instruction}
    ...
    \OOODiagram[
        ...
        rs2={\newentrya{RB2$\leftarrow$RB0/RB1}},
        exec1={\srcentrya{RB0$\leftarrow$R4/R3 (4)}},
...
\begin{frame}{Cycle 3: Fetch Fourth Instruction}
    ...
    \OOODiagram[
        ...
        rob31={\newentryb{R2$\leftarrow$R4+RB1}}, rob32={\newentryb{INV}},
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
        rs3={\newentryb{RB3$\leftarrow$R4+RB1}},
        exec1={\srcentrya{RB0$\leftarrow$R4/R3 (4)}},
        exec2={\srcentryb{RB1$\leftarrow$MEM(R4+50) (1)}},
...
\begin{frame}{Cycle 4: Execution Continues}
    ...
    \OOODiagram[
        ...
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
        rs3={\oldentry{RB3$\leftarrow$R4+RB1}},
        exec1={\oldentry{RB0$\leftarrow$R4/R3 (2)}},
        exec2={\oldentry{RB1$\leftarrow$MEM(R4+50) (1)}},
...
\begin{frame}{Cycle 5: LD Completes, Unblocks Dependents}
    ...
    \OOODiagram[
        ...
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
        rs3={\srcentrya{RB3$\leftarrow$R4+RB1}},
        exec1={\oldentry{RB0$\leftarrow$R4/R3 (2)}},
...
\begin{frame}{Cycle 6: First DIV Completes}
    ...
    \OOODiagram[
        ...
        rob41={\oldentry{R3$\leftarrow$RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\srcentrya{RB2$\leftarrow$RB0/RB1}},
...
\begin{frame}{Cycle 7: Retire RB0}
    ...
    \OOODiagram[
        ...
        rob11={\srcentrya{R3$\leftarrow$LD R4(50)}}, rob12={\srcentrya{OK}},
        rob21={\srcentryb{R1$\leftarrow$RB0/RB1}}, rob22={\srcentryb{INV}},
        rob31={\oldentry{R2$\leftarrow$R4+RB1}}, rob32={\oldentry{OK}},
        rob41={\oldentry{R3$\leftarrow$RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
...
\begin{frame}{Cycle 8: Retire RB1}
    ...
    \OOODiagram[
        ...
        rob31={\srcentryb{R2$\leftarrow$R4+RB1}}, rob32={\srcentryb{OK}},
        rob41={\oldentry{R3$\leftarrow$RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
        exec1={\oldentry{RB2$\leftarrow$RB0/RB1 (2)}},
        instq1={}, instq2={}, instq3={}, instq4={}, instq5={}
...
\begin{frame}{Cycle 9: Second DIV Completes}
    ...
    \OOODiagram[
        R1={\srcentrya{RB2}}, R2={\srcentryb{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob21={\srcentrya{R1$\leftarrow$RB0/RB1}}, rob22={\srcentrya{OK}},
        rob31={\srcentryb{R2$\leftarrow$R4+RB1}}, rob32={\srcentryb{OK}},
        rob41={\oldentry{R3$\leftarrow$RB3-RB1}}, rob42={\oldentry{INV}},
