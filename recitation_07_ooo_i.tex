...
\newcommand{\drawPipeline}[1][]{%
    ...
    \begin{tikzpicture}[scale=0.8, transform shape]
        ...
        \node[draw, fill=\pgfkeysvalueof{/pipeline/highlightdivider}, minimum width=0.6cm, minimum height=0.6cm, left=0.4cm of D2] (D1) {D1};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.4cm of D2] (D3) {D3};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.4cm of D3] (D4) {D4};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.4cm of D4] (D5) {D5};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.4cm of D5] (D6) {D6};
