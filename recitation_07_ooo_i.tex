...
\begin{frame}{Cycle 6: Execute Completed}
    ...
    \OOODiagram[
        ...
        rs1={\oldentry{RB4$\leftarrow$\textcolor{red}{RB3}-\textcolor{red}{RB1} [W]}},
        rs2={\oldentry{RB2$\leftarrow$\textcolor{red}{RB0}/\textcolor{red}{RB1} [W]}},
        rs3={\oldentry{RB3$\leftarrow$R4+\textcolor{red}{RB1} [W]}},
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB0 (DIV) and RB1 (LD) complete! Results written to ROB, both marked OK. RS still blocked: all entries waiting [W] on RB1 (not yet retired).
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
