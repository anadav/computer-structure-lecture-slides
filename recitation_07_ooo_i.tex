...
\begin{frame}{Cycle 1: Decode}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
...
\begin{frame}{Cycle 3: Execute}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB0 continues executing [4→3]. Address R4+50 computed and stored in MOB (ADD takes 1 cycle). LD not yet dispatched to execution.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 3: Decode}
    ...
    \OOODiagram[
        ...
        exec2={\newentrya{RB1$\leftarrow$MEM(R4+50) [2]}},
        mob1={\newentrya{RB1$\leftarrow$R4(50) [2]}},
...
\begin{frame}{Cycle 4: Decode}
    ...
    \OOODiagram[
        ...
        exec1={\srcentrya{RB0$\leftarrow$R4/R3 [3]}},
        instq1={~}, instq2={~}, instq3={SUB R3,R2,R3}, instq4={\newentryb{\sout{ADD R2,R4,R3}}}, instq5={~}
    ]
...
\begin{frame}{Cycle 5: Execute}
    ...
    \OOODiagram[
        ...
        instq1={~}, instq2={~}, instq3={SUB R3,R2,R3}, instq4={~}, instq5={~}
    ]
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB0 (DIV) continues at [2]. RB3 (ADD) dispatched from RS and executing at [1], will complete next cycle. RB1 ready to retire but waits for RB0.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 5: Decode}
    ...
    \OOODiagram[
        ...
        rob21={\oldentry{R1$\leftarrow$RB0/RB1}}, rob22={\oldentry{INV}},
        rob31={\oldentry{R2$\leftarrow$R4+RB1}}, rob32={\oldentry{INV}},
        rob41={\newentryb{R3$\leftarrow$RB3-RB1}}, rob42={\newentryb{INV}},
        rs1={\newentryb{RB4$\leftarrow$RB3-RB1}},
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
        rs3={\srcentrya{\sout{RB3$\leftarrow$R4+RB1}}},
        exec1={\oldentry{RB0$\leftarrow$R4/R3 [2]}},
        exec2={\srcentrya{RB3$\leftarrow$R4+RB1 [1]}},
        ret1={\oldentry{R3$\leftarrow$RB1}},
        instq1={~}, instq2={~}, instq3={~}, instq4={~}, instq5={\newentryb{\sout{SUB R3,R2,R3}}}
    ]
...
\begin{frame}{Cycle 6: Execute Completed}
    \centering
    \OOODiagram[
        ...
        rs1={\oldentry{RB4$\leftarrow$RB3-RB1}},
        rs2={\oldentry{RB2$\leftarrow$RB0/RB1}},
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB3 (ADD) completes execution, result written to ROB and marked OK. RB0 (DIV) continues at [1]. RB1 still waiting to retire.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 6: Execute}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB0 (DIV) and RB3 (ADD) complete, values written to ROB. RB2 now unblocked, starts executing [4]. RB0 still head of ROB, can't retire yet.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 7: Retire}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB0 retires, commits R2. ROB entry freed. RB2 continues at [3]. RB1 and RB3 ready to retire next.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 8: Retire}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB1 retires, commits R3. ROB entry freed. RB2 continues at [2]. RB3 ready to retire next.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 9: Execute}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB2 (DIV) completes, writes to ROB. RB4 (SUB) now unblocked, starts executing [1]. RB2 can't retire yet - waits for RB3.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 10: Retire}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB2 and RB3 retire together, committing R1 and R2. ROB entries freed. RB4 (SUB) completed, ready to retire.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Cycle 11: Retire}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                RB4 retires, commits R3. All instructions complete. ROB empty. RAT cleared. Program done in 11 cycles!
            \end{block}
        };
    \end{tikzpicture}
