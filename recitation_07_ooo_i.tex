...
\newcommand{\OOODiagram}[1][]{%
    ...
    %
    % Instruction Queue - positioned right of RAT (5 rows)
    \matrix[matrix of nodes,
            row sep=-\pgflinewidth,
            column sep=-\pgflinewidth,
            right=3cm of rat.north east,
            anchor=north west,
            nodes={cell, font=\scriptsize, text width=3cm, align=left, minimum height=4mm, text height=1ex, text depth=0.25ex},
            label={above:\textbf{Instruction Q}}] (instq) {
        \instQOne \\
        \instQTwo \\
        \instQThree \\
        \instQFour \\
    ...
    \matrix[matrix of nodes,
            ...
            anchor=north west,
            nodes={cell, font=\tiny, text width=2.5cm, align=left},
    ...
    \node[cell, right=0.5cm of rs.north east, anchor=north west, font=\tiny, text width=2cm, align=left] (mob) {\mobOne};
...
\begin{frame}{Detailed OOO Execution Example}
    ...
    \begin{alertblock}{Key Structures}
        \begin{itemize}
...
\begin{frame}{Example Program}
    \begin{exampleblock}{Program Listing}
        {\ttfamily\small
        \begin{tabular}{ll}
        (1) & DIV R2, R4, R3 \\
        (2) & LD R3, R4(50) \\
    ...
    \vspace{0.3cm}
    \begin{block}{Execution Latencies}
        \begin{itemize}
...
\begin{frame}{Cycle 1: Initial State}
    \centering
    \OOODiagram[
        R1={}, R2={}, R3={}, R4={},
        instq1={DIV R2,R4,R3}, instq2={LD R3,R4(50)}, instq3={DIV R1,R2,R3}, instq4={ADD R2,R4,R3}, instq5={SUB R3,R2,R3}
    ]

    \vspace{0.3cm}
    \begin{block}{State}
        \begin{itemize}
            \item All structures empty
            \item Instruction queue loaded with program
            \item Ready to fetch first instruction
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 2: Decode First Instruction}
    \centering
    \OOODiagram[
        R1={}, R2={\newentrya{RB0}}, R3={}, R4={},
        rob01={\newentrya{R2=R4/R3}}, rob02={\newentrya{INV}},
        rs1={\newentrya{RB0=R4/R3}},
        instq1={\newentrya{\sout{DIV R2,R4,R3}}}, instq2={LD R3,R4(50)}, instq3={DIV R1,R2,R3}, instq4={ADD R2,R4,R3}, instq5={SUB R3,R2,R3}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Decode:} DIV R2,R4,R3
            \item \textbf{RAT:} R2 $\rightarrow$ RB0 (new mapping)
            \item \textbf{ROB:} Allocate RB0 for DIV instruction
            \item \textbf{RS:} Add entry RB0=R4/R3 (operands ready)
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 2: Fetch Second Instruction}
    \centering
    \OOODiagram[
        R1={}, R2={\oldentry{RB0}}, R3={\newentryb{RB1}}, R4={},
        rob01={\oldentry{R2=R4/R3}}, rob02={\oldentry{INV}},
        rob11={\newentryb{R3=LD R4(50)}}, rob12={\newentryb{INV}},
        rs1={\oldentry{RB0=R4/R3}},
        mob1={\newentryb{RB1=R4(50)}},
        instq1={\oldentry{\sout{DIV R2,R4,R3}}}, instq2={\newentryb{\sout{LD R3,R4(50)}}}, instq3={DIV R1,R2,R3}, instq4={ADD R2,R4,R3}, instq5={SUB R3,R2,R3}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Fetch:} LD R3,R4(50)
            \item \textbf{RAT:} R3 $\rightarrow$ RB1
            \item \textbf{ROB:} Allocate RB1 for LD
            \item \textbf{MOB:} Add memory load entry RB1=R4(50)
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 3: Execution Starts}
    \centering
    \OOODiagram[
        R1={}, R2={\oldentry{RB0}}, R3={\oldentry{RB1}}, R4={},
        rob01={\oldentry{R2=R4/R3}}, rob02={\oldentry{INV}},
        rob11={\oldentry{R3=LD R4(50)}}, rob12={\oldentry{INV}},
        exec1={\newentrya{RB0$\leftarrow$R4/R3 (1)}},
        exec2={\newentryb{RB1$\leftarrow$MEM(R4+50) (1)}},
        instq1={DIV R1,R2,R3}, instq2={ADD R2,R4,R3}, instq3={SUB R3,R2,R3}, instq4={}, instq5={}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Execute:} RB0 (DIV) starts - cycle 1 of 4
            \item \textbf{Execute:} RB1 (LD) starts - cycle 1 of 2
            \item RS and MOB entries dispatched to execution units
            \item Both instructions execute in parallel!
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 3: Decode Third Instruction}
    \centering
    \OOODiagram[
        R1={\newentrya{RB2}}, R2={\oldentry{RB0}}, R3={\oldentry{RB1}}, R4={},
        rob01={\oldentry{R2=R4/R3}}, rob02={\oldentry{INV}},
        rob11={\oldentry{R3=LD R4(50)}}, rob12={\oldentry{INV}},
        rob21={\newentrya{R1=RB0/RB1}}, rob22={\newentrya{INV}},
        rs2={\newentrya{RB2=RB0/RB1}},
        exec1={\srcentrya{RB0$\leftarrow$R4/R3 (1)}},
        exec2={\srcentryb{RB1$\leftarrow$MEM(R4+50) (1)}},
        instq1={\oldentry{\sout{LD R3,R4(50)}}}, instq2={\newentrya{\sout{DIV R1,R2,R3}}}, instq3={ADD R2,R4,R3}, instq4={SUB R3,R2,R3}, instq5={}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Decode:} DIV R1,R2,R3
            \item \textbf{RAT:} R1 $\rightarrow$ RB2
            \item \textbf{RS:} RB2=P0/RB1 (operands NOT ready - waiting!)
            \item RB2 cannot execute until RB0 and RB1 complete
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 3: Fetch Fourth Instruction}
    \centering
    \OOODiagram[
        R1={\oldentry{RB2}}, R2={\newentryb{RB3}}, R3={\oldentry{RB1}}, R4={},
        rob01={\oldentry{R2=R4/R3}}, rob02={\oldentry{INV}},
        rob11={\oldentry{R3=LD R4(50)}}, rob12={\oldentry{INV}},
        rob21={\oldentry{R1=RB0/RB1}}, rob22={\oldentry{INV}},
        rob31={\newentryb{R2=R4+RB1}}, rob32={\newentryb{INV}},
        rs2={\oldentry{RB2=RB0/RB1}},
        rs3={\newentryb{RB3=R4+RB1}},
        exec1={\srcentrya{RB0$\leftarrow$R4/R3 (1)}},
        exec2={\srcentryb{RB1$\leftarrow$MEM(R4+50) (1)}},
        instq1={\oldentry{\sout{DIV R1,R2,R3}}}, instq2={\newentryb{\sout{ADD R2,R4,R3}}}, instq3={SUB R3,R2,R3}, instq4={}, instq5={}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Fetch:} ADD R2,R4,R3
            \item \textbf{RAT:} R2 $\rightarrow$ RB3 (new mapping, old RB0 in ROB)
            \item \textbf{RS:} RB3=R4+P1 (waiting for RB1)
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 4: Execution Continues}
    \centering
    \OOODiagram[
        ...
        rob11={\oldentry{R3=LD R4(50)}}, rob12={\oldentry{INV}},
        rob21={\oldentry{R1=RB0/RB1}}, rob22={\oldentry{INV}},
        rob31={\oldentry{R2=R4+RB1}}, rob32={\oldentry{INV}},
        rob41={\newentrya{R3=RB3-RB1}}, rob42={\newentrya{INV}},
        rs2={\oldentry{RB2=RB0/RB1}},
        rs3={\oldentry{RB3=R4+RB1}},
        exec1={\oldentry{RB0$\leftarrow$R4/R3 (2)}},
        exec2={\oldentry{RB1$\leftarrow$MEM(R4+50) (2)}},
        instq1={\oldentry{\sout{ADD R2,R4,R3}}}, instq2={\newentrya{\sout{SUB R3,R2,R3}}}, instq3={}, instq4={}, instq5={}
    ]

    \vspace{0.3cm}
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Decode:} SUB R3,R2,R3
            \item \textbf{RAT:} R3 $\rightarrow$ RB4
            \item \textbf{Execute:} RB0 at cycle 2/4, RB1 at cycle 2/2
            \item RB1 (LD) completes this cycle!
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 5: LD Completes, Unblocks Dependents}
    \centering
    \OOODiagram[
        ...
        rob21={\oldentry{R1=RB0/RB1}}, rob22={\oldentry{INV}},
        rob31={\oldentry{R2=R4+RB1}}, rob32={\oldentry{INV}},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\oldentry{RB2=RB0/RB1}},
        rs3={\srcentrya{RB3=R4+RB1}},
        exec1={\oldentry{RB0$\leftarrow$R4/R3 (3)}},
        exec2={\newentrya{RB3$\leftarrow$R4+RB1 (1)}},
        ret1={\newentrya{RB1=V}},
        instq1={}, instq2={}, instq3={}, instq4={}, instq5={}
    ]
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Complete:} RB1 (LD) writes value to ROB
            \item \textbf{Unblock:} RB3 can now execute (R4+RB1 ready)
            \item \textbf{Execute:} RB0 at 3/4, RB3 starts (1/1)
            \item \textbf{Retire:} RB0 not done yet, so RB1 waits
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 6: First DIV Completes}
    \centering
    \OOODiagram[
        R1={\oldentry{RB2}}, R2={\oldentry{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob01={\oldentry{R2=R4/R3}}, rob02={\oldentry{OK}},
        rob11={\oldentry{R3=LD R4(50)}}, rob12={\oldentry{OK}},
        rob21={\oldentry{R1=RB0/RB1}}, rob22={\oldentry{INV}},
        rob31={\oldentry{R2=R4+RB1}}, rob32={\oldentry{OK}},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\srcentrya{RB2=RB0/RB1}},
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Complete:} RB0 (DIV) and RB3 (ADD) write values
            \item \textbf{Unblock:} RB2 can now execute (RB0/RB1 ready)
            \item \textbf{Execute:} RB2 starts (1/4)
            \item \textbf{Retire:} Still waiting to retire RB0
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 7: Retire RB0}
    \centering
    \OOODiagram[
        R1={\srcentrya{RB2}}, R2={\srcentryb{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob11={\srcentrya{R3=LD R4(50)}}, rob12={\srcentrya{OK}},
        rob21={\srcentryb{R1=RB0/RB1}}, rob22={\srcentryb{INV}},
        rob31={\oldentry{R2=R4+RB1}}, rob32={\oldentry{OK}},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\oldentry{RB2=RB0/RB1}},
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Retire:} RB0 commits to R2, ROB entry freed
            \item \textbf{Execute:} RB2 continues (2/4)
            \item RB1 and RB3 ready to retire next
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 8: Retire RB1}
    \centering
    \OOODiagram[
        R1={\srcentrya{RB2}}, R2={\srcentryb{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob21={\srcentrya{R1=RB0/RB1}}, rob22={\srcentrya{INV}},
        rob31={\srcentryb{R2=R4+RB1}}, rob32={\srcentryb{OK}},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{INV}},
        rs2={\oldentry{RB2=RB0/RB1}},
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Retire:} RB1 commits to R3, ROB entry freed
            \item \textbf{Execute:} RB2 continues (3/4)
            \item RB3 ready to retire next
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 9: Second DIV Completes}
    \centering
    \OOODiagram[
        R1={\srcentrya{RB2}}, R2={\srcentryb{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob21={\srcentrya{R1=RB0/RB1}}, rob22={\srcentrya{OK}},
        rob31={\srcentryb{R2=R4+RB1}}, rob32={\srcentryb{OK}},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{INV}},
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Complete:} RB2 (DIV) completes, writes to ROB
            \item \textbf{Unblock:} RB4 (SUB) can now execute
            \item \textbf{Execute:} RB4 executes (1/1)
            \item RB2 cannot retire yet (must wait for RB3)
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 10: Retire RB2 and RB3}
    \centering
    \OOODiagram[
        R1={\oldentry{RB2}}, R2={\oldentry{RB3}}, R3={\oldentry{RB4}}, R4={},
        rob41={\oldentry{R3=RB3-RB1}}, rob42={\oldentry{OK}},
        ret1={\newentrya{RB4=V}},
        instq1={}, instq2={}, instq3={}, instq4={}, instq5={}
    ]
    ...
    \begin{block}{Actions}
        \begin{itemize}
            \item \textbf{Retire:} RB2 commits to R1 (freed)
            \item \textbf{Retire:} RB3 commits to R2 (freed)
            \item RB4 (SUB) completed and ready to retire
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Cycle 11: Retire RB4 - Program Complete}
    \centering
    \OOODiagram[
        R1={\srcentrya{}}, R2={\srcentryb{}}, R3={\oldentry{}}, R4={},
        instq1={}, instq2={}, instq3={}, instq4={}, instq5={}
    ]
    ...
    \begin{block}{Final State}
        \begin{itemize}
            \item \textbf{Retire:} RB4 commits to R3 (freed)
            \item All instructions completed and retired
            \item All ROB entries freed
            \item Program execution complete!
        \end{itemize}
    \end{block}
