...
\begin{frame}{ROB Question - Part 1: Identify Dependencies}
    \begin{columns}[T]
        ...
        \only<2->{
            \begin{columns}
                ...
                {\ttfamily\scriptsize
                (1) DIV R1, R2, R3\\
                (2) ADD \textcolor{red}{R2}, R4, R1\\
                (3) ADD \textcolor{red}{R2}, R3, R3\\
                (4) ADD R4, R3, R2
                }

                \tikz[remember picture, overlay] {
                    \draw[->, red, thick] (-0.5,-0.8) to[bend left=30] (-0.5,-1.3);
                }
                ...
                {\ttfamily\scriptsize
                (1) DIV R1, R2, R3\\
                (2) ADD R2, \textcolor{blue}{R4}, R1\\
                (3) ADD R2, R3, R3\\
                (4) ADD \textcolor{blue}{R4}, R3, R2
                }

                \tikz[remember picture, overlay] {
                    \draw[->, blue, thick] (-0.5,-0.8) to[bend left=30] (-0.5,-1.8);
                }
            \end{columns}
...
\begin{frame}{ROB Question - Part 2: After Decode}
