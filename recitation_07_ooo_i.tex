...
\newcommand{\drawPipeline}[1][]{%
    ...
    \begin{tikzpicture}[scale=0.8, transform shape]
        ...
        \node[draw, fill=\pgfkeysvalueof{/pipeline/highlightD2}, minimum width=0.6cm, minimum height=0.6cm] (D2) at ($(M1) + (0,-\pgfkeysvalueof{/pipeline/yspacing})$) {D2};
        ...
        \node[draw, fill=\pgfkeysvalueof{/pipeline/highlightinteger}, minimum width=1cm, minimum height=0.6cm] (EX) at ($(M2)!0.5!(M3) + (0,\pgfkeysvalueof{/pipeline/yspacing})$) {EX};
