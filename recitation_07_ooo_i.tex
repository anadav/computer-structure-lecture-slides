...
\begin{frame}{Cycle 9: Commit}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south west, text width=5cm, font=\small] at (current page.south west) {
            \begin{block}{What's Happening}
                No commit can take place. RB2 is at the head of ROB but still INV (not complete). Despite RB3 and RB4 being OK and ready, they cannot commit - must commit in-order.
            \end{block}
        };
    \end{tikzpicture}
\end{frame}
