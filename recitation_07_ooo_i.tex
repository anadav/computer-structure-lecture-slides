...
\newcommand{\drawPipeline}[1][]{%
    ...
    \begin{tikzpicture}[scale=0.8, transform shape]
        ...
        \node[draw, fill=\pgfkeysvalueof{/pipeline/highlightmultiply}, minimum width=0.8cm, minimum height=0.6cm, right=2cm of ID.east] (M1) {M1};
        \node[draw, fill=white, minimum width=0.8cm, minimum height=0.6cm, right=0.5cm of M1] (M2) {M2};
        \node[draw, fill=white, minimum width=0.8cm, minimum height=0.6cm, right=0.5cm of M2] (M3) {M3};
        \node[draw, fill=white, minimum width=0.8cm, minimum height=0.6cm, right=0.5cm of M3] (M4) {M4};
        
        % Divider pipeline (multi-stage)
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm] (D2) at ($(M1) + (0,-1.2)$) {D2};
        \node[draw, fill=\pgfkeysvalueof{/pipeline/highlightdivider}, minimum width=0.6cm, minimum height=0.6cm, left=0.5cm of D2] (D1) {D1};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.5cm of D2] (D3) {D3};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.5cm of D3] (D4) {D4};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.5cm of D4] (D5) {D5};
        \node[draw, fill=white, minimum width=0.6cm, minimum height=0.6cm, right=0.5cm of D5] (D6) {D6};
        ...
        \node[draw, fill=\pgfkeysvalueof{/pipeline/memcolor}, minimum width=1.2cm, minimum height=0.8cm, right=2cm of M4.west] (MEM) {MEM};
