...
\begin{frame}{How Does a Multiply Instruction Progress Through the Pipeline?}
    \centering
    \drawPipeline[
        spaced=true,
        instructions={R2 $\leftarrow$ R3*R3}
    ]
    \vspace{0.3cm}
