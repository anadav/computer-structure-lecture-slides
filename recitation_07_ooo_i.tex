...
\begin{frame}{Structure Interaction (Intel CPUs)}
    ...
    \begin{tikzpicture}[font=\tiny]
        ...
        % RAT below IDQ
        \node[fill=green!20, inner sep=5pt, below=0.4cm of idq] (rat) {
        ...
        \node[fill=cyan!20, inner sep=5pt, below=0.8cm of rat.south, anchor=north, xshift=-3.5cm] (rob) {
            ...
            \hline
            \textbf{Phys} & \textbf{Alloc} & \multicolumn{2}{c|}{\textbf{Data}} & \textbf{Arch} \\
            \textbf{Reg} & & \textbf{Valid} & \textbf{Value} & \textbf{Reg} \\
            \hline
            19 & V & V & 12 & RBX \\
            \hdashline[2pt/2pt]
            23 & V & V & 33 & RCX \\
        ...
        \node[fill=orange!20, inner sep=5pt, below=0.8cm of rat.south, anchor=north, xshift=3.5cm] (rs) {
            \begin{minipage}{5cm}
            \centering
            \textbf{RS}
            ...
            \hline
             ...
             & \textbf{Valid} & \textbf{Value} & \textbf{Valid} & \textbf{Value} & \\
            \hline
            ...
            \raggedright
            \tiny
            \textcolor{blue!70!black}{Blue}: from RRF\\
        ...
        \node[fill=blue!15, inner sep=5pt, below=0.3cm of rob.south, anchor=north] (rrf) {
            ...
            \begin{tabular}{|c|c|c|}
            \hline
            0 & RAX & \textcolor{blue!70!black}{97H} \\
            \hline
            \end{tabular}
            \end{minipage}
        };
