...
\begin{tikzpicture}[
    ...
    stlbcache/.style={muxcache, fill=white},
...
% PTE connections from TLBs to STLB
\draw[arrow] (insttlb) to[bend right=15] node[near start, left, label] {PTE} (stlb.north west);
\draw[arrow] (datatlb) to[bend left=15] node[near start, left, label] {PTE} (stlb.north east);
