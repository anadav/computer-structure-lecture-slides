...
\draw[decorate, decoration={brace, amplitude=5pt, mirror}] (vaA_bit13) -- (vaA_bit6) node[midway, below=3pt, font=\scriptsize, blue] (vaA_set_label) {Set: [13:6] = 1};
...
\node[addrbox, fill=orange!70, minimum width=2.5cm] (pa_pfn) at ($(vaA_vpn)!0.5!(vbB_vpn) + (0, -3.5)$) {0...0000};
...
\draw[myarrow, red, thick] (vaA_set_label.south) -- ++(0,-0.3) -| (pa_pfn_label.north);
\draw[myarrow, red, thick] (vbB_set_label.south) -- ++(0,-0.3) -| (pa_pfn_label.north);

\end{tikzpicture}
\end{center}

\vspace{0.5em}
Bits [13:12] differ (01 vs 00) but map to same physical page
