...
\node[font=\scriptsize, text=mygreen, anchor=north west] at (addr1.south west) {3 new tables + 1 page};}
...
\node[font=\scriptsize, text=mygreen, anchor=north west] at ([xshift=2mm,yshift=4mm]addr2.south west) {0 new tables};}
...
\node[font=\scriptsize, text=mygreen, anchor=north west] at (addr3.south west) {0 new tables + 1 page};}
...
\node[font=\scriptsize, text=mygreen, anchor=north west] at (addr4.south west) {1 new table + 1 page};}
...
\node[font=\scriptsize, text=mygreen, anchor=north west] at (addr5.south west) {3 new tables + 1 page};}
