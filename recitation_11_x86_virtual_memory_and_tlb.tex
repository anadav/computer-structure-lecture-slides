...
\begin{tikzpicture}[scale=0.18, font=\tiny]
  ...
  \coordinate (b59) at ($(b62) + (4,0)$);   % PKE is 4 bits wide (62-59)
...
%  \node[above] at ($(b52) + (0,\boxheight+0.3)$) {52};
  ...
  \node[above] at ($(b9)!0.5!(b8) + (0,\boxheight+0.3)$) {8};
  ...
  \node[above] at ($(b5)!0.5!(b4) + (0,\boxheight+0.3)$) {4};
