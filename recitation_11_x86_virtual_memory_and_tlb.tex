...
\begin{tikzpicture}[scale=0.18, font=\tiny]
  ...
  % Fields from MSB (63) to LSB (0) - displayed left to right
  % XD bit (63)
  \fill[fieldblue!30] (0,0) rectangle (1,\boxheight);
  \draw[thick] (1,0) -- (1,\boxheight);
  \node[rotate=270, font=\tiny] at (0.5,1.5) {Execute Disable};
  \node[above] at (0.5,\boxheight+0.3) {63};
  
  % Protection Key (59-62)
  \fill[fieldblue!30] (1,0) rectangle (5,\boxheight);
  \draw[thick] (5,0) -- (5,\boxheight);
  \node at (3,1.5) {PKE};
  \node[above] at (1,\boxheight+0.3) {62};
  \node[above] at (5,\boxheight+0.3) {59};
  
  % Available bits (52-58)
  \fill[fieldgray!30] (5,0) rectangle (12,\boxheight);
  \draw[thick] (12,0) -- (12,\boxheight);
  \node at (8.5,1.5) {Available};
  \node[above] at (5,\boxheight+0.3) {58};
  \node[above] at (12,\boxheight+0.3) {52};
  
  % Page Frame Address (12-51)
  \fill[fieldpurple!30] (12,0) rectangle (52,\boxheight);
  \draw[thick] (52,0) -- (52,\boxheight);
  \node at (32,1.5) {Page Frame Address [51:12]};
  \node[above] at (12,\boxheight+0.3) {51};
  \node[above] at (52,\boxheight+0.3) {12};
  
  % AVL bits (9-11)
  \fill[fieldgray!30] (52,0) rectangle (55,\boxheight);
  \draw[thick] (55,0) -- (55,\boxheight);
  \node at (53.5,1.5) {AVL};
  \node[above] at (52,\boxheight+0.3) {11};
  \node[above] at (55,\boxheight+0.3) {9};
  
  % G bit (8)
  \fill[fieldcyan!30] (55,0) rectangle (56,\boxheight);
  \draw[thick] (56,0) -- (56,\boxheight);
  \node[rotate=270, font=\tiny] at (55.5,1.5) {Global};
  \node[above] at (55.5,\boxheight+0.3) {8};
  
  % PAT bit (7)
  \fill[fieldorange!30] (56,0) rectangle (57,\boxheight);
  \draw[thick] (57,0) -- (57,\boxheight);
  \node[rotate=270, font=\tiny] at (56.5,1.5) {Page Attr Table};
  \node[above] at (56.5,\boxheight+0.3) {7};
  
  % D bit (6)
  \fill[fieldgreen!30] (57,0) rectangle (58,\boxheight);
  \draw[thick] (58,0) -- (58,\boxheight);
  \node[rotate=270, font=\tiny] at (57.5,1.5) {Dirty};
  \node[above] at (57.5,\boxheight+0.3) {6};
  
  % A bit (5)
  \fill[fieldgreen!30] (58,0) rectangle (59,\boxheight);
  \draw[thick] (59,0) -- (59,\boxheight);
  \node[rotate=270, font=\tiny] at (58.5,1.5) {Accessed};
  \node[above] at (58.5,\boxheight+0.3) {5};
  
  % PCD bit (4)
  \fill[fieldorange!30] (59,0) rectangle (60,\boxheight);
  \draw[thick] (60,0) -- (60,\boxheight);
  \node[rotate=270, font=\tiny] at (59.5,1.5) {Cache Disable};
  \node[above] at (59.5,\boxheight+0.3) {4};
  
  % PWT bit (3)
  \fill[fieldorange!30] (60,0) rectangle (61,\boxheight);
  \draw[thick] (61,0) -- (61,\boxheight);
  \node[rotate=270, font=\tiny] at (60.5,1.5) {Write-Through};
  \node[above] at (60.5,\boxheight+0.3) {3};
  
  % U/S bit (2)
  \fill[fieldblue!30] (61,0) rectangle (62,\boxheight);
  \draw[thick] (62,0) -- (62,\boxheight);
  \node[rotate=270, font=\tiny] at (61.5,1.5) {User/Supervisor};
  \node[above] at (61.5,\boxheight+0.3) {2};
  
  % W bit (1)
  \fill[fieldblue!30] (62,0) rectangle (63,\boxheight);
  \draw[thick] (63,0) -- (63,\boxheight);
  \node[rotate=270, font=\tiny] at (62.5,1.5) {Writable};
  \node[above] at (62.5,\boxheight+0.3) {1};
  
  % P bit (0) - LSB on the right
  \fill[fieldblue!30] (63,0) rectangle (64,\boxheight);
  \node[rotate=270] at (63.5,1.5) {Present};
  \node[above] at (63.5,\boxheight+0.3) {0};
