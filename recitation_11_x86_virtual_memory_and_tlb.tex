...
\node[mylabel, above=1mm of vaA_vpn] (vaA_vpn_label) {VPN};
\node[mylabel, above=1mm of vaA_offset] (vaA_offset_label) {Offset};
...
% PFN label above PA
\node[mylabel, above=1mm of paA_pfn] {PFN};
...
\node[mylabel, above=1mm of vbB_vpn] (vbB_vpn_label) {VPN};
\node[mylabel, above=1mm of vbB_offset] (vbB_offset_label) {Offset};
...
\node[font=\footnotesize, left=2mm of pbB_pfn] {PB:};
