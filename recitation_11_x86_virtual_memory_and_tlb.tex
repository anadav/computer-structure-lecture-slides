...
\begin{tikzpicture}[node distance=1cm and 1.5cm, auto]
    ...
    % TLB path
    \node[draw, rectangle, fill=orange!20, below=of va, xshift=-2cm, align=center] (tlb) {Access\\TLB};
    \node[draw, diamond, below=of tlb, aspect=1.5, align=center] (tlbhit) {TLB\\Hit?};
    \node[draw, diamond, left=of tlbhit, aspect=1.5, align=center] (stlbhit) {STLB\\Hit?};
    \node[draw, rectangle, above=of stlbhit, xshift=-1cm, align=center] (pw) {Page Walk:\\get PTE from\\memory\\hierarchy};
    
    % Cache path
    \node[draw, rectangle, fill=green!20, below=of va, xshift=2cm, align=center] (cache) {Access\\Cache};
    \node[draw, diamond, below=of cache, aspect=1.5, align=center] (l1hit) {L1\\Cache\\Hit?};
    \node[draw, diamond, right=of l1hit, aspect=1.5, align=center] (l2hit) {L2\\Cache\\Hit?};
    \node[draw, rectangle, right=of l2hit, align=center] (mem) {Access\\Memory};
    
    % Result nodes
    \node[draw, ellipse, fill=blue!20, below=of tlbhit, yshift=-0.5cm, align=center] (pa) {Physical\\Address};
    \node[draw, ellipse, fill=green!20, below=of l1hit, yshift=-0.5cm] (data) {Data};
