...
\node[addrbox, fill=green!20, minimum width=2cm, anchor=east] (paA_pfn) at (paA_offset.west) {0...0000};
...
\node[addrbox, fill=green!20, minimum width=2cm, anchor=east] (pbB_pfn) at (pbB_offset.west) {0...0011};
...
\node[addrbox, fill=green!20, minimum width=2cm] (vaA_vpn) at (0, 2) {xxxx...01};
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=west] (vaA_offset) at (vaA_vpn.east) {0000 0000 0000};
\node[font=\footnotesize, left=2mm of vaA_vpn] (vaA_label) {VA:};
...
\node[addrbox, fill=green!20, minimum width=2cm] (vbB_vpn) at (7.5, 2) {yyyy...00};
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=west] (vbB_offset) at (vbB_vpn.east) {0000 0000 0000};
\node[font=\footnotesize, left=2mm of vbB_vpn] (vbB_label) {VB:};
...
\node[addrbox, fill=orange!30, minimum width=2.5cm] (pa_pfn) at ($(vaA_vpn)!0.5!(vbB_vpn) + (0, -2.5)$) {zzzz};
...
\draw[myarrow, red, thick] (vaA_vpn.south) -- ++(0,-0.5) -| (pa_pfn_label.north);
\draw[myarrow, red, thick] (vbB_vpn.south) -- ++(0,-0.5) -| (pa_pfn_label.north);
