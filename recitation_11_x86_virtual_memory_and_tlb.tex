...
%  \node[above] at ($(b52) + (0,\boxheight+0.3)$) {52};
  ...
  \node[below, align=left, text=fieldblue!70!black, above=0mm of lblXD.east, anchor=south east] (lblPKE) {Protection Key};
  \draw[-|, fieldblue!60!black] (lblPKE.east) -| ($(b62.north)!0.5!(b59.north) + (0, \boxheight)$);
  
  % Available (52-58)
  \node[below, align=left, text=fieldgray!70!black, above=0mm of lblPKE.east, anchor=south east] (lblAVL2) {Available};
