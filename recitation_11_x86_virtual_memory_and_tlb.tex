...
% Set index arrow - from set.south to tag0.west using |-
\draw[myarrow, cyan!70] (set.south) |- (tag0.west);
...
\node[comparator] (comp0) at ([xshift=0.3cm, yshift=-0.6cm]way0.south east) {=};
