...
\textbf{Analysis:}
\begin{itemize}
    \item<1-> 12 bits [11:0] are not translated (page offset)
...
\begin{frame}{Question 3 (cont.): What if we didn't use [13:12] for tag?}
...
\node[mylabel, anchor=south] (vaA_offset_label) at (vaA_offset.north) {Offset};
...
\node[mylabel, anchor=south] (vbB_offset_label) at (vbB_offset.north) {Offset};
...
\begin{frame}{Question 3 (cont.): Virtual Aliasing}
