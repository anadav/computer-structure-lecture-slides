...
\vspace{0.5em}
\textbf{Linear Address Space breakdown:}

\vspace{0.3em}
\textbf{4KB Page:} \vmaddressbreakdown{0}{0}{0}{10}{10}{12}

\vspace{0.3em}
\textbf{4MB Page:} \vmaddressbreakdown{0}{0}{0}{10}{0}{22}
\end{frame}

% Slide 4: PDE and PTE Format
\begin{frame}{32-bit Mode: PDE and PTE Format}
\centering
\textbf{Page Directory Entry (PDE) - 4KB page table}\\[0.5em]

\begin{tikzpicture}[scale=0.26, font=\tiny]
  \def\boxheight{4}

  % Define key coordinates (32-bit format)
  \coordinate (origin) at (0,0);
  \coordinate (topright) at (32,\boxheight);

  \draw[very thick] (origin) rectangle (topright);

  % Define field boundaries from MSB (31) to LSB (0)
  \coordinate (b31) at (0,0);
  \coordinate (b12) at ($(b31) + (20,0)$);  % PFA: 20 bits (31-12)
  \coordinate (b9) at ($(b12) + (3,0)$);    % AVAIL: 3 bits (11-9)
  \coordinate (b8) at ($(b9) + (1,0)$);     % G: 1 bit (8)
  \coordinate (b7) at ($(b8) + (1,0)$);     % PS: 1 bit (7)
  \coordinate (b6) at ($(b7) + (1,0)$);     % 0: 1 bit (6)
  \coordinate (b5) at ($(b6) + (1,0)$);     % A: 1 bit (5)
  \coordinate (b4) at ($(b5) + (1,0)$);     % PCD: 1 bit (4)
  \coordinate (b3) at ($(b4) + (1,0)$);     % PWT: 1 bit (3)
  \coordinate (b2) at ($(b3) + (1,0)$);     % U/S: 1 bit (2)
  \coordinate (b1) at ($(b2) + (1,0)$);     % R/W: 1 bit (1)
  \coordinate (b0) at ($(b1) + (1,0)$);     % P: 1 bit (0)

  % Page Frame Address (31-12)
  \fill[fieldpurple!30] (b31) rectangle ($(b12) + (0,\boxheight)$);
  \draw[thick] (b12) -- ($(b12) + (0,\boxheight)$);
  \node at ($(b31)!0.5!(b12) + (0,\boxheight/2)$) {Page Frame Address};
  \node[below] (b31lbl) at ($(b31) + (1,-0.3)$) {31};
  \node[below] (b12lbl) at ($(b12) + (-1,-0.3)$) {12};

  % AVAIL (11-9)
  \fill[fieldgray!30] (b12) rectangle ($(b9) + (0,\boxheight)$);
  \draw[thick] (b9) -- ($(b9) + (0,\boxheight)$);
  \node at ($(b12)!0.5!(b9) + (0,\boxheight/2)$) {AVL};
  \node[below] at ($(b12)!0.5!(b9) + (0,-0.3)$) {11-9};

  % G (8)
  \fill[fieldcyan!30] (b9) rectangle ($(b8) + (0,\boxheight)$);
  \draw[thick] (b8) -- ($(b8) + (0,\boxheight)$);
  \node at ($(b9)!0.5!(b8) + (0,\boxheight/2)$) {G};
  \node[below] at ($(b9)!0.5!(b8) + (0,-0.3)$) {8};

  % PS (7)
  \fill[fieldcyan!30] (b8) rectangle ($(b7) + (0,\boxheight)$);
  \draw[thick] (b7) -- ($(b7) + (0,\boxheight)$);
  \node[align=center] at ($(b8)!0.5!(b7) + (0,\boxheight/2)$) {P\\S};
  \node[below] at ($(b8)!0.5!(b7) + (0,-0.3)$) {7};

  % 0 (6)
  \fill[fieldgray!30] (b7) rectangle ($(b6) + (0,\boxheight)$);
  \draw[thick] (b6) -- ($(b6) + (0,\boxheight)$);
  \node at ($(b7)!0.5!(b6) + (0,\boxheight/2)$) {0};
  ...
  \node[align=center] at ($(b2)!0.5!(b1) + (0,\boxheight/2)$) {R\\/\\W};
...
\vspace{0.8em}
\textbf{Page Table Entry (PTE)}\\[0.5em]
...
\begin{tikzpicture}[scale=0.26, font=\tiny]
  ...
  \coordinate (b9) at ($(b12) + (3,0)$);    % AVAIL: 3 bits (11-9)
  \coordinate (b8) at ($(b9) + (1,0)$);     % G: 1 bit (8)
  \coordinate (b7) at ($(b8) + (1,0)$);     % PAT: 1 bit (7)
  \coordinate (b6) at ($(b7) + (1,0)$);     % D: 1 bit (6)
  \coordinate (b5) at ($(b6) + (1,0)$);     % A: 1 bit (5)
  \coordinate (b4) at ($(b5) + (1,0)$);     % PCD: 1 bit (4)
  \coordinate (b3) at ($(b4) + (1,0)$);     % PWT: 1 bit (3)
  \coordinate (b2) at ($(b3) + (1,0)$);     % U/S: 1 bit (2)
  ...
  \draw[thick] (b12) -- ($(b12) + (0,\boxheight)$);
  \node at ($(b31)!0.5!(b12) + (0,\boxheight/2)$) {Page Frame Address};
  \node[below] at ($(b31) + (1,-0.3)$) {31};
  \node[below] at ($(b12) + (-1,-0.3)$) {12};
