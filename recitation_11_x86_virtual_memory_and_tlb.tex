...
\node[rectangle, draw, thick, fill=yellow!20, minimum height=4cm, minimum width=1.5cm, 
      right=1.5cm of stlb, yshift=-1.2cm] (pmh) {};
\node[align=center, font=\small, anchor=south west] (pmhlabel) at (pmh.north) {PMH};
...
% Core box
\node[bigbox, fit=(l1inst)(l1data)(insttlb)(datatlb)(transbox)(pmhlabel), 
