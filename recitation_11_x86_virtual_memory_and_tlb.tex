...
% VA for address A
\node[addrbox, fill=green!20, minimum width=2cm] (vaA_vpn) at (0, 2.5) {\texttt{0000...00}\textcolor{red}{\textbf{00}}};
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=west] (vaA_offset) at (vaA_vpn.east) {\texttt{0000 0000 0000}};
\node[font=\footnotesize, left=2mm of vaA_vpn] {VA:};
...
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=north east] (paA_offset) at ([yshift=-0.5cm]vaA_set_label.south -| vaA_offset.east) {\texttt{0000 0000 0000}};
\node[addrbox, fill=green!20, minimum width=2cm, anchor=east] (paA_pfn) at (paA_offset.west) {\texttt{0...0000}};
\coordinate (vaA_label_pos) at (vaA_vpn.west);
\node[font=\footnotesize] at (vaA_label_pos |- paA_pfn) {PA:};
...
% VB for address B
\node[addrbox, fill=green!20, minimum width=2cm] (vbB_vpn) at (7.5, 2.5) {\texttt{0011...00}\textcolor{red}{\textbf{00}}};
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=west] (vbB_offset) at (vbB_vpn.east) {\texttt{0000 0000 0000}};
\node[font=\footnotesize, left=2mm of vbB_vpn] {VB:};
...
\node[addrbox, fill=cyan!20, minimum width=2.5cm, anchor=north east] (pbB_offset) at ([yshift=-0.5cm]vbB_set_label.south -| vbB_offset.east) {\texttt{0000 0000 0000}};
\node[addrbox, fill=green!20, minimum width=2cm, anchor=east] (pbB_pfn) at (pbB_offset.west) {\texttt{0...0011}};
\coordinate (vbB_label_pos) at (vbB_vpn.west);
\node[font=\footnotesize] at (vbB_label_pos |- pbB_pfn) {PB:};
...
\textbf{Problem without PA bits [13:12] in tag:}
\begin{itemize}
    \item Same VA bits [13:6] $\Rightarrow$ same cache set
    \item Different PA bits [13:12] $\Rightarrow$ different physical addresses
    \item Would cause \textcolor{red}{false cache hit}!
\end{itemize}
