...
% VA inputs to translation caches (using rpin 1 of muxdemux)
\draw[arrow] (pmh.west |- stlb.rpin 1) -- node[arrowlabel] {VA[47:12]} (stlb.rpin 1);
\draw[arrow] (pmh.west |- pdecache.rpin 1) -- node[arrowlabel] {VA[47:21]} (pdecache.rpin 1);
\draw[arrow] (pmh.west |- pdpcache.rpin 1) -- node[arrowlabel] {VA[47:30]} (pdpcache.rpin 1);
\draw[arrow] (pmh.west |- pml4cache.rpin 1) -- node[arrowlabel] {VA[47:39]} (pml4cache.rpin 1);

% From translation caches to PMH (using rpin 2 of muxdemux)
\draw[arrow, red, thick] (stlb.rpin 2) -- node[arrowlabel] {PTE}
      (pmh.west |- stlb.rpin 2);
\draw[arrow, red, thick] (pdecache.rpin 2) -- node[arrowlabel] {PDE entry}
      (pmh.west |- pdecache.rpin 2);
\draw[arrow, red, thick] (pdpcache.rpin 2) -- node[arrowlabel] {PDP entry}
      (pmh.west |- pdpcache.rpin 2);
\draw[arrow, red, thick] (pml4cache.rpin 2) -- node[arrowlabel] {PML4 entry}
      (pmh.west |- pml4cache.rpin 2);
