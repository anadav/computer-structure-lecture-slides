...
% Macro for table cell content with overlay - fixes spacing in p{} columns
\newlength{\tablecellvspace}
\setlength{\tablecellvspace}{-3mm}
\newcommand{\cellonslide}[2]{\onslide<#1>{\vspace*{\tablecellvspace}#2}}
...
\section{Virtual Address Translation Caching}

\begin{frame}{Question 1c: Page Table Allocation}
A process accesses the following virtual addresses in order:

\vspace{0.5em}
\begin{enumerate}
\item \texttt{0x00000D382FFE2B25}
\item \texttt{0x00000D382FFE2349}
\item \texttt{0x00000D382FF68937}
\item \texttt{0x00000D3822849C00}
\item \texttt{0x000007146B554622}
\end{enumerate}

\vspace{0.5em}
For each access, how many \textbf{new page tables} must be allocated?
\end{frame}

\begin{frame}{Question 1c (Page Table Allocation): Visualization}
\begin{tikzpicture}[scale=0.6, transform shape,
    ...
    % Highlight style for address values in the bar
    addrval/.style={font=\scriptsize\ttfamily, minimum height=0.35cm},
    addrhighlight/.style={addrval, fill=yellow!60, draw=yellow!80!black, rounded corners=2pt, inner sep=2pt}
]
...
% Field names inside (top row)
\node[font=\scriptsize] at (1.25,11.05) {sign ext.};
\node[font=\scriptsize] (pml4label) at (3.5,11.05) {PML4};
\node[font=\scriptsize] (pdplabel) at (5.5,11.05) {PDP};
\node[font=\scriptsize] (dirlabel) at (7.5,11.05) {DIR};
\node[font=\scriptsize] (tablelabel) at (9.5,11.05) {TABLE};
\node[font=\scriptsize] (offsetlabel) at (12,11.05) {OFFSET};

% Address value row (bottom of address bar) - shows current address being translated
% Highlighting appears with tables (odd stages), then stays as plain text
% Address 1: D3-82-FF-E2-B25 (highlight at stage 3)
\visible<3>{\node[addrhighlight] at (3.5,10.65) {D3};}
\visible<4->{\node[addrval] at (3.5,10.65) {D3};}
\visible<3>{\node[addrhighlight] at (5.5,10.65) {82};}
\visible<4->{\node[addrval] at (5.5,10.65) {82};}
\visible<3>{\node[addrhighlight] at (7.5,10.65) {FF};}
\visible<4->{\node[addrval] at (7.5,10.65) {FF};}
\visible<3>{\node[addrhighlight] at (9.5,10.65) {E2};}
\visible<4->{\node[addrval] at (9.5,10.65) {E2};}
\visible<3>{\node[addrhighlight] at (12,10.65) {B25};}
\visible<4->{\node[addrval] at (12,10.65) {B25};}

% Address 2: same but offset=349 (highlight at stage 5) - only offset changes
\visible<5>{\node[addrhighlight] at (12,10.65) {349};}
\visible<6>{\node[addrval] at (12,10.65) {349};}

% Address 3: D3-82-FF-68-937 (highlight at stage 7) - PTE and offset change
\visible<7>{\node[addrhighlight] at (9.5,10.65) {68};}
\visible<8>{\node[addrval] at (9.5,10.65) {68};}
\visible<7>{\node[addrhighlight] at (12,10.65) {937};}
\visible<8>{\node[addrval] at (12,10.65) {937};}

% Address 4: D3-82-28-49-C00 (highlight at stage 9) - DIR, PTE, offset change
\visible<9>{\node[addrhighlight] at (7.5,10.65) {28};}
\visible<10>{\node[addrval] at (7.5,10.65) {28};}
\visible<9>{\node[addrhighlight] at (9.5,10.65) {49};}
\visible<10>{\node[addrval] at (9.5,10.65) {49};}
\visible<9>{\node[addrhighlight] at (12,10.65) {C00};}
\visible<10>{\node[addrval] at (12,10.65) {C00};}

% Address 5: 71-46-B5-54-622 (highlight at stage 11) - all change
\visible<11>{\node[addrhighlight] at (3.5,10.65) {71};}
\visible<12->{\node[addrval] at (3.5,10.65) {71};}
\visible<11>{\node[addrhighlight] at (5.5,10.65) {46};}
\visible<12->{\node[addrval] at (5.5,10.65) {46};}
\visible<11>{\node[addrhighlight] at (7.5,10.65) {B5};}
\visible<12->{\node[addrval] at (7.5,10.65) {B5};}
\visible<11>{\node[addrhighlight] at (9.5,10.65) {54};}
\visible<12->{\node[addrval] at (9.5,10.65) {54};}
\visible<11>{\node[addrhighlight] at (12,10.65) {622};}
\visible<12->{\node[addrval] at (12,10.65) {622};}
...
% Paths from address fields to table entries (arrows start from bottom of address bar at y=10.5)
% PML4 entries (center at x=3.5)
\visible<3->{\draw[arrow] (3.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pml4d3.west) -- (pml4d3.west) node[pml4tag] {D3};}
\visible<11->{\draw[arrow] (3.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pml471.west) -- (pml471.west) node[pml4tag] {71};}

% PDP entries (center at x=5.5)
\visible<3->{\draw[arrow] (5.5,10.5) -- ++(0, -0.4) -| ([xshift=-10mm]pdp82.west) -- (pdp82.west) node[pdptag] {82};}
\visible<11->{\draw[arrow] (5.5,10.5) -- ++(0, -0.4) -| ([xshift=-10mm]pdp46.west) -- (pdp46.west) node[pdptag] {46};}

% DIR entries (center at x=7.5)
\visible<3->{\draw[arrow] (7.5,10.5) -- ++(0, -0.5) -| ([xshift=-10mm]dirff.west) -- (dirff.west) node[dirtag] {FF};}
\visible<9->{\draw[arrow] (7.5,10.5) -- ++(0, -0.5) -| ([xshift=-10mm]dir28.west) -- (dir28.west) node[dirtag] {28};}
\visible<11->{\draw[arrow] (7.5,10.5) -- ++(0, -0.5) -| ([xshift=-10mm]dirb5.west) -- (dirb5.west) node[dirtag] {B5};}

% TABLE entries (center at x=9.5)
\visible<3->{\draw[arrow] (9.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]ptee2.west) -- (ptee2.west) node[ptetag] {E2};}
\visible<7->{\draw[arrow] (9.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pte68.west) -- (pte68.west) node[ptetag] {68};}
\visible<9->{\draw[arrow] (9.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pte49.west) -- (pte49.west) node[ptetag] {49};}
\visible<11->{\draw[arrow] (9.5,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pte54.west) -- (pte54.west) node[ptetag] {54};}

% OFFSET entries (center at x=12)
\visible<3->{\draw[arrow] (12,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pageb25.west) -- (pageb25.west) node[offsettag] {B25};}
\visible<5->{\draw[arrow] (12,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]page349.west) -- (page349.west) node[offsettag] {349};}
\visible<7->{\draw[arrow] (12,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]page937.west) -- (page937.west) node[offsettag] {937};}
\visible<9->{\draw[arrow] (12,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]pagec00.west) -- (pagec00.west) node[offsettag] {C00};}
\visible<11->{\draw[arrow] (12,10.5) -- ++(0, -0.3) -| ([xshift=-10mm]page622.west) -- (page622.west) node[offsettag] {622};}

% Arrows connecting the hierarchy
% PML4[D3] -> PDP[82]
\visible<3->{\draw[arrow] (pml4d3.east) -- ++(0.3, 0) |- (pdp82base.south west);}
% PML4[71] -> PDP[46]
\visible<11->{\draw[arrow] (pml471.east) -- ++(0.3, 0) |- (pdp46base.south west);}

% PDP[82] -> Dir[FF,28]
\visible<3->{\draw[arrow] (pdp82.east) -- ++(0.3, 0) |- (dirffbase.south west);}
% PDP[46] -> Dir[B5]
\visible<11->{\draw[arrow] (pdp46.east) -- ++(0.3, 0) |- (dirb5base.south west);}

% Dir[FF] -> PT[E2,68]
\visible<3->{\draw[arrow] (dirff.east) -- ++(0.3, 0) |- (pte2base.south west);}
% Dir[28] -> PT[49]
\visible<9->{\draw[arrow] (dir28.east) -- ++(0.3, 0) |- (pte49base.south west);}
% Dir[B5] -> PT[54]
\visible<11->{\draw[arrow] (dirb5.east) -- ++(0.3, 0) |- (pte54base.south west);}

% PT[E2] -> Page[B25,349]
\visible<3->{\draw[arrow] (ptee2.east) -- ++(0.5, 0) |- (pageb25base.south west);}
% PT[68] -> Page[937]
\visible<7->{\draw[arrow] (pte68.east) -- ++(0.3, 0) |- (page937base.south west);}
% PT[49] -> Page[C00]
\visible<9->{\draw[arrow] (pte49.east) -- ++(0.3, 0) |- (pagec00base.south west);}
% PT[54] -> Page[622]
\visible<11->{\draw[arrow] (pte54.east) -- ++(0.3, 0) |- (page622base.south west);}

% Right side: Complete virtual addresses (color-coded) - at fixed positions
% Address appears at address-reveal stage, alloclabel appears at tables-reveal stage
...
\visible<2->{\matrix[anchor=south west, matrix of nodes, nodes={draw=none, inner sep=1pt, font=\footnotesize\ttfamily},
        column sep=0.5pt, row sep=0.5pt, ampersand replacement=\&] (addr1) at (14.5, 8.2) {
...
\visible<4->{\matrix[anchor=south west, matrix of nodes, nodes={draw=none, inner sep=1pt, font=\footnotesize\ttfamily},
        column sep=0.5pt, ampersand replacement=\&] (addr2) at (14.5, 7.2) {
    |[text=green!40!black]| 00000 \&
    |[text=yellow!40!black]| D3 \&
    |[text=red!40!black]| 82 \&
    |[text=blue!20!black]| FF \&
...
\visible<6->{\matrix[anchor=south west, matrix of nodes, nodes={draw=none, inner sep=1pt, font=\footnotesize\ttfamily},
        column sep=0.5pt, ampersand replacement=\&] (addr3) at (14.5, 5.2) {
    |[text=green!40!black]| 00000 \&
    |[text=yellow!40!black]| D3 \&
    |[text=red!40!black]| 82 \&
    |[text=blue!20!black]| FF \&
...
\visible<8->{\matrix[anchor=south west, matrix of nodes, nodes={draw=none, inner sep=1pt, font=\footnotesize\ttfamily},
        column sep=0.5pt, ampersand replacement=\&] (addr4) at (14.5, 2.9) {
    |[text=green!40!black]| 00000 \&
    |[text=yellow!40!black]| D3 \&
    |[text=red!40!black]| 82 \&
...
\visible<10->{\matrix[anchor=south west, matrix of nodes, nodes={draw=none, inner sep=1pt, font=\footnotesize\ttfamily},
        column sep=0.5pt, ampersand replacement=\&] (addr5) at (14.5, 0.6) {
    |[text=green!40!black]| 00000 \&
...
% Note about question parameters (only on first stage)
\visible<1>{\node[font=\scriptsize, draw=black, thick, fill=red!10, align=center, text width=2.8cm,
      rectangle callout, callout absolute pointer={(-0.2,11.3)}] at (-2.5,9.5) {Using Question 1 parameters:\\ 256 entries per table\\ (8-bit indices)};}
...
\begin{itemize}
    \item The page table resides in memory\\
    $\Rightarrow$ each translation requires an extra memory access
    \item The TLB caches recently used PTEs
    \begin{itemize}
        \item Speeds up translation
        \item Separate L1 instruction TLB (iTLB) and data TLB (dTLB)
        \item Typically 64--128 entries, 4--8 way associative
    \end{itemize}
...
\begin{tikzpicture}[
    ...
    \newlength{\vpnwidth}\setlength{\vpnwidth}{3.6cm}
    % Virtual address breakdown - top row
    \node[field, fill=blue!20, minimum width=\vpnwidth] (vpn) at (0,0) {Virtual Page Number};
    \node[field, fill=orange!20, minimum width=1.2cm] (offset) at (vpn.east) {Offset};

    % Tag and Set subdivision - bottom row (Tag + Set = VPN width)
    \node[field, fill=green!20, minimum width=0.6\vpnwidth, anchor=north west] (tag) at ([yshift=-3mm]vpn.south west) {Tag};
    \node[field, fill=yellow!20, minimum width=0.4\vpnwidth] (set) at (tag.east) {Set};

    % Dotted lines connecting VPN to Tag/Set
    \draw[dotted, thick] (vpn.south west) -- (tag.north west);
    \draw[dotted, thick] (vpn.south east) -- (set.north east);
\end{tikzpicture}
...
\begin{itemize}
\item \textbf{On a TLB miss:} Page Miss Handler (PMH) gets the PTE from memory
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item The second-level TLB (L2 TLB) is shared between instruction and data paths
    \item Checked on an L1 TLB miss before performing a full page walk
    \item On an STLB hit: the PTE is copied to the appropriate L1 TLB (iTLB or dTLB)
    \item On an STLB miss: the PMH performs a full page walk
\end{itemize}

\vspace{1em}
\begin{center}
\begin{tabular}{|>{\cellcolor{gray!20}}l|c|c|}
\hline
\rowcolor{gray!20}
...
\hline
\textcolor{signcolor}{0x00000}\textcolor{pml4color}{22}\textcolor{pdpcolor}{33}\textcolor{dircolor}{44}\textcolor{tablecolor}{55}\textcolor{offsetcolor}{666} & \onslide<2->{4} & \cellonslide{2-}{Need to access memory for each of the 4 translation tables} \\
\hline
\textcolor{signcolor}{0x00000}\textcolor{pml4color}{22}\textcolor{pdpcolor}{33}\textcolor{dircolor}{44}\textcolor{tablecolor}{55}\textcolor{offsetcolor}{777} & \onslide<3->{0} & \cellonslide{3-}{Same page as above $\Rightarrow$ TLB hit $\Rightarrow$ No memory access} \\
\hline
\textcolor{signcolor}{0x00000}\textcolor{pml4color}{22}\textcolor{pdpcolor}{88}\textcolor{dircolor}{44}\textcolor{tablecolor}{55}\textcolor{offsetcolor}{777} & \onslide<4->{3} & \cellonslide{4-}{Hit in PML4 cache, then miss in PDP. Need to access memory 3 times: PDP, DIR, PTE} \\
\hline
\end{tabular}
\end{center}
\end{frame}
