...
\tikzset{
    ...
    bypass_data/.style={->, teal, line width=1.5pt},
    bypass_data_tap/.style={teal, circle, inner sep=0pt, minimum size=4pt, fill=teal},
}
...
\draw[bypass_data] (exmem_bypass_tap) |- (exmem_fwdB_junc) |- (BypassMuxB.lpin 1);
\node[bypass_data_tap] at (exmem_fwdA_junc) {};
\draw[bypass_data] (exmem_fwdA_junc) |- (BypassMuxA.lpin 1);
...
\node[bypass_data_tap] at (memwb_bypass_tap_a) {};
\node[bypass_data_tap] at (memwb_bypass_tap_b) {};
\draw[bypass_data] (memwb_bypass_tap_a) |- (BypassMuxB.lpin 3);
\draw[bypass_data] (memwb_bypass_tap_b) |- (BypassMuxA.lpin 3);
