...
%% Slide: Pipelined Car Assembly - Introduction
\begin{frame}{Pipelined Car Assembly}
    \centering
    \begin{tikzpicture}[
        stage/.style={draw, thick, minimum width=3cm, minimum height=2cm, align=center, font=\large\bfseries},
        ]

        % Time progress bar at top
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (-5, 4.4);
        \node[right, font=\Large\bfseries] at (5.2, 4.2) {00:00};

        % Three stages
        \node[stage, fill=orange!40] (chassis) at (-4, 1.5) {
            \includegraphics[width=1cm, rotate=90]{generated/noun-chassis-8091073.pdf}\\[1mm]
            chassis
        };
        \node[font=\small, below=0.1cm of chassis] {1 hour};

        \node[stage, fill=green!40, right=of chassis] (engine) {
            \includegraphics[width=1cm]{generated/noun-engine-8079892.pdf}\\[1mm]
            \vspace{-0.2cm}
            engine
        };
        \node[font=\small, below=0.1cm of engine] {2 hours};

        \node[stage, fill=blue!40, right=of engine] (finish) {
            \includegraphics[width=1cm]{generated/noun-car-spray-5038977.pdf}\\[1mm]
            finish
        };
        \node[font=\small, below=0.1cm of finish] {1 hour};

        % Car 1 below chassis (red)
        \node[below=1.5cm of chassis, rounded corners, inner sep=2pt] (car1) {
            \includegraphics[width=1.4cm]{generated/noun-car-4612699.pdf}
        };
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time progress bar (1/7 filled)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (-3.57, 4.4);
        \node[right, font=\Large\bfseries] at (5.2, 4.2) {01:00};

        % Three stages
        \node[stage, fill=orange!40] (chassis) at (-4, 1.5) {
            \includegraphics[width=1cm]{generated/noun-chassis-8091073.pdf}\\[2mm]
            chassis
        };
        \node[font=\small, below=0.1cm of chassis] {1 hour};

        \node[stage, fill=green!40] (engine) at (0, 1.5) {
            \includegraphics[width=1.2cm]{generated/noun-engine-8079892.pdf}\\[2mm]
            engine
        };
        \node[font=\small, below=0.1cm of engine] {2 hours};

        \node[stage, fill=blue!40] (finish) at (4, 1.5) {
            \includegraphics[width=1cm]{generated/noun-car-spray-5038977.pdf}\\[2mm]
            finish
        };
        \node[font=\small, below=0.1cm of finish] {1 hour};

        % Cars
        \node[below=1.5cm of chassis, fill=blue!20, rounded corners, inner sep=2pt] (car2) {
            \includegraphics[width=1.2cm]{generated/noun-car-2302591.pdf}
        };
        \node[below=0.05cm of car2, font=\small] {Car 2};

        \node[below=1.5cm of engine, fill=red!20, rounded corners, inner sep=2pt] (car1) {
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time progress bar (3/7 filled)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (-0.71, 4.4);
        ...
        % Cars
        \node[below=1.5cm of chassis, fill=green!30, rounded corners, inner sep=2pt] (car3) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car3, font=\small] {Car 3};

        \node[below=1.5cm of engine, fill=blue!20, rounded corners, inner sep=2pt] (car2) {
            \includegraphics[width=1.2cm]{generated/noun-car-2302591.pdf}
        };
        \node[below=0.05cm of car2, font=\small] {Car 2};

        \node[below=1.5cm of finish, fill=red!20, rounded corners, inner sep=2pt] (car1) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car1, font=\small] {Car 1};
...
%% Slide: Time 04:00 - First car done
\begin{frame}{Pipelined Car Assembly}
    \centering
    \begin{tikzpicture}[
        stage/.style={draw, thick, minimum width=3cm, minimum height=2cm, align=center, font=\large\bfseries},
        ...
        % Time progress bar (4/7 filled)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (0.14, 4.4);
        ...
        % Car 1 done - positioned to the right
        \node[fill=red!20, rounded corners, inner sep=2pt] at (7, -1) (car1) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car1, font=\small] {Car 1};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time progress bar (5/7 filled)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (1.43, 4.4);
        ...
        % Cars
        \node[below=1.5cm of chassis, fill=purple!20, rounded corners, inner sep=2pt] (car4) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car4, font=\small] {Car 4};

        \node[below=1.5cm of engine, fill=green!30, rounded corners, inner sep=2pt] (car3) {
            \includegraphics[width=1.2cm]{generated/noun-car-2302591.pdf}
        };
        \node[below=0.05cm of car3, font=\small] {Car 3};

        \node[below=1.5cm of finish, fill=blue!20, rounded corners, inner sep=2pt] (car2) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car2, font=\small] {Car 2};
    \end{tikzpicture}
...
%% Slide: Time 06:00 - Second car done
\begin{frame}{Pipelined Car Assembly}
    \centering
    \begin{tikzpicture}[
        stage/.style={draw, thick, minimum width=3cm, minimum height=2cm, align=center, font=\large\bfseries},
        ...
        % Time progress bar (6/7 filled)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (2.86, 4.4);
        ...
        % Car 2 done - positioned to the right
        \node[fill=blue!20, rounded corners, inner sep=2pt] at (7, -1) (car2) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car2, font=\small] {Car 2};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time progress bar (7/7 filled - complete)
        \draw[draw=black, thick] (-5, 4) rectangle (5, 4.4);
        \fill[fill=blue!40] (-5, 4) rectangle (5, 4.4);
        ...
        % Cars
        \node[below=1.5cm of chassis, fill=orange!30, rounded corners, inner sep=2pt] (car5) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car5, font=\small] {Car 5};

        \node[below=1.5cm of engine, fill=purple!20, rounded corners, inner sep=2pt] (car4) {
            \includegraphics[width=1.2cm]{generated/noun-car-2302591.pdf}
        };
        \node[below=0.05cm of car4, font=\small] {Car 4};

        \node[below=1.5cm of finish, fill=green!30, rounded corners, inner sep=2pt] (car3) {
            \includegraphics[width=1.2cm]{generated/noun-car-4612699.pdf}
        };
        \node[below=0.05cm of car3, font=\small] {Car 3};
