...
\draw[data_path] (IDEX.east |- ALU.blpin 1) -| ([xshift=-5mm]BypassMuxA.lpin 2) -- (BypassMuxA.lpin 2);
\draw[data_path] (BypassMuxA.rpin 1) -- (ALU.blpin 1);
% Src2 (to FwdB): from IDEX position -| to bypass mux lpin 2, then rpin 1 to ALUMux
\draw[data_path] (IDEX.east |- ALUMux.lpin 1) -| ([xshift=-5mm]BypassMuxB.lpin 2) -- (BypassMuxB.lpin 2);
