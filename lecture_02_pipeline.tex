...
\begin{frame}{Register File Split}
    ...
    \begin{circuitikz}[scale=0.9, transform shape]
        ...
        \node[anchor=east, font=\small\ttfamily, anchor=north east] (and_inst) at ([yshift=-2mm]lw_inst.south east) {and R12, R2, R5};
        \node[anchor=east, font=\small\ttfamily, anchor=north east] (or_inst) at ([yshift=-2mm]and_inst.south east) {or R13, R6, R2};
        \node[anchor=east, font=\small\ttfamily, anchor=north east] (add_inst) at ([yshift=-2mm]or_inst.south east) {add R14, R2, R2};
        \node[anchor=east, font=\small\ttfamily, anchor=north east] (sw_inst) at ([yshift=-2mm]add_inst.south east) {sw R15, 100(R2)};
