...
\draw[->, >=stealth, thick, orange!80!black] (ctrl_alusrc) -- (ALUMux.tpin 1) node[control_label, midway, right] {ALU\\source};
...
\draw[->, >=stealth, thick, orange!80!black] (ctrl_aluctl) -- (ALU.tpin 1) node[control_label, midway, right] {ALU\\Control};
...
\draw[->, >=stealth, thick, orange!80!black] (ctrl_mem) -- (DMem.north) node[control_label, midway, right] {Mem\\Rd/Wr};

% WB select (from control line at MEMWB east to WBMux top pin)
\draw[->, >=stealth, thick, orange!80!black] (ctrl_memwb_out) -- (WBMux.tpin 1) node[control_label, midway, right] {WB\\select};
