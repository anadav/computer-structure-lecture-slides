...
\path let \p1=([yshift=-5mm]SignExt.south), \p2=([yshift=2mm]IDEX.south) in
...
\draw[data_path] ([yshift=4mm]instruction.south east) -- ++(0.5,0) |- node[pos=0.75, above, font=\scriptsize] {dst} (dst_idex_in);
