...
\begin{tikzpicture}
    \node[draw=red!70!black, line width=1.5pt, fill=red!10, rounded corners=4pt,
        ...
        \textcolor{red!70!black}{\textbf{60\% performance loss!}}
    };
\end{tikzpicture}
\end{column}
\end{columns}
...
\vspace{0.4cm}
\centering
$\text{CPI}_{\text{new}} = \text{CPI}_{\text{Ideal}} + \text{Avg. } \dfrac{\text{stall cycles}}{\text{instruction}}$
\end{frame}
...
\begin{tikzpicture}
    \node[draw=myorange!70!black, line width=1.5pt, fill=myorange!10, rounded corners=4pt,
        ...
        $= \textbf{1.3}$\\[8pt]
        \textcolor{myorange!80!black}{\textbf{30\% performance loss}}
    };
\end{tikzpicture}
\end{column}
\end{columns}
...
\begin{tikzpicture}
    \node[draw=mygreen!70!black, line width=1.5pt, fill=lightgreen!20, rounded corners=4pt,
        ...
        \small\textbf{Performance Loss}\\[4pt]
        \footnotesize
        Stall: \textcolor{red!70!black}{\textbf{60\%}}\\
        \footnotesize
        Predict NT: \textcolor{myorange!80!black}{\textbf{30\%}}\\
        \footnotesize
        BTB (70\%): \textcolor{mygreen!80!black}{\textbf{18\%}}
    };
\end{tikzpicture}
\end{column}
\end{columns}
