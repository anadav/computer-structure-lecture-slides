...
% === Animated instruction labels ===
\only<1>{
    \node[inst_label] at (IMem.center) {jcc};
    \node[inst_label] at (RegFile.center) {or};
}
\only<2>{
    \node[inst_label, fill=green!40] at (IMem.center) {sub};
    \node[inst_label] at (RegFile.center) {jcc};
    \node[inst_label] at (ALU.center) {or};
}
\only<3>{
...
\only<4>{
    \node[inst_label, fill=green!40] at (IMem.center) {add};
    \node[inst_label, fill=green!40] at (RegFile.center) {mul};
    \node[inst_label, fill=green!40] at (ALU.center) {sub};
    \node[inst_label] at (DMem.center) {jcc};
    \node[font=\scriptsize, fill=green!20, rounded corners, inner sep=3pt] at (VerifyBox.center) {OK};
}
