...
\tikz[remember picture, baseline=(if_l3.base)]{\node[inner sep=0pt] (if_l3) {\texttt{\textcolor{orange!80!black}{if} (L3.RegWrite \&\& \tikz[remember picture, baseline=(lw_check.base)]{\node[inner sep=0pt] (lw_check) {L3.op != lw};} \&\& L3.dst == L2.src1)}};}\\
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    % Callout 1: L3 precedence explanation
    \only<2>{
    ...
    % Callout 2: lw check explanation
    \only<3>{
