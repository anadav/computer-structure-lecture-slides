...
\ifdrawaluinputs
\draw[data_path] (IDEX.east |- ALUMux.lpin 1) -- (WriteDataJunction) node[data_connector] -- (ALUMux.lpin 1) {};
...
% Immediate path: route around BypassMuxB to ALUMux.lpin 2
\draw[data_path] (ImmJunction) |- ([yshift=-3mm]BypassMuxB.south) -| (ALUMux.lpin 2);
