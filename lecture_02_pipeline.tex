...
\small
\texttt{L3\_wr = L3.RegWrite \&\& (L3.op != lw)}

\vspace{0.4cm}
\textcolor{orange!80!black}{\textbf{// Forward from EXE (L3):}}\\[2pt]
\texttt{\textcolor{orange!80!black}{if} (L3\_wr \&\& L3.dst == L2.src1)}\\
\texttt{~~~~ALUSelA = \textcolor{orange!80!black}{\textbf{1}}}\\[2pt]
\texttt{\textcolor{orange!80!black}{if} (L3\_wr \&\& L3.dst == L2.src2)}\\
\texttt{~~~~ALUSelB = \textcolor{orange!80!black}{\textbf{1}}}

\vspace{0.4cm}
\textcolor{cyan!70!black}{\textbf{// Forward from MEM (L4):}}\\[2pt]
\texttt{\textcolor{cyan!70!black}{if} (L4.RegWrite \&\&}\\
\texttt{~~~~(!L3\_wr || L3.dst != L2.src1) \&\&}\\
\texttt{~~~~L4.dst == L2.src1)}\\
\texttt{~~~~ALUSelA = \textcolor{cyan!70!black}{\textbf{2}}}\\[4pt]
\texttt{\textcolor{cyan!70!black}{if} (L4.RegWrite \&\&}\\
\texttt{~~~~(!L3\_wr || L3.dst != L2.src2) \&\&}\\
\texttt{~~~~L4.dst == L2.src2)}\\
\texttt{~~~~ALUSelB = \textcolor{cyan!70!black}{\textbf{2}}}
\end{column}
...
\begin{circuitikz}[scale=0.95, transform shape]
    ...
    \tikzset{
        ...
        pin_num/.style={font=\scriptsize\bfseries, text=green!30!black},
    ...
    % Pin numbers INSIDE the mux (near left edge)
    \node[pin_num] at ([xshift=3mm]Mux.lpin 1) {0};
    \node[pin_num] at ([xshift=3mm]Mux.lpin 2) {1};
    \node[pin_num] at ([xshift=3mm]Mux.lpin 3) {2};
    ...
    % Control input from bottom
    \draw[thick, ->, purple!70!black] ([yshift=-18mm]Mux.bpin 1) -- (Mux.bpin 1);
    \node[font=\scriptsize, purple!70!black, anchor=north] at ([yshift=-18mm]Mux.bpin 1) {ALUSel};
\end{circuitikz}
\end{column}
\end{columns}
\end{frame}
