...
\node[bypass_pin_label] at ([yshift=-1pt]BypassCtrl.tpin 3) {FwdA};
\node[bypass_pin_label] at ([yshift=-1pt]BypassCtrl.tpin 4) {FwdB};
...
\draw[bypass_ctrl_out] (BypassCtrl.tpin 3) |- ([yshift=-2mm]BypassMuxA.bpin 1) -- (BypassMuxA.bpin 1);
\draw[bypass_ctrl_out] (BypassCtrl.tpin 4) |- ([yshift=-2mm]BypassMuxB.bpin 1) -- (BypassMuxB.bpin 1);
