...
\node[bypass_ctrl, anchor=north] (BypassCtrl) at ([yshift=-11mm,xshift=5mm]IDEX.south -| BypassMuxA) {};
% Text in lower half
\node[font=\small\bfseries, purple!70!black] at ([yshift=-4mm]BypassCtrl.center) {Bypass Control};
% Pin labels inside the box (near top edge, rotated) - 6 pins: src2, src1, dst_t-1, dst_t-2, FwdA, FwdB
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 1) {src2};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 2) {src1};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 3) {FwdA};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 4) {FwdB};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 5) {dst$_{t-1}$};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 6) {dst$_{t-2}$};
...
\draw[bypass_ctrl_wire] (BypassCtrl.tpin 3) -- (BypassMuxA.bpin 1);
\draw[bypass_ctrl_wire] (BypassCtrl.tpin 4) -- (BypassMuxB.bpin 1);
