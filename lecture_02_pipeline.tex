...
\newcommand{\drawpipelinearch}[1][]{%
    ...
    \begin{scope}[scale=\pipescale, transform shape]
        ...
        % Instruction Memory - positioned at the "at" parameter
        \node[imem_block] (\pipeprefix-IM) at (\pipeatx,\pipeaty) {IM};
...
\begin{frame}{Register File Split}
    ...
    \begin{tikzpicture}[scale=0.9, every node/.style={transform shape}]
        ...
        \foreach \i in {0,...,4} {
            \pgfmathsetmacro{\xoffset}{0.5 + \i * 1.2}
            \pgfmathsetmacro{\yoffset}{2 - \i * 2}
            \drawpipelinearch[prefix=i\i, at x=\xoffset, at y=\yoffset, scale=0.4]
        }
    \end{tikzpicture}
\end{frame}
