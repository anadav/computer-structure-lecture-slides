...
\pause
\vspace{1mm}
\footnotesize Not quite -- \textbf{unbalanced stages} limit clock to slowest $\Rightarrow$ speedup = $\frac{\text{old cycle}}{\text{new cycle}} = \frac{8\text{ns}}{2\text{ns}} = 4\times$
\end{frame}
