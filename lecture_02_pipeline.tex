...
\begin{tikzpicture}
    ...
    \node[draw=red!70!black, line width=1pt, fill=red!8, rounded corners=3pt,
          text width=6.2cm, align=left, inner sep=8pt] (wrong) {
    ...
    \node[draw=myorange!70!black, line width=1pt, fill=myorange!10, rounded corners=3pt,
          text width=6.8cm, align=left, inner sep=8pt, right=1cm of wrong] (flush) {
...
\textbf{Performance Impact:} With prediction rate $P$ and 3-cycle penalty:
\[
\text{CPI} = 1 + 0.2 \times (1{-}P) \times 3
\]
\textbf{Example:} If $P = 70\%$, then $\text{CPI} = 1 + 0.2 \times 0.3 \times 3 = \textbf{1.18}$
\end{frame}
