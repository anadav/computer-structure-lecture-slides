...
\draw[bypass_wire] (dst_exmem_tap) -- ++(0,-2mm) -| (BypassCtrl.tpin 5);
\draw[bypass_wire] (dst_memwb_tap) -- ++(0,-4mm) -| (BypassCtrl.tpin 6);
...
\draw[bypass_data] (exmem_bypass_tap) |- ([yshift=-2mm,xshift=-3mm]EXMEM.south -| BypassMuxB.west) |- (BypassMuxB.lpin 1);
\node[bypass_data_tap] at ([yshift=-2mm,xshift=-3mm]EXMEM.south -| BypassMuxA.west) {};
\draw[bypass_data] ([yshift=-2mm,xshift=-3mm]EXMEM.south -| BypassMuxA.west) |- (BypassMuxA.lpin 1);

% Bypass data lines from MEM/WB (t-2) to mux lpin 3
\coordinate (memwb_bypass_tap) at (AddrWB -| MEMWB.east);
\draw[bypass_data] (memwb_bypass_tap) |- ([yshift=-4mm,xshift=-2mm]EXMEM.south -| BypassMuxB.west) |- (BypassMuxB.lpin 3);
\node[bypass_data_tap] at ([yshift=-4mm,xshift=-2mm]EXMEM.south -| BypassMuxA.west) {};
\draw[bypass_data] ([yshift=-4mm,xshift=-2mm]EXMEM.south -| BypassMuxA.west) |- (BypassMuxA.lpin 3);
