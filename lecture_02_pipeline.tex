...
% Bypass data lines from MEM/WB (t-2) to mux lpin 3
\coordinate (memwb_bypass_tap) at (AddrWB -| MEMWB.east);
\coordinate (memwb_fwdA_junc) at ([yshift=-4mm,xshift=-2mm]EXMEM.south -| BypassMuxA.west);
\coordinate (memwb_fwdB_junc) at ([yshift=-4mm,xshift=-2mm]EXMEM.south -| BypassMuxB.west);
\draw[bypass_data] (memwb_bypass_tap) |- (memwb_fwdB_junc) |- (BypassMuxB.lpin 3);
\node[bypass_data_tap] at (memwb_fwdA_junc) {};
\draw[bypass_data] (memwb_fwdA_junc) |- (BypassMuxA.lpin 3);
