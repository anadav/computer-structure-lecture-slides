...
\only<1>{
    % Instruction on IF/ID latch - anchored to bottom of Instruction rectangle
...
\only<2>{
    % Instruction on latch - anchored to bottom of Instruction rectangle
    \node[latch_inst, anchor=north] at (Instruction.south) {jcc};
...
\only<3>{
    ...
    \node[latch_inst] at (IDEX.center |- Instruction.south) {jcc};
...
\only<2>{
    ...
    \node[latch_inst_flush, anchor=north] at (Instruction.south) {mul};
