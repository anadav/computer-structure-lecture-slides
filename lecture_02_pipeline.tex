...
\coordinate (src1_data_pos) at ([xshift=5mm]RegFile.brpin 1);
\coordinate (src2_data_pos) at ([xshift=5mm]RegFile.brpin 2);
\coordinate (imm_pos) at ([xshift=5mm]SignExt.east);
\coordinate (alu_result_pos) at ([xshift=5mm]ALU.east);
\coordinate (mem_data_pos) at ([xshift=5mm]DMem.rpin 5);
