...
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 3) {dst$_{t-1}$};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 4) {dst$_{t-2}$};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 5) {FwdA};
\node[font=\tiny, purple!70!black, rotate=90, anchor=east] at ([yshift=-1pt]BypassCtrl.tpin 6) {FwdB};
...
\draw[bypass_wire] (dst_exmem_tap) -- ++(0,-2mm) -| (BypassCtrl.tpin 3);
\draw[bypass_wire] (dst_memwb_tap) -- ++(0,-4mm) -| (BypassCtrl.tpin 4);
% Tap marks on the dst lines
\node[bypass_tap] at (dst_exmem_tap) {};
\node[bypass_tap] at (dst_memwb_tap) {};

% Control signals to muxes (using top pins 5 and 6)
\draw[bypass_ctrl_wire] (BypassCtrl.tpin 5) -- (BypassMuxA.bpin 1);
\draw[bypass_ctrl_wire] (BypassCtrl.tpin 6) -- (BypassMuxB.bpin 1);
