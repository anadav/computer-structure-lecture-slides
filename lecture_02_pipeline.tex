...
\only<1>{
    \node[anchor=west, align=left, font=\small] at (StageExplainPos) {
...
\only<3>{
    ...
    \node[latch_target] at ([yshift=5mm]EXMEM.center |- calc_target_exmem) {50};
    % Explanation
    \node[anchor=west, font=\small] at (StageExplainPos) {
