...
% Alias for instruction node (macro uses lowercase)
\node (Instruction) at (instruction) {};
...
\only<1>{
    ...
    % Instruction on IF/ID latch - anchored north at instruction.south
    \node[latch_inst, anchor=north] at (Instruction.south) {or};
...
\only<2>{
    ...
    \node[latch_inst, anchor=north] (jcc2) at (Instruction.south) {jcc};
...
\only<3>{
    ...
    \node[latch_inst, anchor=north] at (Instruction.south) {sub};
    \node[latch_inst, anchor=north] (jcc3) at (IDEX.center |- Instruction.south) {jcc};
...
\only<4>{
    ...
    % Instructions on latches - using -| for consistent y-level
    \node[latch_inst, anchor=north] at (Instruction.south) {mul};
    \node[latch_inst, anchor=north] at (IDEX.center |- Instruction.south) {sub};
    \node[latch_inst_highlight, anchor=north] (jcc4) at (EXMEM.center |- Instruction.south) {jcc};
...
\only<5>{
    ...
    % Instructions on latches - using -| for consistent y-level
    \node[latch_inst, anchor=north] at (Instruction.south) {add};
    \node[latch_inst, anchor=north] at (IDEX.center |- Instruction.south) {mul};
    \node[latch_inst, anchor=north] at (EXMEM.center |- Instruction.south) {sub};
    \node[latch_inst, anchor=north] at (MEMWB.center |- Instruction.south) {jcc};
...
\only<1>{
    % IP value below IP register
    \node[ip_value] at ([yshift=-3mm]PC.south) {58};
    % Instructions on latches - anchored north at instruction.south level
    \node[latch_inst, anchor=north] at (Instruction.south) {mul};
    \node[latch_inst, anchor=north] at (IDEX.center |- Instruction.south) {sub};
    \node[latch_inst_highlight, anchor=north] (jccM1) at (EXMEM.center |- Instruction.south) {jcc};
    \node[branch_offset] at (EXMEM.center |- SignExt) {42};
    \node[latch_inst, anchor=north] at (MEMWB.center |- Instruction.south) {or};
    % Predicted values - positioned relative to signal coordinates
    \node[latch_target] at (EXMEM.center |- execute_out_pred_target) {50};
...
\only<2>{
    ...
    % Instructions - mul/sub being flushed - anchored north at instruction.south level
    \node[latch_inst_flush, anchor=north] at (Instruction.south) {\sout{mul} $\to$ NOP};
    \node[latch_inst_flush, anchor=north] at (IDEX.center |- Instruction.south) {\sout{sub} $\to$ NOP};
    \node[latch_inst_highlight, anchor=north] at (EXMEM.center |- Instruction.south) {jcc};
    \node[latch_inst, anchor=north] at (MEMWB.center |- Instruction.south) {or};
    % Mismatch indicator
...
\only<3>{
    % IP value - now at 8
    \node[ip_value] at ([yshift=-3mm]PC.south) {8};
    % Instructions - NOPs (bubbles) in flushed stages - anchored north at instruction.south level
    \node[latch_inst_nop, anchor=north] at (Instruction.south) {NOP};
    \node[latch_inst_nop, anchor=north] at (IDEX.center |- Instruction.south) {NOP};
    \node[latch_inst, anchor=north] at (EXMEM.center |- Instruction.south) {jcc};
    \node[latch_inst, anchor=north] at (MEMWB.center |- Instruction.south) {or};
    % Stage explanation
...
\only<4>{
    ...
    \node[ip_value] at ([yshift=-3mm]PC.south) {8};
    % Instructions - and fetched from correct path - anchored north at instruction.south level
    \node[latch_inst_new, anchor=north] at (Instruction.south) {and};
    \node[latch_inst_nop, anchor=north] at (IDEX.center |- Instruction.south) {--};
    \node[latch_inst_nop, anchor=north] at (EXMEM.center |- Instruction.south) {--};
    \node[latch_inst, anchor=north] at (MEMWB.center |- Instruction.south) {jcc};
    % Stage explanation
    \node[draw=green!50!black, line width=1.5pt, fill=green!10, rounded corners=6pt,
          font=\small, inner sep=8pt, anchor=west] at (StageExplainPos) {
