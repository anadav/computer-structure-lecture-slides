...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        car/.style={fill=red!20, rounded corners, minimum width=1.5cm, minimum height=0.8cm, align=center, font=\small},
        ]

        % Time indicator at top
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {00:00};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {01:00};
        ...
        % Cars
        \node[car] (car2) at (-4, -1) {Car 2};
        \node[car] (car1) at (0, -1) {Car 1};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {03:00};
        ...
        % Cars
        \node[car] (car3) at (-4, -1) {Car 3};
        \node[car] (car2) at (0, -1) {Car 2};
        \node[car] (car1) at (4, -1) {Car 1};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {04:00};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {05:00};
        ...
        % Cars
        \node[car] (car4) at (-4, -1) {Car 4};
        \node[car] (car3) at (0, -1) {Car 3};
        \node[car] (car2) at (4, -1) {Car 2};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {06:00};
...
\begin{frame}{Pipelined Car Assembly}
    ...
    \begin{tikzpicture}[
        ...
        % Time indicator
        \node[font=\LARGE\bfseries, color=blue!70] at (0, 4) {07:00};
        ...
        % Cars
        \node[car] (car5) at (-4, -1) {Car 5};
        \node[car] (car4) at (0, -1) {Car 4};
        \node[car] (car3) at (4, -1) {Car 3};
