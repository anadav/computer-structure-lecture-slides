...
\draw[data_path] (IDEX.east |- ALUMux.lpin 1) -- (WriteDataJunction) node[data_connector] {};
\ifdrawaluinputs
...
% Src1 (to FwdA): from IDEX position -| to bypass mux lpin 2, then rpin 1 to ALU
\draw[data_path] (IDEX.east |- ALU.blpin 1) -| ([xshift=-5mm]BypassMuxA.lpin 1) -- (BypassMuxA.lpin 1);
\draw[data_path] (BypassMuxA.rpin 1) -- (ALU.blpin 1);
% Src2 (to FwdB): from IDEX position -| to bypass mux lpin 2, then rpin 1 to ALUMux
\draw[data_path] (IDEX.east |- ALUMux.lpin 1) -| ([xshift=-5mm]BypassMuxB.lpin 1) -- (BypassMuxB.lpin 1);
