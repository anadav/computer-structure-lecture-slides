...
% === Cycle indicator (nice box 2cm left of Fetch label) ===
\only<1>{\node[cycle_box] at ([xshift=-2cm]IF_label.west) {Cycle 1};}
\only<2>{\node[cycle_box] at ([xshift=-2cm]IF_label.west) {Cycle 2};}
\only<3>{\node[cycle_box] at ([xshift=-2cm]IF_label.west) {Cycle 3};}
\only<4>{\node[cycle_box] at ([xshift=-2cm]IF_label.west) {Cycle 4};}
\only<5>{\node[cycle_box] at ([xshift=-2cm]IF_label.west) {Cycle 5};}
