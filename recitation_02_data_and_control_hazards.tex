...
\begin{circuitikz}[
    ...
    mux2r/.style={muxdemux, muxdemux def={Lh=1.5, Rh=3, NL=1, NR=2, NB=1, NT=1, w=1}, fill=cyan!20,
                 external pins width=0},
    mux3/.style={muxdemux, muxdemux def={Lh=2.4, Rh=1.3, NL=3, NR=1, NB=1, NT=1, w=1}, 
                 external pins width=0},
    mux4/.style={muxdemux, muxdemux def={Lh=2.4, Rh=1.3, NL=4, NR=1, NB=1, NT=1, w=1}, 
                 external pins width=0},
...
\draw[control_path] (MemAnd.bout) -- ++(0.3, 0) -- ++(0, 2) |- node[control_label, pos=0.6, below, yshift=2mm] {PCSrc} ([yshift=4mm]PCSrcMux.btpin 1) -- (PCSrcMux.btpin 1);
