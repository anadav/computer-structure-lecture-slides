...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[draw, thick, minimum width=2.8cm, minimum height=0.5cm, align=center,
          font=\ttfamily\footnotesize, fill=orange!20]
          at ($(ID_label) + (0, -5.5)$) {SUB \$4$\leftarrow$\textcolor{red}{\$1},\$5};

    \node[draw, thick, minimum width=2.8cm, minimum height=0.5cm, align=center,
          font=\ttfamily\footnotesize, fill=green!20]
          at ($(EX_label) + (0, -5.5)$) {ADD \textcolor{red}{\$1}$\leftarrow$\$2,\$3};
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    % Bubbles (stalls) in EX and MEM
    \node[draw, thick, minimum width=2.8cm, minimum height=0.5cm, align=center,
          font=\ttfamily\footnotesize, fill=gray!20]
          at ($(EX_label) + (0, -5.5)$) {BUBBLE};

    \node[draw, thick, minimum width=2.8cm, minimum height=0.5cm, align=center,
          font=\ttfamily\footnotesize, fill=gray!20]
          at ($(MEM_label) + (0, -5.5)$) {BUBBLE};

    \node[draw, thick, minimum width=2.8cm, minimum height=0.5cm, align=center,
          font=\ttfamily\footnotesize, fill=green!20]
          at ($(WB_label) + (0, -5.5)$) {ADD \textcolor{red}{\$1}$\leftarrow$\$2,\$3};
