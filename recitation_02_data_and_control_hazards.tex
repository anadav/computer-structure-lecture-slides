...
\begin{circuitikz}[
    ...
    hazard_unit/.style={muxdemux, muxdemux def={Lh=1.5, NL=2, Rh=1.5, NR=3, NB=2, w=2.5, square pins=1}, 
    ...
    regfile/.style={muxdemux, muxdemux def={Lh=5, NL=5, Rh=5, NR=2, NB=1, w=3.2, square pins=1}, 
...
% Control Unit
\node[control_block, ellipse, minimum height=0.7cm, minimum width=1cm, above=1.3cm of RegFile] (Control) [rotate=90] {Control};
...
\node[mux2, fill=orange!20, anchor=brpin 1, right=1cm of IDEX] (ForwardA) {};
...
% Forwarding Unit
\node[muxdemux, muxdemux def={Lh=2, NL=4, Rh=2, NR=4, w=3, square pins=1}, 
      external pins width=0, fill=orange!30, font=\scriptsize, align=center, below=of ALU] (FwdUnit) {Forwarding\\Unit};
...
\node[memory_block, fill=yellow!20, anchor=blpin 1] (DMem) at ([xshift=5mm]EXMEM.east |- ALU) {Data\\Memory};
...
\node[control_signal] (Rd_field) at ([yshift=2mm]IDEX.south) {\tiny Rd};
\node[control_signal] (Rt_field) at (Rd_field.north) [anchor=south, yshift=0.1cm] {\tiny Rt};
\node[control_signal] (Rs_field) at (Rt_field.north) [anchor=south, yshift=0.1cm] {\tiny Rs};
...
\draw[data_path] (IFID.east) -- ++(0.3,0) |- node[near end, above, font=\tiny] {Rs} (RegFile.blpin 1);
\draw[data_path] (IFID.east) -- ++(0.3,0) |- node[near end, above, font=\tiny] {Rt} (RegFile.blpin 2);

\draw[data_path] (IFID.east) -- ++(0.3,0) |- (Control.north);
...
% Write back path
\draw[data_path] (WBMux.brpin 1) -- ++(0.5,0) |- ([yshift=-5mm]MEMWB.south) -| node[midway, above right, font=\tiny] {WrData} ([xshift=-5mm]RegFile.blpin 4) -- (RegFile.blpin 4);
...
\draw[control_path] (Control.south) -- ++(0.1, 0) |- (HDU_AND.bin 2);
\draw[control_path] (WB1.east) -- (WB2.west);
\draw[control_path] (M1.east) -- (M2.west);
\draw[control_path] (WB2.east) -- (WB3.west);
\draw[control_path] (WB3.east) -- ++(0.2, 0) |- ([yshift=-3mm]MEMWB.south) -| ([xshift=3mm]FwdUnit.brpin 4) -- (FwdUnit.brpin 4);
\draw[control_path] (WB3.east) -- ++(0.2, 0) |- ([yshift=-3mm]MEMWB.south) -| node[midway, above right, font=\tiny] {RegWrite} ([xshift=-4mm]RegFile.blpin 5) -- (RegFile.blpin 5);
...
\draw[hazard_path, line width=0pt] (HDU.brpin 3) -- ++(0.2, 0) |- (HDU_AND.bin 1);
\draw[hazard_path, line width=0pt] (HDU.blpin 1) -| (PC.north);
...
\draw[forward_path] (FwdUnit.blpin 1) -- (ForwardA.bbpin 1);
