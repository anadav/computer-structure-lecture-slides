...
\node[data_latch, anchor=east] (Rs_field) at ([yshift=5mm]Rt_latch.east |- mux4.brpin 1) {\tiny Rs};
...
\node[data_latch] (EXMEM_RtRd) at ([yshift=2mm]EXMEM.south) {\rotatebox{90}{\tiny Rt/Rd}};
\node[data_latch] (MEMWB_RtRd) at ([yshift=2mm]MEMWB.south) {\rotatebox{90}{\tiny Rt/Rd}};
