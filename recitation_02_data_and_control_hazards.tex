...
\draw[data_path] (IDEX.east |- RegFile.brpin 2) \node[black_connector] {} -- ++(3,0) 
...
\draw[control_path] (EXMEM.east |- ALU.brpin 1) -- ++(0.4, 0) |- node[control_label, near start, sloped] {} (MemAnd.bin 2);
