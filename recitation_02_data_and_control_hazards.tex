...
\begin{circuitikz}[
    ...
    memory_block/.style={muxdemux, muxdemux def={Lh=6, NL=5, Rh=6, NR=1, NT=3, w=3, square pins=1}, 
                        external pins width=0, align=center, text depth=10ex, fill=yellow!20},
...
\draw[data_path] ([xshift=3mm]EXMEM.east |- ALU)  node[black_connector] (DmemConnector) {} 
    |- (ALUresult.west);
...
\draw[data_path] (DMem.brpin 1) -- (MEMWB.west |- DMem.brbin 1);
...
%\draw[->, >=stealth, thick, orange!50] ( [yshift=3mm]ALUresult -| DmemConnector ) -- ++(0.3,0) |- (FwdUnit.blpin 1);
