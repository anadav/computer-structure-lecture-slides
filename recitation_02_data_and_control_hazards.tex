...
\begin{circuitikz}[
    ...
    imem_block/.style={muxdemux, muxdemux def={Lh=6, NL=1, Rh=6, NR=1, w=4, square pins=1}, 
                        external pins width=0, align=center, text depth=10ex, fill=yellow!20},
...
\node[imem_block, right=of PC] (IMem) {Instruction\\Memory};
...
\node[align=left, font=\tiny] at ([xshift=3mm]IMem.blpin 1) {read\\addr};
...
\draw[data_path] (IFID.east) -- ++(0.3,0) |-
