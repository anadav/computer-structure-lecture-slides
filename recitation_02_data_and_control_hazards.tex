...
\begin{circuitikz}[
    ...
    control_block/.style={draw, thick, fill=orange!30, rounded corners=3pt, font=\footnotesize},
    ...
    regfile/.style={muxdemux, muxdemux def={Lh=6.5, NL=5, Rh=6.5, NR=2, NB=1, NT=1, w=3.2, square pins=1}, 
                    external pins width=0, fill=cyan!20, align=center},
    alu_style/.style={muxdemux, muxdemux def={Lh=4.5, NL=2, Rh=2, NR=3, w=1.2, inset w=0.5, inset Lh=2, inset Rh=0, square pins=1},
    ...
    mux3/.style={muxdemux, muxdemux def={Lh=3, Rh=1.5, NL=3, NR=1, NB=1, NT=1, w=1}, 
                 external pins width=0},
    mux4/.style={muxdemux, muxdemux def={Lh=2, Rh=1, NL=2, NR=1, NB=1, NT=1, w=1}, 
                 external pins width=0},
    ...
    control_signal/.style={draw, thick, fill=orange!30, minimum width=6mm, minimum height=0.3cm, font=\tiny},
    data_latch/.style={draw, thick, fill=cyan!20, minimum width=6mm, minimum height=0.3cm, font=\tiny},
    % Connector circles
...
\node[adder, above=of IMem.north east, anchor=south east] (PCadder) {+};
...
\node[align=left, xshift=-3mm, font=\tiny] at (RegFile.brpin 1) {read\\data 1};
\node[align=left, xshift=-3mm, font=\tiny] at (RegFile.brpin 2) {read\\data 2};

% Control Unit
\node[control_block, ellipse, minimum height=0.5cm, minimum width=0.5cm,
      above=2mm of RegFile, inner sep=1pt] (Control) {\rotatebox{90}{Control}};
...
\node[ellipse, draw, thick, fill=cyan!20, minimum width=0.3cm, minimum height=0.2cm, inner sep=1pt,
      right=4mm of RegFile.south east, yshift=1.8mm, anchor=west, font=\tiny] (SignExt) {\rotatebox{90}{SignExt}};


% EX Stage Components
\node[mux3, fill=orange!20, anchor=blpin 1] (ForwardA) at ([xshift=10mm]IDEX.east |- RegFile.brpin 1) {};
...
\node[data_latch] (Rd_field) at ([yshift=2mm]IDEX.south) {Rd};
...
\node[data_latch, anchor=south] (Rs_field) at ([yshift=1mm]Rt_field.north) {Rs};
...
\draw[control_path] (EX1.east) -|  node[control_label, near end, sloped] {ALUSrc} (ForwardA.btpin 1);
...
\draw[data_path] (EXMEM.east |- ALU) -- (DMem.blpin 3);
\draw[data_path] ([xshift=3mm]EXMEM.east |- ALU)  node[black_connector] (DmemConnector) {} |- (ALUresult.west);
