...
\begin{tikzpicture}[
    ...
    memory_block/.style={muxdemux, muxdemux def={Lh=3, NL=2, Rh=3, NR=1, w=2.5, square pins=1}, 
                        external pins width=0, scale=0.5},
    regfile/.style={muxdemux, muxdemux def={Lh=4, NL=3, Rh=4, NR=2, NB=1, w=2.5, square pins=1}, 
...
% Control Unit
\node[control_block, minimum width=1.2cm, minimum height=0.8cm] (Control) at (3, 2.5) {Control};

% Hazard Detection Unit
\node[hazard_unit, minimum width=1.5cm, minimum height=0.8cm] (HDU) at (3, -2) {HDU};
...
\draw[hazard_path] ([xshift=-0.2cm]RegFile.south) -- ([xshift=-0.2cm]HDU.north);
\draw[hazard_path] ([xshift=0.2cm]RegFile.south) -- ([xshift=0.2cm]HDU.north);
\draw[hazard_path] (HDU.west) -| (PC.south);
\draw[hazard_path] (HDU.west) -| (IFID.south);
\draw[hazard_path] (HDU.east) -| (Control.south);
