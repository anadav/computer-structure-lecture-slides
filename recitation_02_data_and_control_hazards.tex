...
\node[regfile, right=of IFID] (RegFile) {Register\\File};

% Control Unit
\node[control_block, ellipse, minimum height=0.8cm, minimum width=1.2cm, above=of RegFile] (Control) [rotate=90] {Control};

% Hazard Detection Unit
\node[hazard_unit, above=of Control] (HDU) {HDU};
