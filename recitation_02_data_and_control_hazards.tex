...
\begin{circuitikz}[
    ...
    regfile/.style={muxdemux, muxdemux def={Lh=7, NL=5, Rh=7, NR=2, NB=1, NT=1, w=3.2, square pins=1}, 
                    external pins width=0, fill=cyan!20, align=center},
    alu_style/.style={muxdemux, muxdemux def={Lh=5, NL=2, Rh=2, NR=2, w=1.2, inset w=0.5, inset Lh=2, inset Rh=0, square pins=1},
    ...
    mux2/.style={muxdemux, muxdemux def={Lh=3, Rh=1.5, NL=3, NR=1, NB=1, NT=1, w=1}, 
...
% Addr and SHL
\node[adder, anchor=brpin 2] (EXPCAddr) at (ALU.east |- IFNewPC) {};
\node[ellipse, draw, thick, fill=cyan!20, minimum width=0.3cm, minimum height=0.2cm, inner sep=1pt,
      above=4mm of ALU.north east, yshift=1.8mm, anchor=east, font=\tiny] (shltwo) {\rotatebox{90}{SHL2}};
