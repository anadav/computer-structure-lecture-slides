...
% Forwarding Unit
\node[muxdemux, muxdemux def={Lh=2, NL=2, Rh=2, NR=2, w=3, square pins=1}, 
...
% Write back path
\draw[data_path] (WBMux.east) -- ++(0.5,0) -- ++(0,-3) -| node[midway, above right, font=\tiny] {RegWrite} ([xshift=-5mm]RegFile.blpin 5) -- (RegFile.blpin 5);
