...
\begin{tikzpicture}[
    ...
    memory_block/.style={muxdemux, muxdemux def={Lh=6, NL=2, Rh=6, NR=1, w=5, square pins=1}, 
                        external pins width=0, scale=0.5, font=\small, align=center},
    regfile/.style={muxdemux, muxdemux def={Lh=5, NL=3, Rh=5, NR=2, NB=1, w=3.2, square pins=1}, 
                    external pins width=0, scale=0.5, fill=cyan!20, font=\small, align=center},
...
\node[regfile] (RegFile) at (3, 0.5) {Register\\File};
...
\node[mux2, fill=blue!20] (RegDstMux) at (ForwardB.south) [anchor=north, yshift=-0.5cm] {};

% Forwarding Unit
\node[muxdemux, muxdemux def={Lh=3, NL=2, Rh=3, NR=2, w=3.5, square pins=1}, 
      external pins width=0, scale=0.5, fill=orange!30, font=\small, align=center] (FwdUnit) at (6.5, -2) {Forwarding\\Unit};

% MEM Stage Components
% Data Memory using muxdemux
\node[memory_block, fill=yellow!20] (DMem) at (10, 0.5) {Data\\Memory};
