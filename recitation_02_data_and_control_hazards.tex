...
\draw[data_path] (IFID.east) -- ++(0.3,0) |- node[pos=0.9, above, font=\tiny, yshift=-2] {Rs} (RegFile.blpin 1);
\draw[data_path] (IFID.east) -- ++(0.3,0) |- node[pos=0.9, above, font=\tiny, yshift=-2] {Rt} (RegFile.blpin 2);
\draw[data_path] (IFID.east) -- ++(0.3,0) |- node[pos=0.8, above, font=\tiny, yshift=-2] {Rd} (Rd_field.west);
\draw[data_path] ([xshift=-9mm]RegFile.blpin 1) node[circle, fill, inner sep=1.2pt] {}
                    |- node[pos=0.8, above, font=\tiny, yshift=-2] {Rs} (Rs_field.west);  
\draw[data_path] ([xshift=-10mm]RegFile.blpin 2) node[circle, fill, inner sep=1.2pt] {}
                    |- node[pos=0.8, above, font=\tiny, yshift=-2] {Rt} (Rt_field.west);  
...
\draw[data_path]
  ...
  |- ([yshift=-6mm]FwdUnit.south)
  -| node[midway, above right, font=\tiny, yshift=-2]{RegDst} ([xshift=-8mm]RegFile.blpin 3)
  -- node[midway, above, font=\tiny, yshift=-2]{RegDst} % or pos=0.9, etc.
     (RegFile.blpin 3);
...
\draw[data_path]
  (WBMux.brpin 1) -- ++(0.5,0)
  |- ([yshift=-2mm]FwdUnit.south)
  -| node[midway, above right, font=\tiny, yshift=-2]{WrData} ([xshift=-7mm]RegFile.blpin 4)
  -- node[midway, above, font=\tiny, yshift=-2]{WrData} % or pos=0.9, etc.
     (RegFile.blpin 4);
...
\draw[hazard_path_input] (RegFile.blpin 2 -| HDU.bbpin 2) node[circle, fill, inner sep=1.2pt, red!70] {} -- (HDU.bbpin 2);
\draw[hazard_path_input] (RegFile.blpin 1 -| HDU.bbpin 3) node[circle, fill, inner sep=1.2pt, red!70] {} -- (HDU.bbpin 3);
