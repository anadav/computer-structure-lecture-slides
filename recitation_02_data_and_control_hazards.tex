...
\draw[data_path] ([xshift=3mm]EXMEM.east |- ALU.brpin 4)  node[data_connector] (DmemConnector) {} |- (ALUresult.west);
...
\draw[forward_path] ([xshift=1mm]EXMEM_RtRd.east) node[data_connector] {} |- (FwdUnit.brpin 1);
...
\draw[arrow, blue] (ALUresult -| DmemConnector) node[data_connector] {} 
