...
\begin{tikzpicture}[scale=1]
    ...
    % BTB table with 3 columns
    \draw[thick] (0, 4.5) -- (0, 0);
    \draw[thick] (7.5, 4.5) -- (7.5, 0);
    
    % Table headers (above the table, no vertical lines)
    \node at (1.5, 4.7) {Look up};
    \node at (4.5, 4.7) {Predicted PC};
    ...
    \draw[->] (6.75, 0) -- (6.75, -1) node[below, align=center] {Branch prediction\\Taken or not taken};
\end{tikzpicture}
\end{center}
