...
\begin{circuitikz}[
    ...
    data_latch/.style={draw, thick, fill=cyan!20, minimum width=0.5cm, minimum height=0.3cm, font=\scriptsize},
...
\node[mux2, fill=cyan!20, below=of ForwardB] (RegDstMux) {};
...
\node[data_latch] (Rt_field) at (Rd_field.north) [anchor=south, yshift=0.1cm] {\tiny Rt};
\node[data_latch] (Rs_field) at (Rt_field.north) [anchor=south, yshift=0.1cm] {\tiny Rs};
...
% Write back path
\draw[data_path] (WBMux.brpin 1) -- ++(0.5,0) |- ([yshift=-6mm]MEMWB.south) -| node[midway, above right, font=\tiny] {WrData} ([xshift=-5mm]RegFile.blpin 4) -- (RegFile.blpin 4);
