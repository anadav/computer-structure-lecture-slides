...
\draw[control_path]
    ...
    -| node[midway, above right, font=\tiny, yshift=-2] {RegWrite} ([xshift=-4mm]RegFile.blpin 5)
    -- (RegFile.blpin 5);
...
\draw[hazard_path_input] ([xshift=-1cm]M2.west) node[circle, fill, inner sep=1.2pt, red!70] {} |- (HDU.brpin 2);
\draw[hazard_path_input] ([xshift=-3mm]EXMEM_RtRd.west) node[circle, fill, inner sep=1.2pt, red!70] {} |- (HDU.brpin 1);
...
\draw[data_path] ([xshift=2mm]Rt_field.east) node[circle, fill, inner sep=1.2pt] {}  |- (FwdUnit.blpin 4);
