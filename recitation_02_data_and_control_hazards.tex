...
\begin{circuitikz}[
    ...
    adder/.style={muxdemux, muxdemux def={Lh=2, NL=2, Rh=0.7, NR=2, w=1.2, inset w=0.5, inset Lh=1, inset Rh=0, square pins=1},
...
\node[data_latch, font=\tiny] (Instruction) at (IMem.rpin 3 -| IFID) {\rotatebox{90}{instruction}};
...
\draw[control_path] ([yshift=-3]M2.east) -| node[control_label, near end, sloped] {MemWrite} (DMem.btpin 2);
