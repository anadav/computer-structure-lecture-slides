...
% Parameters: #1 = show forwarding (1/0), #2 = show HDU (1/0)
...
\centering
\pipelineprocessor{1}{1}  % Show forwarding=1, Show HDU=1
\end{frame}

\begin{frame}{Pipeline Processor with Hazard Detection (No Forwarding)}
\centering
\pipelineprocessor{0}{1}  % Show forwarding=0, Show HDU=1
\end{frame}

\begin{frame}{Basic Pipeline Processor}
\centering
\pipelineprocessor{0}{0}  % Show forwarding=0, Show HDU=0
\end{frame}
