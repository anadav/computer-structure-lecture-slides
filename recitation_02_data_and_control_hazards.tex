...
\draw[control_path] (EXMEM.east |- ALU.brpin 3) -- ++(0.4, 0) |- node[control_label, near start, sloped] {} (MemAnd.bin 2);
...
\draw[arrow, blue] (ForwardB_junction1) node[black_connector] {} |- (ForwardB.blpin 2);
