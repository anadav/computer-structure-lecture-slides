...
\begin{circuitikz}[
    ...
    control_block/.style={draw, t3ick, fill=orange!30, rounded corners=3pt, font=\footnotesize},
...
\node[data_latch, above=1mm of MEMWB_RtRd] (ALUresult) {\rotatebox{90}{\tiny ALUresult}};
