...
\begin{tikzpicture}[
    ...
    hazard_unit/.style={draw, thick, fill=red!60, text=white, font=\bfseries, rounded corners=3pt},
...
\node[hazard_unit, minimum width=1.5cm, minimum height=0.8cm] (HDU) at (Control.east) [anchor=south east, yshift=0.5cm] {HDU};
...
\draw[hazard_path] ([xshift=-0.2cm]RegFile.south) |- (HDU.west);
\draw[hazard_path] ([xshift=0.2cm]RegFile.south) |- (HDU.west);
\draw[hazard_path] (HDU.south) |- (PC.south);
\draw[hazard_path] (HDU.south) |- (IFID.south);
\draw[hazard_path] (HDU.west) -- (Control.east);
