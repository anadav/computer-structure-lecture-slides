...
\begin{tikzpicture}[
    ...
    hazard_unit/.style={muxdemux, muxdemux def={Lh=3, NL=2, Rh=3, NR=3, NB=2, w=2.5, square pins=1}, 
                       external pins width=0, scale, fill=red!60, text=white},
...
\node[stage_label] (EX_label) at ($ (IDEX.center)!0.5!(EXMEM.center) $) [yshift=4cm] {EX};
\node[stage_label] (MEM_label) at ($ (EXMEM.center)!0.5!(MEMWB.center) $) [yshift=4cm] {MEM};
