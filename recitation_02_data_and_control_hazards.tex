...
\begin{circuitikz}[
    ...
    alu_style/.style={muxdemux, muxdemux def={Lh=3.6, Rh=1.8, NL=2, NR=5, NB=1, w=1.2, inset w=0.5, inset Lh=2, inset Rh=0, square pins=1},
...
\node[hazard_unit, above=of Control.north west, yshift=-2mm, xshift=-7mm] (HDU) {HDU};
...
\node[ellipse, draw, thick, fill=cyan!20, minimum width=0.3cm, minimum height=0.2cm, inner sep=1pt,
      left=4mm of EXPCAddr.blpin 2, font=\tiny] (SHLTwo) {\rotatebox{90}{SHL2}};
...
\node[control_signal, anchor=north] (WB1) at (IDEX.north) {WB};
...
\draw[data_path] ([xshift=3mm]PCadder.brpin 1) node[black_connector] {} |- (PCSrcMux.brpin 2);
...
\draw[data_path] (EXNewPC.east) -- ++(0.3,0)
...
\draw[data_path] ([xshift=3mm]EXMEM.east |- ALU.brpin 4)  node[black_connector] (DmemConnector) {} |- (ALUresult.west);
...
\draw[control_path] (EXMEM.east |- ALU.brpin 3) -- ++(0.4, 0)
...
\draw[control_path]
    ...
    |- node[control_label, pos=0.1, sloped] {RegWrite} ([yshift=-2mm]FwdUnit.south)
...
\draw[hazard_path_input] (RegFile.blpin 2 -| HDU.bbpin 3) node[red_connector] {} -- (HDU.bbpin 3);
\draw[hazard_path_input] (RegFile.blpin 1 -| HDU.bbpin 4) node[red_connector] {} -- (HDU.bbpin 4);
...
\draw[arrow, blue] (ALUresult -| DmemConnector) node[black_connector] {} 
    ...
    -| ([xshift=-12]ForwardB.blpin 2) coordinate (ForwardB_junction1)
    |- (ForwardA.blpin 2);

\node[black_connector] at (ForwardB_junction1) {};
