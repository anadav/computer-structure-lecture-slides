...
\begin{tikzpicture}[
    ...
    pipeline_reg/.style={draw, thick, fill=gray!20, minimum width=0.3cm, minimum height=6cm},
    ...
    memory_block/.style={muxdemux, muxdemux def={Lh=6, NL=2, Rh=6, NR=1, w=5, square pins=1}, 
...
\node[memory_block, fill=yellow!20] (IMem) at (PC.east) [anchor=west, xshift=0.3cm] {};
...
% Control Unit
\node[control_block, ellipse, minimum height=0.8cm, minimum width=1.2cm] (Control) at (3, 2.5) [rotate=90] {\rotatebox{90}{Control}};
...
\node[draw, thick, fill=red!60, minimum width=0.8cm, minimum height=0.6cm] (HDU_AND) at (Control.east) [anchor=west, xshift=1cm] {AND};
...
% MUXes in EX stage
\node[mux2, fill=orange!20] (ForwardA) at (5.5, 1.2) {};
\node[mux2, fill=orange!20] (ForwardB) at (5.5, 0.2) {};
\node[mux2, fill=blue!20] (RegDstMux) at (5.5, -0.8) {};

% Forwarding Unit
\node[muxdemux, muxdemux def={Lh=2, NL=2, Rh=2, NR=2, w=2.5, square pins=1}, 
      external pins width=0, scale=0.5, fill=orange!30] (FwdUnit) at (6.5, -2) {};
\node[font=\small, align=center] at (FwdUnit.center) {Forwarding\\Unit};
...
\draw[data_path] (ForwardB.east) -- ([yshift=-0.3cm]ALU.west);
...
\draw[hazard_path] (HDU.east) -| ([yshift=0.3cm]HDU.east) |- (HDU_AND.west);
\draw[hazard_path] (HDU_AND.east) -| (Control.west);
