...
\begin{tikzpicture}[
    ...
    validcell/.style={draw, minimum width=0.3cm, minimum height=0.2cm, fill=red!90, font=\tiny, inner sep=0pt, text=white},
    tagcell/.style={draw, minimum width=1.2cm, minimum height=0.2cm, fill=green!20, font=\tiny},
    datacell/.style={draw, minimum width=2.8cm, minimum height=0.2cm, fill=white, font=\tiny},
    offsetbox/.style={draw, minimum width=0.5cm, minimum height=0.2cm, fill=orange!20},
    label/.style={font=\tiny},
    data_connector/.style={circle, fill, inner sep=1pt},
    scale=1, transform shape
]
