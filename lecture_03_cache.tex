...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north] at ([xshift=-2.5cm, yshift=-2cm]set.south) (tag0) {
  |[tagcell]| {\scriptsize Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north west] at ([xshift=0.6cm]tag0.north east) (data0) {
  |[datacell]| {\scriptsize Data} \\
  |[datacell]| \phantom{Data} \\
  |[datacell]| \phantom{Data} \\
  |[datacell]| \phantom{Data} \\
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north] at ([xshift=3.5cm, yshift=-2cm]set.south) (tag1) {
  |[tagcell]| {\scriptsize Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north west] at ([xshift=0.6cm]tag1.north east) (data1) {
  |[datacell]| {\scriptsize Data} \\
  |[datacell]| \phantom{Data} \\
  |[datacell]| \phantom{Data} \\
  |[datacell]| \phantom{Data} \\
...
\begin{tikzpicture}[scale=0.8, transform shape]
  ...
  \begin{scope}[shift={(0,0)}]
    \node[anchor=north, align=center, font=\footnotesize] at (1.25, 4.8) {Different sets, so\\both can reside\\in the cache};
  ...
  \begin{scope}[shift={(3,0)}]
    \node[anchor=north, align=center, font=\footnotesize] at (1.25, 4.8) {Same set, still\\both can reside\\in the cache};
  ...
  \begin{scope}[shift={(6.5,0)}]
    \node[anchor=north, align=center, font=\footnotesize] at (1.25, 4.8) {Same set, both\\cannot reside in\\the cache};
