...
\begin{tikzpicture}[
    ...
    validcell/.style={draw, minimum width=0.3cm, minimum height=0.22cm, fill=red!90, font=\tiny, inner sep=0pt, text=white},
    tagcell/.style={draw, minimum width=1.2cm, minimum height=0.22cm, fill=green!20, font=\tiny},
    datacell/.style={draw, minimum width=2.8cm, minimum height=0.22cm, fill=white, font=\tiny},
    offsetbox/.style={draw, minimum width=0.5cm, minimum height=0.22cm, fill=orange!20},
    label/.style={font=\tiny},
    data_connector/.style={circle, fill, inner sep=1pt},
    scale=1, transform shape
]
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        below=0.5cm of tag_field.south west, anchor=north] (vtag) {
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north west] (data) at ([xshift=3.5cm]vtag-1-2.north east) {
  |[datacell]| Line \\
  |[datacell]| \phantom{Line} \\
  |[datacell]| \phantom{Line} \\
  |[datacell]| \phantom{Line} \\
  |[datacell]| \phantom{Line} \\
  |[datacell]| \phantom{Line} \\
...
% OR gate for hit/miss
\node[or port, number inputs=8, anchor=north, external pins width=0, fill=cyan!20,
      xscale=0.6, yscale=0.25, rotate=-90, below right=0.3cm and 0.4cm of and_gate_8.south, anchor=out] (or_gate) {};
