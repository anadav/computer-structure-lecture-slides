...
\begin{tikzpicture}[baseline=(current bounding box.center),
  idx/.style={minimum width=0.38cm, font=\scriptsize, inner sep=0pt},
  cell/.style={draw, minimum width=0.38cm, minimum height=0.38cm, inner sep=0pt},
  acc/.style={cell, fill=green!40},
  pref/.style={cell, fill=blue!25},
]
\matrix[matrix of nodes, column sep=-\pgflinewidth, row sep=0pt, ampersand replacement=\&] (m) {
  |[idx]| 1 \& |[idx]| 2 \& |[idx]| 3 \& |[idx]| 4 \& |[idx]| 5 \& |[idx]| 6 \& |[idx]| 7 \& |[idx]| 8 \& |[idx]| 9 \\
  |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[pref]| \phantom{0} \& |[pref]| \phantom{0} \& |[pref]| \phantom{0} \& |[pref]| \phantom{0} \\
};
\draw[->, thick, green!60!black] (m-2-1.south) to[bend right=25] (m-2-2.south);
\draw[->, thick, green!60!black] (m-2-2.south) to[bend right=25] (m-2-3.south);
\draw[->, thick, green!60!black] (m-2-3.south) to[bend right=25] (m-2-4.south);
\draw[->, thick, green!60!black] (m-2-4.south) to[bend right=25] (m-2-5.south);
\draw[->, thick, blue] (m-2-5.south) to[bend right=25] (m-2-6.south);
\draw[->, thick, blue] (m-2-6.south) to[bend right=25] (m-2-7.south);
\draw[->, thick, blue] (m-2-7.south) to[bend right=25] (m-2-8.south);
\draw[->, thick, blue] (m-2-8.south) to[bend right=25] (m-2-9.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\matrix[matrix of nodes, column sep=-\pgflinewidth, row sep=0pt, ampersand replacement=\&] (m) {
  |[idx]| 1 \& |[idx]| 2 \& |[idx]| 3 \& |[idx]| 4 \& |[idx]| 5 \& |[idx]| 6 \& |[idx]| 7 \& |[idx]| 8 \& |[idx]| 9 \\
  |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[pref]| \phantom{0} \\
};
\draw[->, thick, green!60!black] (m-2-1.south) to[bend right=30] (m-2-3.south);
\draw[->, thick, green!60!black] (m-2-3.south) to[bend right=30] (m-2-5.south);
\draw[->, thick, green!60!black] (m-2-5.south) to[bend right=30] (m-2-7.south);
\draw[->, thick, blue] (m-2-7.south) to[bend right=30] (m-2-9.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\matrix[matrix of nodes, column sep=-\pgflinewidth, row sep=0pt, ampersand replacement=\&] (m) {
  |[idx]| 1 \& |[idx]| 2 \& |[idx]| 3 \& |[idx]| 4 \& |[idx]| 5 \& |[idx]| 6 \& |[idx]| 7 \& |[idx]| 8 \& |[idx]| 9 \\
  |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| \phantom{0} \& |[acc]| \phantom{0} \& |[pref]| \phantom{0} \\
};
\draw[->, thick, green!60!black] (m-2-1.south) to[bend right=25] (m-2-2.south);
\draw[->, thick, green!60!black] (m-2-2.south) to[bend right=35] (m-2-4.south);
\draw[->, thick, green!60!black] (m-2-4.south) to[bend right=25] (m-2-5.south);
\draw[->, thick, green!60!black] (m-2-5.south) to[bend right=35] (m-2-7.south);
\draw[->, thick, green!60!black] (m-2-7.south) to[bend right=25] (m-2-8.south);
\draw[->, thick, blue] (m-2-8.south) to[bend right=25] (m-2-9.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\begin{tikzpicture}[baseline=(current bounding box.center),
  idx/.style={minimum width=0.38cm, font=\scriptsize, inner sep=0pt},
  cell/.style={draw, minimum width=0.38cm, minimum height=0.38cm, font=\scriptsize, inner sep=0pt},
  acc/.style={cell, fill=green!40},
  pref/.style={cell, fill=blue!25},
]
\matrix[matrix of nodes, column sep=-\pgflinewidth, row sep=0pt, ampersand replacement=\&] (m) {
  |[idx]| 1 \& |[idx]| 2 \& |[idx]| 3 \& |[idx]| 4 \& |[idx]| 5 \& |[idx]| 6 \& |[idx]| 7 \& |[idx]| 8 \& |[idx]| 9 \\
  |[acc]| 3 \& |[cell]| \phantom{0} \& |[acc]| 6 \& |[cell]| \phantom{0} \& |[cell]| \phantom{0} \& |[acc]| 9 \& |[cell]| \phantom{0} \& |[cell]| \phantom{0} \& |[pref]| \phantom{0} \\
};
\draw[->, thick, green!60!black] (m-2-1.south) to[bend right=35] (m-2-3.south);
\draw[->, thick, green!60!black] (m-2-3.south) to[bend right=40] (m-2-6.south);
\draw[->, thick, blue] (m-2-6.south) to[bend right=40] (m-2-9.south);
\end{tikzpicture}
\end{column}
\end{columns}
