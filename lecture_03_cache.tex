...
\begin{tikzpicture}[baseline=(current bounding box.center),
  cell/.style={draw, minimum width=0.32cm, minimum height=0.3cm, font=\tiny, inner sep=0pt},
  acc/.style={cell, fill=green!40},
  pref/.style={cell, fill=blue!25},
]
\matrix[matrix of nodes, column sep=-\pgflinewidth, ampersand replacement=\&,
  nodes={cell}] (m) {
  |[acc]| 1 \& |[acc]| 2 \& |[acc]| 3 \& |[acc]| 4 \& |[acc]| 5 \& |[acc]| 6 \& |[pref]| 7 \& |[pref]| 8 \& |[pref]| 9 \& |[pref]| 10 \\
};
\draw[->, thick, blue] (m-1-6.south) -- ++(0,-0.08) -| (m-1-10.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\matrix[matrix of nodes, column sep=-\pgflinewidth, ampersand replacement=\&,
  nodes={cell}] (m) {
  |[acc]| 1 \& \phantom{0} \& |[acc]| 2 \& \phantom{0} \& |[acc]| 3 \& \phantom{0} \& |[acc]| 4 \& \phantom{0} \& |[pref]| 5 \& |[pref]| \\
};
\draw[->, thick, blue, dashed] (m-1-7.south) to[bend right=15] (m-1-9.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\matrix[matrix of nodes, column sep=-\pgflinewidth, ampersand replacement=\&,
  nodes={cell}] (m) {
  |[acc]| 1 \& |[acc]| 2 \& \phantom{0} \& |[acc]| 3 \& |[acc]| 4 \& \phantom{0} \& |[acc]| 5 \& |[acc]| 6 \& \phantom{0} \& |[pref]| 7 \& |[pref]| \\
};
\draw[->, thick, blue, densely dotted] (m-1-8.south) -- ++(0,-0.08) -| (m-1-11.south);
\end{tikzpicture}
\end{column}
\end{columns}
...
\begin{column}{0.5\textwidth}
\begin{tikzpicture}[baseline=(current bounding box.center),
  idx/.style={minimum width=0.55cm, minimum height=0.25cm, font=\tiny, inner sep=0pt},
  cell/.style={draw, minimum width=0.55cm, minimum height=0.35cm, font=\tiny, inner sep=1pt},
  acc/.style={cell, fill=green!40},
  pref/.style={cell, fill=blue!25},
]
% Top row: cache line indices
\matrix[matrix of nodes, column sep=-\pgflinewidth, ampersand replacement=\&,
  nodes={idx}] (idx) at (0,0.3) {
  1 \& 2 \& 3 \& 4 \& 5 \& 6 \\
};
% Bottom row: contents (some look like pointers)
\matrix[matrix of nodes, column sep=-\pgflinewidth, ampersand replacement=\&,
  nodes={cell}] (m) at (0,0) {
  |[acc]| \& |[acc]| 4 \& \phantom{00} \& |[acc]| 6 \& \phantom{00} \& |[pref]| \\
};
% Access arrows (green, curved above)
\draw[->, thick, green!60!black] (m-1-1.north) to[bend left=40] (m-1-2.north);
\draw[->, thick, green!60!black] (m-1-2.north) to[bend left=40] (m-1-4.north);
% Prefetch arrow (blue, curved below)
\draw[->, thick, blue] (m-1-4.south) to[bend right=30] (m-1-6.south);
\end{tikzpicture}
\end{column}
\end{columns}
