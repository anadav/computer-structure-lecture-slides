...
\begin{center}
\begin{tikzpicture}
  % Processor 0 timeline
  \node[font=\bfseries] (p0) at (0.8, 0) {Processor 0};
  \node[font=\scriptsize, gray] at (-1.3, -0.8) {S1};
  \node[hbinstr] (s1) at (-0.8, -0.8) {Store [\textcolor{varX}{X}] <- 1};
  \node[font=\scriptsize, gray] at (-1.3, -2.0) {S2};
  \node[hbinstr] (s2) at (-0.8, -2.0) {Store [\textcolor{varY}{Y}] <- 1};

  % Processor 1 timeline
  \node[font=\bfseries] (p1) at (8, 0) {Processor 1};
  \node[hbinstr] (l1) at (6.2, -0.8) {r1 <- Load [\textcolor{varY}{Y}]};
  \node[font=\scriptsize, gray] at (9.5, -0.8) {L1};
  \node[hbinstr] (l2) at (6.2, -2.0) {r2 <- Load [\textcolor{varX}{X}]};
  \node[font=\scriptsize, gray] at (9.5, -2.0) {L2};

  % Arrow 1: S1 -> S2 (program order)
  \draw[hbprogorder] ([xshift=-0.3cm]s1.south) -- ([xshift=-0.3cm]s2.north)
    node[hblabel, midway, left=2pt, draw, thin] {1};

  % Arrow 2: L1 -> L2 (program order)
  \draw[hbprogorder] ([xshift=-0.3cm]l1.south) -- ([xshift=-0.3cm]l2.north)
    node[hblabel, midway, left=2pt, draw, thin] {2};

  % Arrow 3: S2 -> L1 (cross-processor, Y variable)
  \draw[hbcross, varY] (s2.east) to[out=15, in=165]
    node[hblabel, above=1pt, pos=0.5, draw, thin] {3} (l1.west);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  % Processor 0 timeline
  \node[font=\bfseries] (p0) at (0.8, 0) {Processor 0};
  \node[font=\scriptsize, gray] at (-1.3, -0.8) {L1};
  \node[hbinstr] (l1) at (-0.8, -0.8) {r1 <- Load [\textcolor{varX}{X}]};
  \node[font=\scriptsize, gray] at (-1.3, -2.0) {S1};
  \node[hbinstr] (s1) at (-0.8, -2.0) {Store [\textcolor{varY}{Y}] <- 1};

  % Processor 1 timeline
  \node[font=\bfseries] (p1) at (8, 0) {Processor 1};
  \node[hbinstr] (l2) at (6.2, -0.8) {r2 <- Load [\textcolor{varY}{Y}]};
  \node[font=\scriptsize, gray] at (9.5, -0.8) {L2};
  \node[hbinstr] (s2) at (6.2, -2.0) {Store [\textcolor{varX}{X}] <- 1};
  \node[font=\scriptsize, gray] at (9.5, -2.0) {S2};

  % Arrow 1: L1 -> S1 (program order)
  \draw[hbprogorder] ([xshift=-0.3cm]l1.south) -- ([xshift=-0.3cm]s1.north)
    node[hblabel, midway, left=2pt, draw, thin] {1};

  % Arrow 2: L2 -> S2 (program order)
  \draw[hbprogorder] ([xshift=-0.3cm]l2.south) -- ([xshift=-0.3cm]s2.north)
    node[hblabel, midway, left=2pt, draw, thin] {2};

  % Arrow 3: S2 -> L1 (cross-processor, X variable)
  \draw[hbcross, varX] (s2.west) to[out=170, in=-10]
  ...
  \draw[hbcross, varY] (s1.east) to[out=10, in=190]
    node[hblabel, above=1pt, pos=0.5, draw, thin] {4} (l2.west);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
  ...
  \node[font=\scriptsize, gray] at (-1.3, -0.8) {S1};
  \node[hbinstr] (s1) at (-0.8, -0.8) {Store [\textcolor{varX}{X}] <- 1};
  \node[font=\scriptsize, gray] at (-1.3, -2.0) {L1};
  \node[hbinstr] (l1) at (-0.8, -2.0) {r1 <- Load [\textcolor{varY}{Y}]};

  % Processor 1 timeline
  \node[font=\bfseries] (p1) at (8, 0) {Processor 1};
  \node[hbinstr] (s2) at (6.2, -0.8) {Store [\textcolor{varY}{Y}] <- 1};
  \node[font=\scriptsize, gray] at (9.5, -0.8) {S2};
  \node[hbinstr] (l2) at (6.2, -2.0) {r2 <- Load [\textcolor{varX}{X}]};
  \node[font=\scriptsize, gray] at (9.5, -2.0) {L2};

  % NO program order arrows - that's the point!
  % Show crossed-out arrows to emphasize no ordering
  \draw[gray!50, dashed, thick] ([xshift=-0.3cm]s1.south) -- ([xshift=-0.3cm]l1.north);
  \node[font=\scriptsize, red!70!black] at (-1.6, -1.4) {\texttimes};

  \draw[gray!50, dashed, thick] ([xshift=-0.3cm]s2.south) -- ([xshift=-0.3cm]l2.north);
  \node[font=\scriptsize, red!70!black] at (5.6, -1.4) {\texttimes};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[xscale=0.95]
  % Processor 0 timeline
  \node[font=\bfseries\footnotesize] (p0) at (-0.2, 0) {Processor 0};
  \node[font=\scriptsize, gray] at (-2.0, -0.8) {S1};
  \node[hbinstr, font=\ttfamily\footnotesize] (s1) at (-1.6, -0.8) {Store [\textcolor{varX}{X}] <- 1};

  % Processor 1 timeline (3 instructions)
  \node[font=\bfseries\footnotesize] (p1) at (4.5, 0) {Processor 1};
  \node[font=\scriptsize, gray] at (2.7, -0.8) (l1label) {L1};
  \node[hbinstr, font=\ttfamily\footnotesize] (l1) at (3.1, -0.8) {r1 <- Load [\textcolor{varX}{X}]};
  \node[font=\scriptsize, gray] at (2.7, -1.7) {S2};
  \node[hbinstr, font=\ttfamily\footnotesize] (s2) at (3.1, -1.7) {Store [\textcolor{varY}{Y}] <- 1};
  \node[font=\scriptsize, gray] at (2.7, -2.6) {L2};
  \node[hbinstr, font=\ttfamily\footnotesize] (l2) at (3.1, -2.6) {r2 <- Load [\textcolor{varY}{Y}]};

  % Processor 2 timeline
  \node[font=\bfseries\footnotesize] (p2) at (9.2, 0) {Processor 2};
  \node[hbinstr, font=\ttfamily\footnotesize] (l3) at (8.0, -0.8) {r3 <- Load [\textcolor{varX}{X}]};
  \node[font=\scriptsize, gray] at (10.5, -0.8) {L3};

  % Arrow 1: S1 -> L1 (cross-processor, X variable)
  \draw[hbcross, varX] (s1.east) to[out=0, in=180]
    node[hblabel, above=0pt, pos=0.5, draw, thin] {1} (l1label.west);

  % Arrow 2: L1 -> S2 (program order)
  \draw[hbprogorder] ([xshift=-0.15cm]l1.south) -- ([xshift=-0.15cm]s2.north)
    node[hblabel, midway, left=1pt, draw, thin] {2};

  % Arrow 3: S2 -> L2 (program order / reads-from Y)
  \draw[hbprogorder] ([xshift=-0.15cm]s2.south) -- ([xshift=-0.15cm]l2.north)
    node[hblabel, midway, left=1pt, draw, thin] {3};

  % Arrow 4: implied S1 -> L3 (transitivity forces this)
  \draw[hbcross, varX, densely dotted] (s1.south east) to[out=-20, in=160]
    node[hblabel, below=0pt, pos=0.4, draw, thin] {4} (l3.west);
\end{tikzpicture}
\end{center}
...
\begin{enumerate}
  ...
  \item S1 $\rightarrow$ L3 --- transitivity: S1 visible to system $\Rightarrow$ L3 must see X=1, so r3=1
\end{enumerate}
\end{frame}
