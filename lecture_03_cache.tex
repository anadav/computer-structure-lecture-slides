...
\begin{itemize}
  ...
  \item Performance gap grew $\sim$50\%/year historically --- motivation for caches
\end{itemize}
\vspace{0.2cm}
\centering
\includegraphics[width=0.75\textwidth]{figures/processor_memory_gap.png}\\[0.1cm]
{\tiny Source: Mittal \& Vetter, IJCSIT 2015}
\end{frame}
