...
\begin{tikzpicture}
  \matrix[matrix of nodes,
    ...
    column 1/.style={nodes={font=\bfseries, anchor=east, minimum width=1.5cm}},
    column 2/.style={nodes={anchor=east, minimum width=2cm}},
    column 3/.style={nodes={minimum width=10cm}},
    column 4/.style={nodes={anchor=west, minimum width=2cm}},
  ] (m) {
    Speed: \& \textcolor{green!70!black}{Fastest} \& \& \textcolor{red!80!black}{Slowest} \\
    Size: \& \textcolor{red!80!black}{Smallest} \& \& \textcolor{green!70!black}{Biggest} \\
    Cost: \& \textcolor{red!80!black}{Highest} \& \& \textcolor{green!70!black}{Lowest} \\
    Power: \& \textcolor{red!80!black}{Highest} \& \& \textcolor{green!70!black}{Lowest} \\
  };
  % Draw arrows
  \foreach \row in {1,2,3,4} {
    \draw[->, thick, gray] (m-\row-2.east) ++(0.2,0) -- ($(m-\row-4.west)+(-0.2,0)$);
  }
\end{tikzpicture}
\end{center}
\end{frame}
