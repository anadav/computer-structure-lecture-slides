...
\begin{tikzpicture}[
    ...
    datacell/.style={basecell, minimum width=2.8cm, fill=white},
...
\matrix[matrix of nodes,
        ...
        ampersand replacement=\&,
        anchor=north west] (data) at ([xshift=1.5cm,yshift=3.25mm]and_gate_1.out) {
...
% OR gate for hit/miss
\node[or port, number inputs=8, anchor=north, external pins width=0, fill=cyan!20,
      xscale=0.6, yscale=0.25, rotate=-90, below right=0.7cm and 0.8cm of and_gate_8.south, anchor=out] (or_gate) {};
