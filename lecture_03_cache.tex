...
\begin{frame}{Multi-processor System: Write Serialization (1/2)}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{A memory system is \emph{coherent} if:}
\begin{itemize}
...
\begin{tikzpicture}[scale=0.7, every node/.style={font=\scriptsize}]
  ...
  % Processor 1
  \node[draw, thick, fill=green!20, minimum width=2.2cm, minimum height=2.4cm, align=center, anchor=south west] (p1) at ([yshift=15]l2.north west) {};
  \node[above] at (p1.north) {\textbf{Processor 1}};
  \node[draw, thick, fill=lightgray!20, minimum width=1.9cm, minimum height=1.5cm, text depth=0.9cm] (l1p1) at (p1.center) {L1 cache};
  \node[draw, fill=white, font=\scriptsize\ttfamily, anchor=south] (x1) at ([yshift=1mm]l1p1.south) {X=0};

  % Processor 2
  \node[draw, thick, fill=green!20, minimum width=2.2cm, minimum height=2.4cm, align=center, anchor=south east] (p2) at ([yshift=15]l2.north east) {};
  \node[above] at (p2.north) {\textbf{Processor 2}};
  \node[draw, thick, fill=lightgray!20, minimum width=1.9cm, minimum height=1.5cm, text depth=0.9cm] (l1p2) at (p2.center) {L1 cache};
  ...
  \node[rectangle callout, callout absolute pointer={(x1.west)}, draw, fill=yellow!20,
        ...
        at (p1.west) {P1 writes\\X$\leftarrow$0};
  \node[rectangle callout, callout absolute pointer={(x2.east)}, draw, fill=yellow!20,
        ...
        at (p2.east) {P2 sees\\X=0};
\end{tikzpicture}
\end{column}
\end{columns}
\end{frame}

\begin{frame}{Multi-processor System: Write Serialization (2/2)}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{A memory system is \emph{coherent} if:}
\begin{itemize}
...
\begin{tikzpicture}[scale=0.7, every node/.style={font=\scriptsize}]
  ...
  \node[rectangle callout, callout absolute pointer={(x1.west)}, draw, fill=yellow!20,
        font=\scriptsize, align=center, text width=1.4cm, anchor=east]
        at (p1.west) {P1 sees\\X=1};
  \node[rectangle callout, callout absolute pointer={(x2.east)}, draw, fill=yellow!20,
        font=\scriptsize, align=center, text width=1.4cm, anchor=west]
        at (p2.east) {P2 writes\\X$\leftarrow$1};
\end{tikzpicture}
\end{column}
\end{columns}
...
\begin{center}
\begin{tikzpicture}
  \node[draw, fill=red!15, rounded corners, font=\small, text width=9cm, align=center] {
    \textbf{Coherence guarantee:} All processors see writes in the same order\\[2pt]
    Both saw X: 0 $\rightarrow$ 1. ~P2 seeing 1 $\rightarrow$ 0 is \textbf{not allowed}.
  };
\end{tikzpicture}
\end{center}
\end{frame}
