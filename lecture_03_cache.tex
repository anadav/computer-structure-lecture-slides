...
\definecolor{capacityyellow}{RGB}{255,220,0}
...
\addplot[capacityyellow] fill between[of=compulsory and eightway];
...
\node[lbl, anchor=west] (lbl2) at (axis cs:55,0.092) {2-way};
\draw[->, thick] (lbl2.west) -- (axis cs:26,0.08);
\node[lbl, anchor=west] (lbl4) at (axis cs:120,0.064) {4-way};
\draw[->, thick] (lbl4.west) -- (axis cs:37,0.058);
\node[lbl, anchor=west] (lbl8) at (axis cs:160,0.042) {8-way};
\draw[->, thick] (lbl8.west) -- (axis cs:65,0.038);

% Miss type labels (Conflict in upper right, no arrow)
\node[misslbl, rotate=-32] at (axis cs:280,0.085) {Conflict};
\node[misslbl, anchor=west] (caplab) at (axis cs:380,0.055) {Capacity};
\draw[->, thick] (caplab.west) -- (axis cs:180,0.015);
\node[misslbl] (complab) at (axis cs:800,0.04) {Compulsory};
\draw[->, thick] (complab.south) -- (axis cs:650,0.05);
\end{axis}
\end{tikzpicture}
\end{column}
\end{columns}
