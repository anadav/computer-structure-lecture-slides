...
% Associativity labels with arrows pointing to curves (inside plot area)
\node[font=\scriptsize, anchor=south west] (lbl1) at (axis cs:17,0.118) {1-way};
\draw[->, thick] (lbl1.south east) -- (axis cs:26,0.112);
\node[font=\scriptsize, anchor=south west] (lbl2) at (axis cs:22,0.082) {2-way};
\draw[->, thick] (lbl2.south east) -- (axis cs:38,0.070);
\node[font=\scriptsize, anchor=south west] (lbl4) at (axis cs:32,0.057) {4-way};
\draw[->, thick] (lbl4.south east) -- (axis cs:55,0.048);
\node[font=\scriptsize, anchor=south west] (lbl8) at (axis cs:50,0.042) {8-way};
\draw[->, thick] (lbl8.south east) -- (axis cs:85,0.035);

% Miss type labels (Conflict in upper right, no arrow)
\node[font=\small\bfseries, rotate=-32] at (axis cs:120,0.105) {Conflict};
\node[font=\small\bfseries] at (axis cs:450,0.040) {Capacity};
\draw[->, thick] (axis cs:520,0.034) -- (axis cs:650,0.018);
\node[font=\small\bfseries] at (axis cs:1200,0.020) {Compulsory};
\draw[->, thick] (axis cs:1350,0.015) -- (axis cs:1500,0.005);
\end{axis}
\end{tikzpicture}
\end{column}
\end{columns}
