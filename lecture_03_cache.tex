...
\node[anchor=south west, font=\tiny] at (tag.north west) {39};
\node[anchor=south east, font=\tiny] at (tag.north east) {14};
\node[anchor=south east, font=\tiny] at (set.north east) {6};
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north] at ([xshift=-0.5cm, yshift=-2.2cm]set.south) (tagmat) {
