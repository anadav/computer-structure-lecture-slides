...
% Way 0 comparator
\node[muxdemux, muxdemux def={Lh=0.6, Rh=0.3, NL=2, NB=1, w=0.5},
      external pins width=0, fill=green!30, rotate=270] at ([xshift=5mm, yshift=-0.5cm]tag0.south east) (comp0) {};
...
\matrix[matrix of nodes,
        column sep=0pt, row sep=0pt,
        ampersand replacement=\&,
        anchor=north] at ([xshift=2.5cm, yshift=-2cm]set.south) (tag1) {
  |[tagcell]| {\scriptsize Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
  |[tagcell]| \phantom{Tag} \\
...
% Way 1 comparator
\node[muxdemux, muxdemux def={Lh=0.6, Rh=0.3, NL=2, NB=1, w=0.5},
      external pins width=0, fill=green!30, rotate=270] at ([xshift=5mm, yshift=-5mm]tag1.south east) (comp1) {};
