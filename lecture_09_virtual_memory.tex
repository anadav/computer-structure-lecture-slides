...
\begin{tikzpicture}[
    ...
    \draw[->, thick, blue!60] (cpu0.lpin 2) -- ++(-2mm,0) |- node[lbl, below] {inv} (tlb0.west);
    \draw[->, thick, blue!60] (cpu1.rpin 2) -- ++(2mm,0) |- node[lbl, below] {inv} (tlb1.east);
    \draw[->, thick, blue!60] (cpu2.lpin 2) -- ++(-2mm,0) |- node[lbl, below] {inv} (tlb2.west);
    \draw[->, thick, blue!60] (cpu3.rpin 2) -- ++(2mm,0) |- node[lbl, below] {inv} (tlb3.east);
...
\begin{tikzpicture}[
    ...
    \node[cpublock, below left=12mm and 8mm of interconnect.south] (cpu0) {};
    \node[cpulbl] at ([yshift=-1mm]cpu0.north) {CPU 0};
    \node[tlbbox] (tlb0) at (cpu0.south) {TLB};
    ...
    % Hardware broadcast lines from interconnect to CPUs
    ...
    % Local TLB invalidation: left CPUs from lpin to TLB west, right CPUs from rpin to TLB east
    \draw[->, thick, blue!60] (cpu0.lpin 2) -- ++(-2mm,0) |- node[lbl, pos=0.75, left] {inv} (tlb0.west);
    \draw[->, thick, blue!60] (cpu1.rpin 2) -- ++(2mm,0) |- node[lbl, pos=0.75, right] {inv} (tlb1.east);
    \draw[->, thick, blue!60] (cpu2.lpin 2) -- ++(-2mm,0) |- node[lbl, pos=0.75, left] {inv} (tlb2.west);
    \draw[->, thick, blue!60] (cpu3.rpin 2) -- ++(2mm,0) |- node[lbl, pos=0.75, right] {inv} (tlb3.east);
