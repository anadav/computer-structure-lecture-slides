...
\draw[arrow] (pml4label) -- ++(0, -0.8) -| ([xshift=-5mm]pml4d3.west) -- (pml4d3.west);
\draw[arrow] (pdplabel) -- ++(0, -0.8) -| ([xshift=-5mm]pdp82.west) -- (pdp82.west);
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-5mm]dirff.west) -- (dirff.west);
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-5mm]ptee2.west) -- (ptee2.west);
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-5mm]pageb25.west) -- (pageb25.west);
