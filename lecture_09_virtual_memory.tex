...
\node[pml4entry] (pml4d3) at ($(pml4base.south)!0.827!(pml4base.north)$) {}; % D3 = 211/255
\node[pml4entry] (pml471) at ($(pml4base.south)!0.443!(pml4base.north)$) {}; % 71 = 113/255
...
\node[pdpentry] (pdp82) at ($(pdp82base.south)!0.510!(pdp82base.north)$) {}; % 82 = 130/255

\node[pdptable] (pdp46base) at (4,3.5) {};
\node[pdpentry] (pdp46) at ($(pdp46base.south)!0.275!(pdp46base.north)$) {}; % 46 = 70/255

% Page Dir instances
\node[dirtable] (dirffbase) at (7,7) {};
\node[font=\scriptsize, anchor=south] at (dirffbase.north) {Page Dir};
\node[direntry] (dirff) at ($(dirffbase.south)!1.0!(dirffbase.north)$) {}; % FF = 255/255
\node[direntry] (dir28) at ($(dirffbase.south)!0.157!(dirffbase.north)$) {}; % 28 = 40/255

\node[dirtable] (dirb5base) at (7,2.5) {};
\node[direntry] (dirb5) at ($(dirb5base.south)!0.710!(dirb5base.north)$) {}; % B5 = 181/255

% Page Table instances
\node[pagetable] (pte2base) at (10,8) {};
\node[font=\scriptsize, anchor=south] at (pte2base.north) {Page Table};
\node[pageentry] (ptee2) at ($(pte2base.south)!0.886!(pte2base.north)$) {}; % E2 = 226/255
\node[pageentry] (pte68) at ($(pte2base.south)!0.408!(pte2base.north)$) {}; % 68 = 104/255

\node[pagetable] (pte49base) at (10,5) {};
\node[pageentry] (pte49) at ($(pte49base.south)!0.286!(pte49base.north)$) {}; % 49 = 73/255

\node[pagetable] (pte54base) at (10,2.5) {};
\node[pageentry] (pte54) at ($(pte54base.south)!0.329!(pte54base.north)$) {}; % 54 = 84/255

% 4KB Pages with offsets
\node[page] (pageb25base) at (13,8.8) {};
\node[font=\scriptsize, anchor=south] at (pageb25base.north) {4KB Page};
\node[pageoffset] (pageb25) at ($(pageb25base.south)!0.697!(pageb25base.north)$) {}; % B25 = 2853/4095
\node[pageoffset] (page349) at ($(pageb25base.south)!0.205!(pageb25base.north)$) {}; % 349 = 841/4095

\node[page] (page937base) at (13,5.8) {};
\node[pageoffset] (page937) at ($(page937base.south)!0.576!(page937base.north)$) {}; % 937 = 2359/4095

\node[page] (pagec00base) at (13,3.5) {};
\node[pageoffset] (pagec00) at ($(pagec00base.south)!0.750!(pagec00base.north)$) {}; % C00 = 3072/4095

\node[page] (page622base) at (13,1.2) {};
\node[pageoffset] (page622) at ($(page622base.south)!0.383!(page622base.north)$) {}; % 622 = 1570/4095

% Paths from address fields to table entries
% PML4 entries
\draw[arrow] (pml4label) -- ++(0, -0.8) -| ([xshift=-10mm]pml4d3.west) -- (pml4d3.west) node[entrytag] {D3};
\draw[arrow] (pml4label) -- ++(0, -0.8) -| ([xshift=-10mm]pml471.west) -- (pml471.west) node[entrytag] {71};

% PDP entries
\draw[arrow] (pdplabel) -- ++(0, -0.8) -| ([xshift=-10mm]pdp82.west) -- (pdp82.west) node[entrytag] {82};
\draw[arrow] (pdplabel) -- ++(0, -0.8) -| ([xshift=-10mm]pdp46.west) -- (pdp46.west) node[entrytag] {46};

% DIR entries
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dirff.west) -- (dirff.west) node[entrytag] {FF};
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dir28.west) -- (dir28.west) node[entrytag] {28};
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dirb5.west) -- (dirb5.west) node[entrytag] {B5};

% TABLE entries
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]ptee2.west) -- (ptee2.west) node[entrytag] {E2};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte68.west) -- (pte68.west) node[entrytag] {68};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte49.west) -- (pte49.west) node[entrytag] {49};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte54.west) -- (pte54.west) node[entrytag] {54};

% OFFSET entries
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]pageb25.west) -- (pageb25.west) node[entrytag] {B25};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page349.west) -- (page349.west) node[entrytag] {349};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page937.west) -- (page937.west) node[entrytag] {937};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]pagec00.west) -- (pagec00.west) node[entrytag] {C00};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page622.west) -- (page622.west) node[entrytag] {622};
...
\node[font=\small\ttfamily, anchor=west, right=2cm of pageb25] {
...
\node[font=\small\ttfamily, anchor=west, right=2cm of page349] {
...
\node[font=\small\ttfamily, anchor=west, right=2cm of page937] {
...
\node[font=\small\ttfamily, anchor=west, right=2cm of pagec00] {
...
\node[font=\small\ttfamily, anchor=west, right=2cm of page622] {
