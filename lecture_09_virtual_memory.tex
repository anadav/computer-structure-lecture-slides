...
\node[pml4entry] (pml4d3) at ([yshift=1.6cm]pml4base.south) {};
\node[pml4entry] (pml471) at ([yshift=0.1cm]pml4base.south) {};
...
\node[pdpentry] (pdp82) at ([yshift=1.8cm]pdp82base.south) {};
\node[pdpentry] (pdp46) at ([yshift=0.1cm]pdp82base.south) {};

% Page Dir instances
\node[dirtable] (dirffbase) at (7,7) {};
\node[font=\scriptsize, anchor=south] at (dirffbase.north) {Page Dir};
\node[direntry] (dirff) at ([yshift=2.0cm]dirffbase.south) {};
\node[direntry] (dir28) at ([yshift=0.6cm]dirffbase.south) {};

\node[dirtable] (dirb5base) at (7,2.5) {};
\node[direntry] (dirb5) at ([yshift=1.5cm]dirb5base.south) {};

% Page Table instances
\node[pagetable] (pte2base) at (10,8) {};
\node[font=\scriptsize, anchor=south] at (pte2base.north) {Page Table};
\node[pageentry] (ptee2) at ([yshift=1.9cm]pte2base.south) {};
\node[pageentry] (pte68) at ([yshift=0.6cm]pte2base.south) {};

\node[pagetable] (pte49base) at (10,3.5) {};
\node[pageentry] (pte49) at ([yshift=1.8cm]pte49base.south) {};
\node[pageentry] (pte54) at ([yshift=0.1cm]pte49base.south) {};

% 4KB Pages with offsets
\node[page] (pageb25base) at (13,8.8) {};
\node[font=\scriptsize, anchor=south] at (pageb25base.north) {4KB Page};
\node[pageoffset] (pageb25) at ([yshift=1.9cm]pageb25base.south) {};
\node[pageoffset] (page349) at ([yshift=1.1cm]pageb25base.south) {};

\node[page] (page937base) at (13,5.8) {};
\node[pageoffset] (page937) at ([yshift=1.8cm]page937base.south) {};

\node[page] (pagec00base) at (13,3.5) {};
\node[pageoffset] (pagec00) at ([yshift=1.8cm]pagec00base.south) {};

\node[page] (page622base) at (13,1.2) {};
\node[pageoffset] (page622) at ([yshift=1.8cm]page622base.south) {};
