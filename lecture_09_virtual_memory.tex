...
\begin{tikzpicture}[
    ...
    node distance=2mm,
    vabox/.style={ellipse, draw, fill=yellow!20, font=\scriptsize, inner sep=1pt, minimum width=14mm, minimum height=5mm},
    ...
    entrybox/.style={ellipse, draw, fill=blue!15, font=\scriptsize, inner sep=1pt, align=center, minimum width=14mm, minimum height=5mm},
...
\draw[arrow] (pml4l1.west) -- ++(-0.15,0) |- node[near start, left, ymark] {Yes} (pml4e.west);
\draw[arrow] (pml4l2.west) -- ++(-0.2,0) |- (pml4e.west);
\draw[arrow] (pml4l3.west) -- ++(-0.25,0) |- (pml4e.west);
\draw[arrow] (pml4mem.west) -- ++(-0.3,0) |- (pml4e.west);

\draw[arrow] (pdpl1.west) -- ++(-0.15,0) |- node[near start, left, ymark] {Yes} (pdpe.west);
\draw[arrow] (pdpl2.west) -- ++(-0.2,0) |- (pdpe.west);
\draw[arrow] (pdpl3.west) -- ++(-0.25,0) |- (pdpe.west);
\draw[arrow] (pdpmem.west) -- ++(-0.3,0) |- (pdpe.west);

\draw[arrow] (pdel1.west) -- ++(-0.15,0) |- node[near start, left, ymark] {Yes} (pdee.west);
\draw[arrow] (pdel2.west) -- ++(-0.2,0) |- (pdee.west);
\draw[arrow] (pdel3.west) -- ++(-0.25,0) |- (pdee.west);
\draw[arrow] (pdemem.west) -- ++(-0.3,0) |- (pdee.west);

% PT cache chain goes to PTE
\draw[arrow] (ptl1.east) -- ++(0.15,0) |- node[near start, right, ymark] {Yes} (pte.south);
\draw[arrow] (ptl2.east) -- ++(0.2,0) |- (pte.south);
\draw[arrow] (ptl3.east) -- ++(0.25,0) |- (pte.south);
\draw[arrow] (ptmem.east) -- ++(0.3,0) |- (pte.south);
