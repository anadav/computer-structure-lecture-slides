...
\node[font=\small\ttfamily, anchor=west] (addr1) at ([xshift=7mm]pageb25.west) {
\textcolor{green!40!black}{00000} \tikzmark{pml4start}\textcolor{yellow!40!black}{D3}\tikzmark{pml4end} \tikzmark{pdpstart}\textcolor{red!40!black}{82}\tikzmark{pdpend} \tikzmark{dirstart}\textcolor{blue!20!black}{FF}\tikzmark{dirend} \tikzmark{ptestart}\textcolor{blue!40!black}{E2}\tikzmark{pteend} \tikzmark{offsetstart}\textcolor{orange!60!black}{B25}\tikzmark{offsetend}
};
\node[font=\small\ttfamily, anchor=west] at ([xshift=7mm]page349.west) {
...
\node[font=\small\ttfamily, anchor=west] at ([xshift=7mm]page937.west) {
...
\node[font=\small\ttfamily, anchor=west] at ([xshift=7mm]pagec00.west) {
...
\node[font=\small\ttfamily, anchor=west] at ([xshift=7mm]page622.west) {
...
% Field labels above the first address using tikzmarks
\node[font=\scriptsize, text=yellow!40!black] at ($(pic cs:pml4start)!0.5!(pic cs:pml4end)+(0,0.3)$) {PML4};
\node[font=\scriptsize, text=red!40!black] at ($(pic cs:pdpstart)!0.5!(pic cs:pdpend)+(0,0.3)$) {PDP};
\node[font=\scriptsize, text=blue!20!black] at ($(pic cs:dirstart)!0.5!(pic cs:dirend)+(0,0.3)$) {DIR};
\node[font=\scriptsize, text=blue!40!black] at ($(pic cs:ptestart)!0.5!(pic cs:pteend)+(0,0.3)$) {PTE};
\node[font=\scriptsize, text=orange!60!black] at ($(pic cs:offsetstart)!0.5!(pic cs:offsetend)+(0,0.3)$) {offset};

% Note about 8 bits
\node[font=\scriptsize, draw=black, thick, fill=red!10, align=center, text width=2.5cm,
      rectangle callout, callout absolute pointer={(-0.2,11.3)}] at (-2,9.5) {8 bits instead of 9 for example purposes only};
