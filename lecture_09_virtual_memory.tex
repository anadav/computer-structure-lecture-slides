...
\node[rectangle, draw, thick, fill=yellow!20, minimum height=1.2cm, minimum width=1.5cm,
      right=2.5cm of stlb] (pmh) {};
...
\node[bigbox, fill=gray!10, fit=(stlb)(pmh)(pmhlabel), inner sep=3mm] (transbox) {};
\end{scope}
...
\draw[arrow, red, thick] (l1data.south) -- ++(0,-3mm) -| node[near start, right, label] {Load} (pmh.north);
