...
%    \node[font=\tiny, red, align=center] at ([xshift=10mm]pte_matrix-6-3.east) {64KB\\aligned};
   ...
   % Arrow with label for contiguous block
    ...
    \draw[->, thick, blue] ([xshift=-4mm]va.south) -- ++(0,-5mm) node[pos=0.7, below=2pt, font=\tiny] {Page-walk} -| (pte_matrix.north);
    \draw[->, thick, blue] ([xshift=4mm]va.south) -- ++(0,-5mm) node[pos=0.98, below, font=\tiny] {Lookup} -| (tlb_box.north);
\end{tikzpicture}
\end{center}
\end{column}
\end{columns}
