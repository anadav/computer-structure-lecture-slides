...
\node[font=\scriptsize] at (3.5,10.9) {PML4};
\node[font=\scriptsize] at (5.5,10.9) {PDP};
\node[font=\scriptsize] at (7.5,10.9) {DIR};
\node[font=\scriptsize] at (9.5,10.9) {TABLE};
\node[font=\scriptsize] at (12,10.9) {OFFSET};
...
\node[font=\scriptsize] at (1,6) {PML4};
\node[font=\scriptsize] at (1,5.6) {Table};
\node[pml4entry] (pml4d3) at (1,4.3) {\scriptsize D3};
\node[pml4entry] (pml471) at (1,2.7) {\scriptsize 71};
...
\node[font=\scriptsize] at (4,7.3) {PDP};
\node[font=\scriptsize] at (4,6.9) {Table};
\node[pdpentry] (pdp82) at (4,5.6) {\scriptsize 82};
\node[pdpentry] (pdp46) at (4,2.5) {\scriptsize 46};

% Page Dir instances
\node[dirtable] (dirffbase) at (7,7) {};
\node[font=\scriptsize] at (7,8.2) {Page};
\node[font=\scriptsize] at (7,7.8) {Dir};
\node[direntry] (dirff) at (7,6.8) {\scriptsize FF};
\node[direntry] (dir28) at (7,5) {\scriptsize 28};

\node[dirtable] (dirb5base) at (7,2.5) {};
\node[direntry] (dirb5) at (7,2.2) {\scriptsize B5};

% Page Table instances
\node[pagetable] (pte2base) at (10,8) {};
\node[font=\scriptsize] at (10,9.3) {Page};
\node[font=\scriptsize] at (10,8.9) {Table};
\node[pageentry] (ptee2) at (10,7.7) {\scriptsize E2};
\node[pageentry] (pte68) at (10,6) {\scriptsize 68};

\node[pagetable] (pte49base) at (10,3.5) {};
\node[pageentry] (pte49) at (10,3.3) {\scriptsize 49};
\node[pageentry] (pte54) at (10,1.5) {\scriptsize 54};

% 4KB Pages with offsets
\node[page] (pageb25base) at (13,8.8) {};
\node[font=\scriptsize] at (13,9.9) {4KB};
\node[font=\scriptsize] at (13,9.5) {Page};
\node[pageoffset] (pageb25) at (13,8.5) {\scriptsize B25};
\node[pageoffset] (page349) at (13,7.7) {\scriptsize 349};

\node[page] (page937base) at (13,5.8) {};
\node[pageoffset] (page937) at (13,5.6) {\scriptsize 937};

\node[page] (pagec00base) at (13,3.5) {};
\node[pageoffset] (pagec00) at (13,3.3) {\scriptsize C00};

\node[page] (page622base) at (13,1.2) {};
\node[pageoffset] (page622) at (13,1) {\scriptsize 622};

% Arrows connecting the hierarchy
% PML4[D3] -> PDP
\draw[arrow] (pml4d3.east) -| (pdp82base.south);
% PML4[71] -> PDP[46] (dashed to show it's the same PDP table, different entry)
\draw[arrow] (pml471.east) -| (pdp46.west);

% PDP[82] -> Dir[FF,28]
\draw[arrow] (pdp82.east) -| (dirffbase.south);
% PDP[46] -> Dir[B5]
\draw[arrow] (pdp46.east) -| (dirb5base.south);

% Dir[FF] -> PT[E2,68]
\draw[arrow] (dirff.east) -| (pte2base.south);
% Dir[28] -> PT[49,54]
\draw[arrow] (dir28.east) -| (pte49base.south);
% Dir[B5] -> same PT[49,54]
\draw[arrow] (dirb5.east) -| (pte54.west);

% PT[E2] -> Page[B25,349]
\draw[arrow] (ptee2.east) -| (pageb25base.south);
% PT[68] -> Page[937]
\draw[arrow] (pte68.east) -| (page937base.south);
% PT[49] -> Page[C00]
\draw[arrow] (pte49.east) -| (pagec00base.south);
% PT[54] -> Page[622]
\draw[arrow] (pte54.east) -| (page622base.south);

% Right side: Complete virtual addresses (color-coded)
\node[font=\scriptsize, anchor=west, text width=4.5cm] at (16,8.5) {
...
\node[font=\scriptsize, anchor=west, text width=4.5cm] at (16,7.7) {
...
\node[font=\scriptsize, anchor=west, text width=4.5cm] at (16,5.6) {
...
\node[font=\scriptsize, anchor=west, text width=4.5cm] at (16,3.3) {
...
\node[font=\scriptsize, anchor=west, text width=4.5cm] at (16,1) {
