...
\begin{tikzpicture}[scale=0.6, transform shape,
    ...
    pml4table/.style={rectangle, draw=black, thick, minimum width=1.2cm, minimum height=2.24cm, fill=yellow!40},
    pdptable/.style={rectangle, draw=black, thick, minimum width=1.2cm, minimum height=2.24cm, fill=red!30},
    dirtable/.style={rectangle, draw=black, thick, minimum width=1.2cm, minimum height=2.24cm, fill=blue!20},
    pagetable/.style={rectangle, draw=black, thick, minimum width=1.2cm, minimum height=2.24cm, fill=blue!40},
    page/.style={rectangle, draw=black, thick, minimum width=1.2cm, minimum height=2.24cm, fill=orange!40},
...
% PML4 entries
\draw[arrow] (pml4label) -- ++(0, -0.8) -| ([xshift=-10mm]pml4d3.west) -- (pml4d3.west) node[pos=0.6, above, font=\tiny] {D3};
\draw[arrow] (pml4label) -- ++(0, -0.8) -| ([xshift=-10mm]pml471.west) -- (pml471.west) node[pos=0.6, above, font=\tiny] {71};

% PDP entries
\draw[arrow] (pdplabel) -- ++(0, -0.8) -| ([xshift=-10mm]pdp82.west) -- (pdp82.west) node[pos=0.6, above, font=\tiny] {82};
\draw[arrow] (pdplabel) -- ++(0, -0.8) -| ([xshift=-10mm]pdp46.west) -- (pdp46.west) node[pos=0.6, above, font=\tiny] {46};

% DIR entries
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dirff.west) -- (dirff.west) node[pos=0.6, above, font=\tiny] {FF};
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dir28.west) -- (dir28.west) node[pos=0.6, above, font=\tiny] {28};
\draw[arrow] (dirlabel) -- ++(0, -0.8) -| ([xshift=-10mm]dirb5.west) -- (dirb5.west) node[pos=0.6, above, font=\tiny] {B5};

% TABLE entries
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]ptee2.west) -- (ptee2.west) node[pos=0.6, above, font=\tiny] {E2};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte68.west) -- (pte68.west) node[pos=0.6, above, font=\tiny] {68};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte49.west) -- (pte49.west) node[pos=0.6, above, font=\tiny] {49};
\draw[arrow] (tablelabel) -- ++(0, -0.8) -| ([xshift=-10mm]pte54.west) -- (pte54.west) node[pos=0.6, above, font=\tiny] {54};

% OFFSET entries
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]pageb25.west) -- (pageb25.west) node[pos=0.6, above, font=\tiny] {B25};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page349.west) -- (page349.west) node[pos=0.6, above, font=\tiny] {349};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page937.west) -- (page937.west) node[pos=0.6, above, font=\tiny] {937};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]pagec00.west) -- (pagec00.west) node[pos=0.6, above, font=\tiny] {C00};
\draw[arrow] (offsetlabel) -- ++(0, -0.8) -| ([xshift=-10mm]page622.west) -- (page622.west) node[pos=0.6, above, font=\tiny] {622};
