...
\begin{tikzpicture}[scale=0.75, every node/.style={scale=0.75},
    ...
    % TLB cells - widths sized to fit header text
    tlbvalid/.style={cell, fill=green!30, minimum width=0.8cm, inner sep=0pt},
    tlbinvalid/.style={cell, fill=gray!20, minimum width=0.8cm, inner sep=0pt},
    tlbtag/.style={cell, fill=green!30, minimum width=0.6cm},
    tlbtaginvalid/.style={cell, fill=gray!20, minimum width=0.6cm},
    tlbpfn/.style={cell, fill=green!30, minimum width=1.7cm, inner sep=0pt},
    tlbpfninvalid/.style={cell, fill=gray!20, minimum width=1.7cm, inner sep=0pt},
    % Page table cells
    ptgreen/.style={cell, fill=green!30, minimum width=1cm, inner sep=0},
    ptred/.style={cell, fill=red!30, minimum width=1cm, inner sep=0},
    ptdatagreen/.style={cell, fill=green!30, minimum width=1.1cm},
    ptdatared/.style={cell, fill=red!30, minimum width=1.1cm},
    % Physical memory
...
\matrix[matrix of nodes, row sep=-\pgflinewidth, column sep=-\pgflinewidth, ampersand replacement=\&,
    ...
    |[colheader]| Valid \& |[colheader]| Tag \& |[colheader]| PFN \\
    |[tlbinvalid]| 0 \& |[tlbtaginvalid]| \& |[tlbpfninvalid]| \\
    |[tlbvalid]| 1 \& |[tlbtag]| \& |[tlbpfn]| \\
    |[tlbvalid]| 1 \& |[tlbtag]| \& |[tlbpfn]| \\
    |[tlbvalid]| 1 \& |[tlbtag]| \& |[tlbpfn]| \\
    |[tlbvalid]| 1 \& |[tlbtag]| \& |[tlbpfn]| \\
    |[tlbinvalid]| 0 \& |[tlbtaginvalid]| \& |[tlbpfninvalid]| \\
...
\matrix[matrix of nodes, row sep=-\pgflinewidth, column sep=-\pgflinewidth, ampersand replacement=\&,
    ...
    |[colheader]| Present \& |[colheader, minimum width=1.1cm]| \\
    |[ptgreen]| 1 \& |[ptdatagreen]| \\
    |[ptgreen]| 1 \& |[ptdatagreen]| \\
    |[ptgreen]| 1 \& |[ptdatagreen]| \\
    |[ptgreen]| 1 \& |[ptdatagreen]| \\
...
% Orange arrows from TLB (valid entries) to Physical Memory
\draw[orangearrow] (tlb-3-3.east) -- (pp-2-1.west);
\draw[orangearrow] (tlb-4-3.east) -- (pp-4-1.west);
\draw[orangearrow] (tlb-5-3.east) -- (pp-3-1.west);
\draw[orangearrow] (tlb-6-3.east) -- (pp-5-1.west);
\draw[orangearrow] (tlb-8-3.east) -- (pp-6-1.west);

% Black arrows from Page Table (present=1) to Physical Memory
\draw[dotarrow] (pt-2-2.east) -- (pp-1-1.west);
\draw[dotarrow] (pt-3-2.east) -- (pp-3-1.west);
\draw[dotarrow] (pt-4-2.east) -- (pp-2-1.west);
\draw[dotarrow] (pt-5-2.east) -- (pp-5-1.west);
\draw[dotarrow] (pt-7-2.east) -- (pp-7-1.west);
\draw[dotarrow] (pt-8-2.east) -- (pp-4-1.west);
\draw[dotarrow] (pt-10-2.east) -- (pp-6-1.west);
\draw[dotarrow] (pt-12-2.east) -- (pp-7-1.west);

% Dashed arrows from Page Table (present=0) to Disk - straight lines
...
\draw[dotarrow, dashed] (pt-6-2.center) -- (diskslot1);
\draw[dotarrow, dashed] (pt-9-2.center) -- (diskslot2);
\draw[dotarrow, dashed] (pt-11-2.center) -- (diskslot3);
