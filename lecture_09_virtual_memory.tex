...
\begin{tikzpicture}[
    ...
    \node[draw, fill=red!15, minimum height=0.4cm, font=\tiny,
          anchor=east] (ptbr) at ([xshift=-0.3cm]ptbox.north west) {Page Table Base Reg};
    ...
    \node[rectangle callout, draw, fill=green!20, callout absolute pointer={(selP.west)},
        font=\scriptsize, anchor=east] (callP) at ([xshift=-5mm, yshift=1mm]selP.west) {Present};
    \node[rectangle callout, draw, fill=yellow!20, callout absolute pointer={(selAD.center)},
        font=\scriptsize, anchor=north east] (callAD) at ([yshift=-1mm]callP.south east) {Accessed/Dirty};
    \node[rectangle callout, draw, fill=gray!20, callout absolute pointer={(selAC.center)},
        font=\scriptsize, anchor=north east] (callAC) at ([yshift=-1mm]callAD.south east) {Access Control (R/W/X)};
    \node[rectangle callout, draw, fill=cyan!20, callout absolute pointer={(selC.center)},
        font=\scriptsize, anchor=north east] (callC) at ([yshift=-1mm]callAC.south east) {Cache type};
