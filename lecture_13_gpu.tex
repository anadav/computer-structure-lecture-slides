...
\node[muxdemux, muxdemux def={Rh=1, w=8, NT=1, NB=16, square pins=1},
      external pins width=0, fill=yellow!20]
    (ireg) at ([yshift=-1.5cm]scheduler.south) {};
\node[font=\tiny] at (ireg.center) {instruction register};
...
\foreach \i in {0,...,15} {
    ...
    % ALU (trapezoid) - positioned relative to lane box
    \fill[cyan!30] ([xshift=-0.22cm, yshift=-1.3cm]lane\i-box.center) --
                   ([xshift=0.22cm, yshift=-1.3cm]lane\i-box.center) --
                   ([xshift=0.28cm, yshift=-1.15cm]lane\i-box.center) --
                   ([xshift=0.28cm, yshift=-1.05cm]lane\i-box.center) --
                   ([xshift=0.22cm, yshift=-0.9cm]lane\i-box.center) --
                   ([xshift=-0.22cm, yshift=-0.9cm]lane\i-box.center) --
                   ([xshift=-0.28cm, yshift=-1.05cm]lane\i-box.center) --
                   ([xshift=-0.28cm, yshift=-1.15cm]lane\i-box.center) -- cycle;
    \node[font=\fontsize{4}{5}\selectfont] at ([yshift=-1.1cm]lane\i-box.center) {ALU};
