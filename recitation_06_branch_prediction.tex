...
\newcommand{\BHRbit}[2]{%
  % #1 = bit value (0 or 1), #2 = highlight flag (0 or 1)
  \ifnum#2=1\relax
...
% Use \BHRbit{value}{highlight} directly in the table for slides needing highlighting
% Example: \BHRbit{0}{1} | \BHRbit{0}{0} | \BHRbit{0}{0} | \BHRbit{0}{0}
  ...
  \begin{frame}
    ...
    \column{0.35\textwidth}
      ...
      \begin{tabular}{|c|ccc|c}
          ...
          \midrule
          \ifnum\pdfstrcmp{\localframeIP}{IP1}=0
            \cellcolor{highlightyellow}IP1 & \multicolumn{4}{c|}{%
              \ifx\localframeBHROneDisplay\empty\BHRdisplay{\localframeBHROne}\else\localframeBHROneDisplay\fi%
            } \\
          \else
            IP1 & \multicolumn{4}{c|}{%
              \ifx\localframeBHROneDisplay\empty\BHRdisplay{\localframeBHROne}\else\localframeBHROneDisplay\fi%
          ...
          \fi
          \ifnum\pdfstrcmp{\localframeIP}{IP2}=0
            \cellcolor{highlightyellow}IP2 & \multicolumn{4}{c|}{%
              \ifx\localframeBHRTwoDisplay\empty\BHRdisplay{\localframeBHRTwo}\else\localframeBHRTwoDisplay\fi%
            } \\
          \else
            IP2 & \multicolumn{4}{c|}{%
              \ifx\localframeBHRTwoDisplay\empty\BHRdisplay{\localframeBHRTwo}\else\localframeBHRTwoDisplay\fi%
          ...
          \fi
          \ifnum\pdfstrcmp{\localframeIP}{IP3}=0
            \cellcolor{highlightyellow}IP3 & \multicolumn{4}{c|}{%
              \ifx\localframeBHRThreeDisplay\empty\BHRdisplay{\localframeBHRThree}\else\localframeBHRThreeDisplay\fi%
            } \\
          \else
            IP3 & \multicolumn{4}{c|}{%
              \ifx\localframeBHRThreeDisplay\empty\BHRdisplay{\localframeBHRThree}\else\localframeBHRThreeDisplay\fi%
...
\localFrameKV{
    ...
    step={1},
    action={Prediction},
    description={Using BHR=0000, index 0, state=WT predicts Taken. Actual outcome: Not Taken (misprediction)}
  }
...
% Step 1c: BHR update
% LSB (rightmost bit) highlighted with yellow bg + red text
\localFrameKV{
    ip={IP1},
    outcome={},
    r1={100},
    ...
    r3={0},
    bhr1={0}{0}{0}{0},
    bhr1display={\BHRbit{0}{0} | \BHRbit{0}{0} | \BHRbit{0}{0} | \BHRbit{0}{1}},
    bhr2={0}{0}{0}{0},
    bhr3={0}{0}{0}{0},
    states1={0:WNT:0},
    states2={},
