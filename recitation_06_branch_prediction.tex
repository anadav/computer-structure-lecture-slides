...
% Helper to format state without color (for highlighted cells)
\newcommand{\formatStatePlain}[1]{%
...
\newcommand{\getStateForIndex}[2]{%
  ...
  \ifnum\temphighlight=2
    ...
    \cellcolor{highlightyellow}\textcolor{red}{\formatStatePlain{\tempstate}}%
  \else\ifnum\temphighlight=1
    % Yellow background only (no color text)
    \cellcolor{highlightyellow}\formatStatePlain{\tempstate}%
  \else
    % Normal (with default colors)
...
\localFrameKV{
    ...
    bhr1={0}{0}{0}{0},
    bhrrowhighlight={1},
    bhr1={0}{0}{0}{\textcolor{incorrectred}{0}},
    bhr2={0}{0}{0}{0},
    bhr3={0}{0}{0}{0},
    states1={0:WNT:0},
    states2={},
