  ...
  \ifx\localframeBHRTwoDisplay\empty
    ...
    \ifnum\localframeBHRRowHighlight=1
      \ifnum\pdfstrcmp{\localframeIP}{IP2}=0
        % Apply yellow to all bits, red text to specified bit
        \ifnum\localframeBHRRedBit=1
          \gdef\rowTwoBitOne{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitOne}}%
        \else
          \gdef\rowTwoBitOne{\cellcolor{highlightyellow}\bhrBitOne}%
        \fi
        \ifnum\localframeBHRRedBit=2
          \gdef\rowTwoBitTwo{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitTwo}}%
        \else
          \gdef\rowTwoBitTwo{\cellcolor{highlightyellow}\bhrBitTwo}%
        \fi
        \ifnum\localframeBHRRedBit=3
          \gdef\rowTwoBitThree{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitThree}}%
        \else
          \gdef\rowTwoBitThree{\cellcolor{highlightyellow}\bhrBitThree}%
        \fi
        \ifnum\localframeBHRRedBit=4
          \gdef\rowTwoBitFour{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitFour}}%
        \else
  ...
  \ifx\localframeBHRThreeDisplay\empty
    ...
    \ifnum\localframeBHRRowHighlight=1
      \ifnum\pdfstrcmp{\localframeIP}{IP3}=0
        % Apply yellow to all bits, red text to specified bit
        \ifnum\localframeBHRRedBit=1
          \gdef\rowThreeBitOne{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitOne}}%
        \else
          \gdef\rowThreeBitOne{\cellcolor{highlightyellow}\bhrBitOne}%
        \fi
        \ifnum\localframeBHRRedBit=2
          \gdef\rowThreeBitTwo{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitTwo}}%
        \else
          \gdef\rowThreeBitTwo{\cellcolor{highlightyellow}\bhrBitTwo}%
        \fi
        \ifnum\localframeBHRRedBit=3
          \gdef\rowThreeBitThree{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitThree}}%
        \else
          \gdef\rowThreeBitThree{\cellcolor{highlightyellow}\bhrBitThree}%
        \fi
        \ifnum\localframeBHRRedBit=4
          \gdef\rowThreeBitFour{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitFour}}%
        \else
