    ...
    \ifnum\localframeBHRRowHighlight=1
      \ifnum\pdfstrcmp{\localframeIP}{IP1}=0
        ...
        \ifnum\localframeBHRRedBit=1
          \gdef\rowOneBitOne{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitOne}}%
        \else
          \gdef\rowOneBitOne{\cellcolor{highlightyellow}\bhrBitOne}%
        \fi
        \ifnum\localframeBHRRedBit=2
          \gdef\rowOneBitTwo{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitTwo}}%
        \else
          \gdef\rowOneBitTwo{\cellcolor{highlightyellow}\bhrBitTwo}%
        \fi
        \ifnum\localframeBHRRedBit=3
          \gdef\rowOneBitThree{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitThree}}%
        \else
          \gdef\rowOneBitThree{\cellcolor{highlightyellow}\bhrBitThree}%
        \fi
        \ifnum\localframeBHRRedBit=4
          \gdef\rowOneBitFour{\cellcolor{highlightyellow}\textcolor{red}{\bhrBitFour}}%
        \else
          \gdef\rowOneBitFour{\cellcolor{highlightyellow}\bhrBitFour}%
        \fi
      \else
        \gdef\rowOneBitOne{\bhrBitOne}%
        \gdef\rowOneBitTwo{\bhrBitTwo}%
        \gdef\rowOneBitThree{\bhrBitThree}%
        \gdef\rowOneBitFour{\bhrBitFour}%
      \fi
    \else
      \gdef\rowOneBitOne{\bhrBitOne}%
      \gdef\rowOneBitTwo{\bhrBitTwo}%
...
\newcommand{\buildBHRrowTwo}{%
  ...
  \ifx\localframeBHRTwoDisplay\empty
    ...
    \ifnum\localframeBHRRowHighlight=1
      \ifnum\pdfstrcmp{\localframeIP}{IP2}=0
        \gdef\rowTwoBitOne{\cellcolor{highlightyellow}\bhrBitOne}%
        \gdef\rowTwoBitTwo{\cellcolor{highlightyellow}\bhrBitTwo}%
        \gdef\rowTwoBitThree{\cellcolor{highlightyellow}\bhrBitThree}%
        \gdef\rowTwoBitFour{\cellcolor{highlightyellow}\bhrBitFour}%
      \else
        \gdef\rowTwoBitOne{\bhrBitOne}%
        \gdef\rowTwoBitTwo{\bhrBitTwo}%
        \gdef\rowTwoBitThree{\bhrBitThree}%
        \gdef\rowTwoBitFour{\bhrBitFour}%
      \fi
    \else
      \gdef\rowTwoBitOne{\bhrBitOne}%
      \gdef\rowTwoBitTwo{\bhrBitTwo}%
...
\newcommand{\buildBHRrowThree}{%
  ...
  \ifx\localframeBHRThreeDisplay\empty
    ...
    \ifnum\localframeBHRRowHighlight=1
      \ifnum\pdfstrcmp{\localframeIP}{IP3}=0
        \gdef\rowThreeBitOne{\cellcolor{highlightyellow}\bhrBitOne}%
        \gdef\rowThreeBitTwo{\cellcolor{highlightyellow}\bhrBitTwo}%
        \gdef\rowThreeBitThree{\cellcolor{highlightyellow}\bhrBitThree}%
        \gdef\rowThreeBitFour{\cellcolor{highlightyellow}\bhrBitFour}%
      \else
        \gdef\rowThreeBitOne{\bhrBitOne}%
        \gdef\rowThreeBitTwo{\bhrBitTwo}%
        \gdef\rowThreeBitThree{\bhrBitThree}%
        \gdef\rowThreeBitFour{\bhrBitFour}%
      \fi
    \else
      \gdef\rowThreeBitOne{\bhrBitOne}%
      \gdef\rowThreeBitTwo{\bhrBitTwo}%
...
% Helper to format state - just bold for strong states, no colors
\newcommand{\formatState}[1]{%
  \ifnum\pdfstrcmp{#1}{ST}=0\textbf{#1}%
  \else\ifnum\pdfstrcmp{#1}{WT}=0#1%
  \else\ifnum\pdfstrcmp{#1}{WNT}=0#1%
  \else\ifnum\pdfstrcmp{#1}{SNT}=0\textbf{#1}%
  \else #1%
  \fi\fi\fi\fi%
}
...
\localFrameKV{
    ...
    step={1},
    action={State Update},
    description={Misprediction: State at index 0 transitions from WT to WNT (highlighted in yellow with red text)}
  }

% Step 1c: BHR update
% Entire IP1 BHR row highlighted yellow, LSB also has red text
% State should NOT be highlighted
\localFrameKV{
    ip={IP1},
    outcome={Not Taken},
    r1={100},
...
\localFrameKV{
    ...
    step={2},
    action={Prediction},
    description={Using BHR=0000, index 0, state=WT predicts Taken. Actual outcome: Taken (correct)}
  }

% Slide 4: Correct prediction at IP2, update BHR2 and state
\localFrameKV{
    ip={IP2},
    outcome={},
    r1={100},
    ...
    states3={},
    active={2},
    description={Step 4: Correct prediction - update state}
  }
...
\localFrameKV{
    ...
    states3={},
    active={1},
    description={Step 5: Prediction at IP1}
  }

% Slide 6: Misprediction at IP1, update
\localFrameKV{
    ip={IP1},
    outcome={},
    r1={100},
    ...
    states3={},
    active={1},
    description={Step 6: Misprediction - update state}
  }
...
\localFrameKV{
    ...
    states3={},
    active={2},
    description={Step 7: Correct prediction at IP2}
  }
...
\localFrameKV{
    ...
    states3={},
    active={2},
    description={Step 8: Correct prediction - update state}
  }
...
\localFrameKV{
    ...
    states3={},
    active={1},
    description={Step 9: Prediction at IP1}
  }

% Slide 10: Misprediction at IP1
\localFrameKV{
    ip={IP1},
    outcome={},
    r1={100},
    ...
    bhr2={0}{0}{1}{1},
    bhr3={0}{0}{0}{0},
    states1={0:ST:0,1:WNT:1},
    states2={0:ST:0,1:ST:0},
    states3={},
    active={1},
    description={Step 10: Misprediction - update state}
  }
...
\localFrameKV{
    ...
    bhr2={0}{0}{1}{1},
    bhr3={0}{0}{0}{0},
    states1={0:ST:0,1:WNT:0},
    states2={0:ST:0,1:ST:0},
    states3={},
    active={2},
    description={Step 11: Prediction at IP2}
  }

% Slide 12: Misprediction at IP2
\localFrameKV{
    ip={IP2},
    outcome={},
    r1={100},
    ...
    states3={},
    active={2},
    description={Step 12: Misprediction - update state}
  }

% Slide 13: IP3 now (first time!)
\localFrameKV{
    ip={IP3},
    outcome={Taken},
    r1={99},
    ...
    states3={},
    active={3},
    description={Step 13: Prediction at IP3}
  }

% Slide 14: Correct prediction at IP3
\localFrameKV{
    ip={IP3},
    outcome={},
    r1={99},
    ...
    states3={0:ST:1},
    active={3},
    description={Step 14: Correct prediction - update state}
  }
