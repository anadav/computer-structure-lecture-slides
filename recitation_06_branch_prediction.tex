...
% NEW: Display BHR with highlight using explicit expansion
% Must be called with BOTH parameters already expanded
\newcommand{\BHRdisplayH}[8]{%
  \BHRboxH{#1}{#2}{#3}{#4}{#5}{#6}{#7}{#8}%
}

% Simple text-based BHR display for use in tables (no TikZ)
\newcommand{\BHRtextH}[8]{%
  % #1-#4 = BHR bit values
  % #5-#8 = Highlight flags (1 = highlight)
  \ifnum#5=1\relax\cellcolor{highlightyellow}\textcolor{red}{#1}\else#1\fi%
  \,|\,%
  \ifnum#6=1\relax\cellcolor{highlightyellow}\textcolor{red}{#2}\else#2\fi%
  \,|\,%
  \ifnum#7=1\relax\cellcolor{highlightyellow}\textcolor{red}{#3}\else#3\fi%
  \,|\,%
  \ifnum#8=1\relax\cellcolor{highlightyellow}\textcolor{red}{#4}\else#4\fi%
}
...
% Slide 1: Initial prediction at IP1
\localFrameKV{
    ip={IP1},
    outcome={Not Taken},
    r1={100},
    ...
    states3={},
    active={1},
    description={Step 1: Prediction at IP1 - using BHR=0000, predicts Taken but was Not Taken}
  }

% Slide 2: Misprediction, update BHR1 and state
% NOTE: For BHR highlighting, manually edit the BHR table in the frame to use \BHRbit{value}{highlight}
% Example: \BHRbit{0}{1} for bit 0 with yellow bg + red text
\localFrameKV{
    ip={IP1},
    outcome={},
    r1={100},
    ...
    step={2},
    action={State update},
    description={Step 2: Misprediction - update state}
  }
...
\localFrameKV{
    ...
    states3={},
    active={2},
    description={Step 3: Prediction at IP2}
  }
