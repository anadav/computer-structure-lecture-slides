...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      % History output from east side going to XOR - using -| pattern
      \draw[arrow] (history_out) -| node[pos=0.2, right] {h} (xor.north);

      % Route from connector around history cache to XOR bottom
