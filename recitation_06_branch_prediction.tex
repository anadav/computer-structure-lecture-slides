...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      \node[above=1.5cm of counter_array_center, font=\small] (counter_label) {2-bit-sat counter array};
      ...
      \node[right=2cm of counter_array_center, align=center, font=\normalsize, text=blue!80!black] (prediction) {prediction =\\msb of counter};
      ...
      \draw[thick, draw=black!70] (lower_left) -- node[midway, below, font=\scriptsize] {$/h$ l.s.bits of IP} (lower_right);
