  ...
  \begin{center}
    ...
    \begin{tikzpicture}[
      ...
      \node[muxdemux, muxdemux def={Lh=3, Rh=3, w=3, NL=4, NR=2},
            external pins width=0, fill=cyan!20, anchor=lpin 2] at ([xshift=1cm]L1.east |- imem.rpin 1) (regfile) {};
      ...
      \node[muxdemux, muxdemux def={Lh=7.5, NL=2, Rh=3, NR=1, NB=2, NT=1, w=3, inset w=1.5, inset Lh=3, inset Rh=0, square pins=1},
            external pins width=0, scale=0.5, fill=cyan!20, anchor={lpin 1}] at ([xshift=10mm]L2.east |- {regfile.rpin 1}) (alu) {};
      ...
      \node[muxdemux, muxdemux def={Lh=3, Rh=3, w=3, NL=1, NR=1},
            external pins width=0, fill=cyan!20, anchor=lpin 1] at ([xshift=5mm]L3) (dmem) {};
      ...
      % L2 to ALU
      \draw[arrow] (L2.east |- alu.lpin 1) -- (alu.lpin 1);
      \draw[arrow] (L2.east) -- ++(0.3,0) |- (alu.blpin 2);

      % ALU to L3
      \draw[arrow] (alu.brpin 1) -- (L3.west);
      ...
      % L4 to WB Mux
      \draw[arrow] (L4.east) -- ++(0.2,0) |- (wb_mux.blpin 1);
      \draw[arrow] (L4.east) -- ++(0.2,0) |- (wb_mux.blpin 2);
