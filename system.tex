...
\draw[thick] (5.5,1.2) rectangle (9.5,-1.5);
\foreach \x in {5.8,6.1,6.4,6.7,7,7.3,7.6,7.9,8.2,8.5,8.8,9.2} {
    \draw (\x,1.2) -- (\x,-1.5);
}
\foreach \y in {0.9,0.6,0.3,0,-0.3,-0.6,-0.9,-1.2} {
    \draw (5.5,\y) -- (9.5,\y);
}
\node[align=center, fill=white, inner sep=2pt] at (7.5,-0.15) {memory\\array};
...
\foreach \y in {0.9,0.6,0.3,0,-0.3,-0.6,-0.9,-1.2} {
    \draw[purple, thick] (5.5,\y) -- (5.6,\y);
}
% Highlight one row
\draw[purple, line width=2.5pt, opacity=0.5] (5.5,0.3) -- (9.5,0.3);
...
\foreach \x in {6.1,6.7,7.3,7.9,8.5,9.2} {
    \draw[olive, thick] (\x,-1.5) -- (\x,-1.4);
}
% Highlight one column
\draw[olive, line width=2.5pt, opacity=0.5] (7.6,1.2) -- (7.6,-1.5);

% Mark intersection
\fill[red] (7.6,0.3) circle (0.06);
