...
\begin{tikzpicture}[
    ...
    % ============ IN-KERNEL SWITCHING ============
    % Virtual core 1 matrix (vertical: big on top, little below)
    \matrix[matrix of nodes, ampersand replacement=\&,
            row sep=3mm, anchor=center] (inker-vcore1-mat) at ([xshift=-9mm]col2) {
        |[big core, name=inker-big1]| \\
        |[little core, name=inker-lit1]| \\
    };
    ...
    % Virtual core 2 matrix
    \matrix[matrix of nodes, ampersand replacement=\&,
            row sep=3mm, anchor=center] (inker-vcore2-mat) at ([xshift=9mm]col2) {
        |[big core, name=inker-big2]| \\
        |[little core, name=inker-lit2]| \\
    };
    ...
    \matrix[matrix of nodes, ampersand replacement=\&,
            column sep=1mm, anchor=center,
            nodes={big core}] (glob-big-mat) at ([yshift=10mm]col3) {
