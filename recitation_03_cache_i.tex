...
\node[muxdemux, muxdemux def={Lh=0.3, Rh=0.6, NL=2, NB=1, w=0.5},
      external pins width=0, fill=green!30, rotate=90, below=0.8cm of tag1_3] (comp1) {};
...
% OR gate - positioned between comparators
\node[orgatestyle] at ($(comp0)!0.5!(comp1) + (0,-1)$) (orgate) {};

% MUX - using muxdemux, rotated 90 degrees, positioned relative to data arrays
\node[muxdemux, muxdemux def={Lh=0.5, Rh=1, NL=2, NB=1, w=0.8},
      external pins width=0, fill=gray!20, rotate=90] at ($(data0_3.south)!0.5!(data1_3.south) + (0.5,-1.2)$) (mux) {};
...
% Data array to MUX connections
\draw[arrow] (data0_3.south) |- (mux.lpin 1);
\draw[arrow] (data1_3.south) |- (mux.lpin 2);

% Comparator outputs to OR gate
\draw[arrow] (comp0.rpin 1) |- (orgate.input 1);
\draw[arrow] (comp1.rpin 1) |- (orgate.input 2);
