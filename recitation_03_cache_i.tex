...
\node[muxdemux, muxdemux def={Lh=1, Rh=4, NB=0, NL=1, NR=4, w=0.8, square pins=0},
      external pins width=0, fill=cyan!20, anchor=rpin 1] at ($(tag0_0.west) + (-1.5,0)$) (decoder0) {};
...
\node[muxdemux, muxdemux def={Lh=1, Rh=4, NB=0, NL=1, NR=4, w=0.8, square pins=0},
      external pins width=0, fill=cyan!20, anchor=rpin 1] at ($(tag1_0.west) + (-1.5,0)$) (decoder1) {};
