...
\usepackage{tikz}
\usetikzlibrary{arrows.meta, positioning, shapes.geometric, calc, tikzmark, shapes.misc, patterns, fit, circuits.logic.US, matrix, backgrounds, shapes.callouts}
...
% Headers
\node[header, above=3mm of m-1-2] {MRU};
\node[header, above=3mm of m-1-5] {LRU};
