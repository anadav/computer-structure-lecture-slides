...
\node[muxdemux, muxdemux def={Lh=4, Rh=2, NL=2, NB=1, w=1},
      external pins width=0, fill=gray!20, rotate=270] at ($(data1_3.south east) + (0.3,-1.8)$) (mux) {MUX};
...
\draw[arrow] (data0_3.south) |- ([yshift=8mm]mux.lpin 1) -- (mux.lpin 1);
\draw[arrow] (data1_3.south) |- ([yshift=8mm]mux.lpin 2) -- (mux.lpin 2);
