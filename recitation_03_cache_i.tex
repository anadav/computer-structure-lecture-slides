...
\usepackage{tikz}
\usetikzlibrary{arrows.meta, positioning, shapes.geometric, calc, tikzmark, shapes.misc, patterns, fit}
...
\tikzset{
    writeblock/.style={draw, thick, minimum width=\blocksize, minimum height=\blocksize, pattern=grid, pattern color=#1, line width=5pt},
    writeblock/.default=blue,
    densegrid/.style={pattern=grid, pattern color=#1, line width=5pt},
    densegrid/.default=blue
}
...
\begin{tikzpicture}[
    ...
    dirtymark/.style={font=\footnotesize\bfseries, white},
...
\foreach \i/\col in {1/blue!60, 2/blue!60, 3/green!60, 4/green!60, 5/yellow!60, 6/yellow!60} {
    ...
    \else
        \ifnum\i=2
            \node[block, pattern=grid, pattern color=\col,
                  right=0cm of s3start, anchor=west, xshift={\i*\blocksize}, 
                  yshift=-0.75cm] (s3_mem_\i) {};
            % Add dirty bit marker to second piece
            \node[dirtymark] at (s3_mem_\i) {D};
        \else
            \node[block, fill=\col, right=0cm of s3start,
