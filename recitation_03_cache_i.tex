...
\draw[->, thick] (mem-11-1.east) -- (cache-2-2.west);
...
\draw[->, thick, red!70!black] (mem-13-1.east) -- (cache-4-2.west);
...
% Way Size brackets on the left
\draw[decorate, decoration={brace, amplitude=5pt, mirror}, thick]
    ([xshift=-3mm]mem-1-1.north west) -- ([xshift=-3mm]mem-2-1.south west)
    node[midway, left=5pt, waysize] {Way\\Size};
\draw[decorate, decoration={brace, amplitude=5pt, mirror}, thick]
    ([xshift=-3mm]mem-5-1.north west) -- ([xshift=-3mm]mem-6-1.south west)
    node[midway, left=5pt, waysize] {Way\\Size};
\draw[decorate, decoration={brace, amplitude=5pt, mirror}, thick]
    ([xshift=-3mm]mem-11-1.north west) -- ([xshift=-3mm]mem-12-1.south west)
    node[midway, left=5pt, waysize] {Way\\Size};
...
\draw[->, thick] (mem-3-1.east) -- (cache1-4-2.west);
% Block 6 (red)
\draw[->, thick, red!70!black] (mem-7-1.east) -- (cache0-4-2.west);
\draw[->, thick, red!70!black] (mem-7-1.east) -- (cache1-4-2.west);
% Block 4n+2 (blue)
\draw[->, thick, blue!70] (mem-13-1.east) -- (cache0-4-2.west);
\draw[->, thick, blue!70] (mem-13-1.east) -- (cache1-4-2.west);
