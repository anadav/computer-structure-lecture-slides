...
\begin{scope}[on background layer]
\node[fit=(snoopp2)(dirty2)(inv2), fill=yellow!30, draw=black, rounded corners, inner sep=5pt] (bg1) {};
\end{scope}
...
\draw[->, rounded corners]
  (snoopp2.south)
  -- ($(snoopp2.south)+(0,-1cm)$) % down 1cm
  -- ($ ($(snoopp2.south)+(0,-1cm)$) -| ($(snoopp1)!0.5!(snoopp2)$) $) % go to midway x at same y
  |- ($(snoopp1.north)+(0,1cm)$)  % up to 1cm above snoopp1
  -- (snoopp1.north);             % straight down into snoopp1.north
