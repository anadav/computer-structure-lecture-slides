...
\begin{tikzpicture}[
    ...
    % Label explaining instruction boxes = grades[i] access (same style as row labels)
    \node[align=right, font=\scriptsize\bfseries, anchor=south east] at (-0.5, 0.6) {Accessed\\Grades\\Element};
