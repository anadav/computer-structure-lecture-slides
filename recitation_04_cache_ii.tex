...
\textbf{(1)} Both cache levels are the same size
\begin{itemize}
    \small
...
\textbf{(2)} Access time for both cache levels is identical. L2 is larger than L1.
...
\vspace{0.5cm}
\onslide<3->{
\textbf{(3)} Access time to L2 and main memory is identical.
