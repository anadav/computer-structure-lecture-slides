...
\begin{itemize}
  ...
  \item Physical address (32 bits) $=$ PFN $+$ offset
  \item $\Rightarrow$ offset $= 32 - 23 = $ \textcolor{orange}{9 bits}
...
\begin{frame}{Question 2: Address Structure}
\textbf{Given:}
\begin{itemize}
...
\begin{center}
\begin{tikzpicture}[scale=0.85,
  addrfield/.style={draw, minimum height=6mm, text depth=0.5ex, inner sep=2mm, font=\small},
  lbl/.style={font=\small},
]
...
\draw[decorate, decoration={brace, amplitude=3pt, mirror}, thick, correctgreen]
  ...
  node[midway, below=1pt, font=\scriptsize, correctgreen] {b + c $\leq$ q};
