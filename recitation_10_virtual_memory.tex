...
\node[entry, fill=red!20, below=0.4cm of pt2, text=red] (pte1) {PTE};
\node[entry, fill=red!20, below=0cm of pte1, text=red] (pte2) {PTE};
\node[entry, fill=white, below=0.4cm of pte2] (entry1) {1};
\node[entry, fill=white, below=0.6cm of entry1] (entry2) {2};
\node[entry, fill=white, below=0.05cm of entry2] (entry3) {2};
...
\draw[->, dashed, thick] (entry2.east) -- ++(0.7,0) |- (page3b.west);
\draw[->, dashed, thick] (entry3.east) -- ++(0.9,0) |- (page3c.west);
