...
\node[pte, fill=red!20, below=0.4cm of pt2.south east, text=red, anchor=north east] (pte1) {PTE};
\node[pte, fill=red!20, below=0cm of pte1, text=red] (pte2) {PTE};
\node[entry, fill=white, below=0.4cm of pte2.south east, anchor=north east, text=green] (entry1) {1};
\node[entry, fill=white, below=0.6cm of entry1, text=red] (entry2a) {2};
\node[entry, fill=white, below=0.05cm of entry2a, text=blue] (entry2b) {2};
\node[entry, fill=white, below=0.05cm of entry2a, text=red] (entry3) {3};

% PTBR Register
\node[draw, rectangle, fill=gray!20, minimum width=1.5cm, minimum height=0.6cm, left=2cm of pte1.north west] (ptbr) {\textbf{PTBR}};

% Address labels
\node[left, font=\scriptsize] at (pte1.west) [xshift=-3mm] {00201200};
\node[right, font=\scriptsize, red] at (pte2.east) [xshift=3mm] {940001C0};
...
% Storage Pages
\node[entry] (page1) at (storage.north) [yshift=-7mm] {1};
\node[entry, below=0.1cm of page1] (page2a) {2};
\node[entry, below=0.1cm of page2a] (page3a) {3};
\node[entry, below=0.1cm of page3a] (page1b) {1};
\node[entry, below=0.1cm of page1b] (page1c) {1};
\node[entry, below=0.1cm of page1c] (page2b) {2};
\node[entry, below=0.5cm of page2b] (page2c) {2};
\node[entry, below=0.1cm of page2c] (page3b) {3};
\node[entry, below=0.1cm of page3b] (page3c) {3};

% Arrow from PTBR to Page Table
\draw[->, thick] (ptbr.east) -- (pte1.north west);
