    ...
    \begin{column}{0.65\textwidth}
      \begin{center}
        ...
        \begin{tikzpicture}[scale=0.6,
          ...
          \draw[dep] (i1) -- node[left] {\textcolor{r1color}{\scriptsize r1}} (i2);
          \draw[dep] (i3) -- node[left] {\textcolor{r5color}{\scriptsize r5}} (i5);
          \draw[dep] (i4) -- node[right] {\textcolor{r6color}{\scriptsize r6}} (i5);
          \draw[dep] (i2) -- node[left] {\textcolor{r8color}{\scriptsize r8}} (i6);
          \draw[dep] (i5) -- node[right] {\textcolor{r4color}{\scriptsize r4}} (i6);
        \end{tikzpicture}
        ...
        \begin{tikzpicture}[
            node distance=1pt,
            inst/.style={draw, thick, minimum height=0.35cm, minimum width=0.5cm, font=\tiny, inner sep=2pt},
            i1/.style={inst, fill=blue!30, minimum width=1.2cm},
            i2/.style={inst, fill=green!30},
            i3/.style={inst, fill=yellow!30},
            i4/.style={inst, fill=orange!30},
            i5/.style={inst, fill=purple!30},
            i6/.style={inst, fill=red!30},
        ]
            % In-order: 1, then 2,3,4 stacked (dispatched together after 1), then 5, then 6
            \node[i1] (n1) {1};
            \node[i2, right=of n1] (n2) {2};
            \node[i3, below=of n2] (n3) {3};
            \node[i4, below=of n3] (n4) {4};
            \node[i5, right=of n2] (n5) {5};
            \node[i6, right=of n5] (n6) {6};
            % Timeline
            \draw[->] ([yshift=-2mm]n1.west |- n4.south) -- ([yshift=-2mm]n6.east |- n4.south) node[right, font=\tiny] {t};
            % Title centered above
            \path (n1.west) -- (n6.east) node[midway, above=3mm of n1.north, font=\tiny\bfseries] {In-order execution};
        \end{tikzpicture}
          &
        \begin{tikzpicture}[
            node distance=1pt,
            ...
            % OOO: 3,4 below 1 (left-aligned), 5 after 3, then 2 after 1, then 6
            \node[i1] (n1) {1};
            \node[i3, below=of n1.south west, anchor=north west] (n3) {3};
            \node[i4, below=of n3] (n4) {4};
            \node[i5, right=of n3] (n5) {5};
            \node[i2, right=of n1] (n2) {2};
            \node[i6, right=of n2] (n6) {6};
            % Timeline
            \draw[->] ([yshift=-2mm]n1.west |- n4.south) -- ([yshift=-2mm]n6.east |- n4.south) node[right, font=\tiny] {t};
            % Title centered above (same positioning as in-order)
            \path (n1.west) -- (n6.east) node[midway, above=3mm of n1.north, font=\tiny\bfseries] {Out-of-order execution};
        \end{tikzpicture}
        \end{tabular}
      \end{center}
    \end{column}
...
\begin{frame}{Misprediction Recovery -- Two Approaches}
    \centering
    \vspace{0.5cm}
