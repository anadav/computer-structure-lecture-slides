    ...
    \begin{column}{0.6\textwidth}
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item<4-> Initiate interrupt service routine (ISR)
          \item<4-> Re-fetch subsequent instructions after ISR
        \end{itemize}
      \end{itemize}
    \end{column}
    \begin{column}{0.4\textwidth}
      ...
      \begin{center}
        \begin{tikzpicture}[font=\tiny,
          ...
          % Stage 4: ISR and re-fetched
          \only<4>{
            \foreach \i in {4,...,8} { \node[P] at (m-\i-1) {}; }
            \node[font=\tiny] at (m-6-1.center) {ISR};
            \foreach \i in {9,...,16} { \node[G] at (m-\i-1) {}; }
