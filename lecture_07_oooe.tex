...
\begin{frame}{Data Flow Analysis}
  \begin{tikzpicture}[
    ...
    \node[font=\bfseries, anchor=west] at (0,0) {Example:};
    \node[code] (line1) at (0,-0.5) {1. \textcolor{r1color}{r1} $\leftarrow$ r4 / r7};
    \node[code] at (0,-1.0) {2. \textcolor{r8color}{r8} $\leftarrow$ \textcolor{r1color}{r1} + r2};
    \node[code] at (0,-1.5) {3. \textcolor{r5color}{r5} $\leftarrow$ r5 + 1};
    \node[code] at (0,-2.0) {4. \textcolor{r6color}{r6} $\leftarrow$ r6 - r3};
    \node[code] at (0,-2.5) {5. \textcolor{r4color}{r4} $\leftarrow$ \textcolor{r5color}{r5} + \textcolor{r6color}{r6}};
    \node[code] at (0,-3.0) {6. r7 $\leftarrow$ \textcolor{r8color}{r8} * \textcolor{r4color}{r4}};

    % Callout for divide - positioned relative to line1, pointing to /
    \node[ellipse callout, draw, fill=blue!10,
          callout absolute pointer={($(line1.east)+(-0.3cm,0)$)},
    ...
    \begin{scope}[shift={(6,0)}]
      \node[font=\small\bfseries] at (1.2,0.3) {Data Flow Graph};
      % Graph nodes
    ...
    % === BOTTOM LEFT: In-order execution ===
    \begin{scope}[shift={(4.5,-3.5)}, node distance=1pt]
      \node[font=\scriptsize\bfseries] at (0.8,0.8) {In-order execution};
    ...
    \node[ellipse callout, draw, fill=red!10,
          ...
          {2 has data dependency on 1, so 3 and 4 must wait (even though independent of 1)};

    % === BOTTOM RIGHT: Out-of-order execution ===
    \begin{scope}[shift={(9,-3.5)}, node distance=1pt]
      \node[font=\scriptsize\bfseries] at (0.8,0.8) {Out-of-order execution};
