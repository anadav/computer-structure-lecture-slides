    ...
    \begin{column}{0.65\textwidth}
      \begin{itemize}
        ...
        \begin{itemize}
          ...
          \item<2-> Instructions older than the fault retire first

          \item<3-> When faulting instruction retires -- handle fault
          ...
          \item<5-> When faulting instruction retires:
          \begin{itemize}
            \item Flush ROB and pipeline
    ...
    \begin{column}{0.35\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.8,
          ...
          % Stage 3: Faulting instruction at retire
          \only<3>{
          ...
          % Stage 4: Empty ROB after flush (all white, already drawn)
          \only<4>{
          ...
          % Stage 5: Fault handling code and re-fetch
          \only<5>{
            % Fault handling code
