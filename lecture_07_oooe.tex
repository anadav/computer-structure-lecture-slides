...
\usepackage{listings}
\usepackage{tikz}
\usetikzlibrary{arrows.meta, positioning, shapes.geometric, calc, tikzmark, shapes.misc, shapes.callouts, fit, matrix, backgrounds, patterns}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \begin{tikzpicture}[font=\tiny,
        ...
        % Re-rename arrow (from checkpoint between 12-13 to mispredicted jump at row 16)
        \draw[<->, thick, white] ($(m-12-1.south west)!0.5!(m-13-1.north west)+(-0.12,0)$) -- ($(m-16-1.west)+(-0.12,0)$) node[midway, left, text=black, font=\tiny] {Re-rename};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
