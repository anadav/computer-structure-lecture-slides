  ...
  \begin{columns}[t]
    \begin{column}{0.5\textwidth}
      \begin{tabular}[t]{lll}
        ...
        (1) & \textcolor{blue}{r1} $\leftarrow$ 17 & \\
        (2) & r2 $\leftarrow$ r2+\textcolor{blue}{r1} & \\
        (3) & \textcolor{orange}{r1} $\leftarrow$ 23 & \\
        (4) & \textcolor{red}{r3} $\leftarrow$ r3+\textcolor{orange}{r1} & \\
        (5) & jcc L2 & \\
        (6) L2: & \textcolor{green}{r1} $\leftarrow$ 35 & \\
        (7) & r4 $\leftarrow$ \textcolor{red}{r3}+\textcolor{green}{r1} & \\
        (8) & \textcolor{blue}{r3} $\leftarrow$ 2 & \\
      \end{tabular}
    \end{column}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{tabular}{lll}
        ...
        (4) & \textcolor{red}{r3} $\leftarrow$ r3+\textcolor{orange}{r1} & \\
        (5) & jcc L2 & \\
        \rowcolor{pink!30} (6) L2: & \textcolor{green}{r1} $\leftarrow$ 35 & \\
        \rowcolor{pink!30} (7) & r4 $\leftarrow$ \textcolor{red}{r3}+\textcolor{green}{r1} & \\
        \rowcolor{pink!30} (8) & \textcolor{blue}{r3} $\leftarrow$ 2 & \\
      \end{tabular}
    \end{column}
