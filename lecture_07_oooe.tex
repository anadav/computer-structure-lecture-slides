...
\begin{frame}{Register Renaming: Example}
  \begin{center}
    \begin{tikzpicture}[font=\small]
      ...
      % Callout note pointing to r2 in row (2)
      \only<1>{
        \node[rectangle callout, callout absolute pointer={(m-3-3.east)}, fill=yellow!20, draw=yellow!60!black, rounded corners=2pt, font=\scriptsize, text width=4.5cm, align=left, anchor=west] at ($(m-7-5.east)+(0.3,0)$) {
...
\begin{frame}{Speculative Execution -- Misprediction}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|}
      ...
      & r1 & r2 & r3 & r4 \\
      \hline
      Register mapping & \textcolor{red}{\textcircled{\textcolor{green}{pr5}}} & \textcolor{violet}{pr2} & \textcolor{red}{\textcircled{\textcolor{blue}{pr7}}} & \textcolor{red}{\textcircled{pr6}} \\
      \hline
    \end{tabular}
  \end{center}
