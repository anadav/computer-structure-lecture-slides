  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.8,
      ...
      \onslide<4->{
        ...
        \node[above=0.1cm of retire.north] (inorder2) {\textbf{In-order}};
      }
      ...
      \onslide<2>{
        ...
        \node[calloutbox, below right=1cm of rs, callout absolute pointer={(rs.east)}]
          (rs_call)
      ...
      \onslide<3>{
        \node[calloutbox, below left=0.5cm of rs, callout absolute pointer={(rs.west)}]
          (rs_call3)
      ...
      \onslide<4>{
        \node[calloutbox, anchor=north west, callout absolute pointer={(retire.south)}]
          at ([yshift=-5mm,xshift=-1cm]retire.south) (retire_call)
