...
\begin{frame}{The ROB}
  \begin{columns}
    \begin{column}{0.65\textwidth}
      \begin{itemize}
        \item \textbf{The Reorder Buffer (ROB)}
        \begin{itemize}
    ...
    \begin{column}{0.35\textwidth}
      \begin{center}
        \begin{tikzpicture}[scale=0.8]
          % Draw white background for all entries (all stages)
          ...
          % Stage 2: Some executed (red at top)
          \only<2>{
            \foreach \i in {0,1,2} {
          ...
          % Stage 3: More executed scattered
          \only<3>{
      ...
      \begin{center}
        \begin{tikzpicture}[scale=0.8]
          ...
          \only<1>{
            ...
            \draw[fill=orange!50] (0,-2*0.4) rectangle (2,-2*0.4+0.35);
          }

          % Stage 2: Faulting instruction at retire
          \only<2>{
            \draw[fill=orange!50] (0,-0*0.4) rectangle (2,-0*0.4+0.35);
          ...
          \only<4>{
            ...
            \node[font=\tiny,align=center] at (1,-0.6) {Fault\\Handling\\Code};
            % Faulting instruction
            \draw[fill=orange!50] (0,-4*0.4) rectangle (2,-4*0.4+0.35);
            \node[font=\tiny,right] at (2.1,-4*0.4+0.15) {The faulting};
            \node[font=\tiny,right] at (2.1,-4*0.4-0.1) {instruction};
