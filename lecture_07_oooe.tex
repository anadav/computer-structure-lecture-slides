...
\begin{frame}{Memory Disambiguation}
  ...
  \begin{block}{Predict non-colliding $\rightarrow$ Load proceeds}
    \begin{tabular}{@{}c@{\hspace{0.3cm}}l@{}}
      & \textcolor{brown}{\texttt{Store Mem[r1+\textcolor{red}{r3}*2] $\leftarrow$ 8}} {\small\textcolor{brown}{// address unknown (\textcolor{red}{r3} not ready)}} \\[4pt]
      \textcolor{green!50!black}{\textbf{GO}} & \texttt{Load R1 $\leftarrow$ Mem[1000]} {\small\textcolor{gray}{// predicted: no conflict}} \\
    \end{tabular}
  \end{block}
\end{frame}
...
\begin{frame}{Store $\rightarrow$ Load Forwarding}
  ...
  \vspace{0.2cm}
  \begin{block}{Store's data is ready $\rightarrow$ forward to Load}
    \begin{tabular}{@{}c@{\hspace{0.3cm}}l@{}}
      & \texttt{Store Mem[1000] $\leftarrow$ 42} {\small\textcolor{gray}{// address known, data ready}} \\[4pt]
      \textcolor{blue!70}{$\Rightarrow$} & \texttt{Load R1 $\leftarrow$ Mem[1000]} {\small\textcolor{blue!70}{// forwarded from SDB}} \\
    \end{tabular}
  \end{block}
\end{frame}
