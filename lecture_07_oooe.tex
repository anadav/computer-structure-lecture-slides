...
\begin{frame}{Reservation Station (RS) - Operation}
  ...
  \begin{tikzpicture}
    ...
    % Labels
    \node[right=0.2cm of rs.east, align=left, font=\small] {Write-Back Bus};
    \node[left=0.2cm of rs.west, align=right, font=\small] {Dispatch};
    \node[above=0.1cm of execute.north east, align=left, font=\small] {Bypass};
  \end{tikzpicture}
\end{frame}
