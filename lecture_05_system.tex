...
\begin{tikztimingtable}[
  ...
  RAS\# & H L 6L H 6L H 2L H \\
  CAS\# & 5H L 2H L 2H L H 8H L 2H L 2H L 2H \\
  Addr  & U 2D{Row} U 1.5D{\colorbox{blue!30}{Col}} 1.5U 1.5D{\colorbox{red!30}{Col}} 1.5U 1.5D{\colorbox{orange!30}{Col}} 5.5U 2D{Row} U 1.5D{\colorbox{green!30}{Col}} 1.5U 1.5D{\colorbox{purple!30}{Col}} 1.5U 1.5D{\colorbox{cyan!30}{Col}} 2.5U \\
  Data  & 6U 2D{\colorbox{blue!30}{Data}} U 2D{\colorbox{red!30}{Data}} U 2D{\colorbox{orange!30}{Data}} 8U 2D{\colorbox{green!30}{Data}} U 2D{\colorbox{purple!30}{Data}} U 2D{\colorbox{cyan!30}{Data}} \\
  \extracode
    % Timing annotations
    \begin{scope}[>=stealth]
      \draw[<->] (0.8,3.6) -- node[above,font=\scriptsize] {tRCD} (2.4,3.6);
      \draw[<->] (5.6,3.6) -- node[above,font=\scriptsize] {tRP} (10.4,3.6);
      \draw[<->] (2.4,-0.5) -- node[below,font=\scriptsize] {CL} (4.8,-0.5);
    \end{scope}
\end{tikztimingtable}
\end{center}
