...
% Vertical mesh lines (double lines for bidirectional ring)
...
\foreach \col in {\colA, \colB, \colC} {
    ...
    \draw[meshline] (\lineX - \lineGap, \topRouterY) -- (\lineX - \lineGap, \bottomY);
    \draw[meshline] (\lineX + \lineGap, \topRouterY) -- (\lineX + \lineGap, \bottomY);
}
