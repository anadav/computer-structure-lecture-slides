...
% Hexagon macro for bus timing diagrams
% Parameters: center_x, center_y, width, height, slant, fill_color, text
\newcommand{\bushex}[7]{
  \draw[very thick, fill=#6]
    (#1-#3/2-#5, #2) --
    (#1-#3/2, #2+#4) --
    (#1+#3/2, #2+#4) --
    (#1+#3/2+#5, #2) --
...
\begin{tikzpicture}[
    ...
    signal/.style={very thick},
    timing/.style={|-|, thick, >=stealth},
    label/.style={font=\small}
]

% Helper coordinates
\def\unit{0.8}  % time unit width
\def\high{0.6}  % signal high level
\def\low{0}     % signal low level
\def\hexw{0.35} % hexagon body width
\def\hexh{0.22} % hexagon half-height
\def\hexs{0.15} % hexagon slant

% RAS# signal (active low)
\draw[signal] (0,3.5) -- (0.5*\unit,3.5) -- (0.5*\unit,3.5-\high) -- (3.5*\unit,3.5-\high) -- (3.5*\unit,3.5)
              -- (6.5*\unit,3.5) -- (6.5*\unit,3.5-\high) -- (9.5*\unit,3.5-\high) -- (9.5*\unit,3.5) -- (10.5*\unit,3.5);
\node[left, label] at (0,3.5-\high/2) {RAS\#};

% CAS# signal (active low)
\draw[signal] (0,2.5) -- (1.5*\unit,2.5) -- (1.5*\unit,2.5-\high) -- (2*\unit,2.5-\high) -- (2*\unit,2.5)
              -- (2.5*\unit,2.5) -- (2.5*\unit,2.5-\high) -- (3*\unit,2.5-\high) -- (3*\unit,2.5)
              -- (3.5*\unit,2.5) -- (3.5*\unit,2.5-\high) -- (4*\unit,2.5-\high) -- (4*\unit,2.5)
              -- (7.5*\unit,2.5) -- (7.5*\unit,2.5-\high) -- (8*\unit,2.5-\high) -- (8*\unit,2.5)
              -- (8.5*\unit,2.5) -- (8.5*\unit,2.5-\high) -- (9*\unit,2.5-\high) -- (9*\unit,2.5)
              -- (9.5*\unit,2.5) -- (9.5*\unit,2.5-\high) -- (10*\unit,2.5-\high) -- (10*\unit,2.5) -- (10.5*\unit,2.5);
\node[left, label] at (0,2.5-\high/2) {CAS\#};

% Address signal (hexagon bus style)
\draw[signal] (0,1.5) -- (0.5*\unit-\hexw/2-\hexs,1.5);
\bushex{\unit}{1.5}{\hexw}{\hexh}{\hexs}{purple!30}{Row}
\bushex{1.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{blue!30}{Col}
\bushex{2.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{red!30}{Col}
\bushex{3.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{orange!30}{Col}
\bushex{5.25*\unit}{1.5}{1.8}{\hexh}{\hexs}{gray!20}{X}
\bushex{7*\unit}{1.5}{\hexw}{\hexh}{\hexs}{purple!30}{Row}
\bushex{7.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{blue!30}{Col}
\bushex{8.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{red!30}{Col}
\bushex{9.75*\unit}{1.5}{\hexw}{\hexh}{\hexs}{orange!30}{Col}
\draw[signal] (10*\unit+\hexw/2+\hexs,1.5) -- (10.5*\unit,1.5);

\node[left, label] at (0,1.5) {Addr};

% Data signal (hexagon bus style)
\draw[signal] (0,0.5) -- (2.2*\unit,0.5);
\bushex{2.4*\unit}{0.5}{0.3}{0.22}{\hexs}{blue!50}{\textcolor{white}{\textbf{Data}}}
\draw[signal] (2.6*\unit+\hexs,0.5) -- (3.2*\unit-\hexs,0.5);
\bushex{3.4*\unit}{0.5}{0.3}{0.22}{\hexs}{red!50}{\textcolor{white}{\textbf{Data}}}
\draw[signal] (3.6*\unit+\hexs,0.5) -- (4.2*\unit-\hexs,0.5);
\bushex{4.4*\unit}{0.5}{0.3}{0.22}{\hexs}{orange!50}{\textcolor{white}{\textbf{Data}}}
\draw[signal] (4.6*\unit+\hexs,0.5) -- (8.2*\unit-\hexs,0.5);
\bushex{8.4*\unit}{0.5}{0.3}{0.22}{\hexs}{blue!50}{\textcolor{white}{\textbf{Data}}}
\draw[signal] (8.6*\unit+\hexs,0.5) -- (9.2*\unit-\hexs,0.5);
\bushex{9.4*\unit}{0.5}{0.3}{0.22}{\hexs}{red!50}{\textcolor{white}{\textbf{Data}}}
\draw[signal] (9.6*\unit+\hexs,0.5) -- (10.2*\unit-\hexs,0.5);
\bushex{10.4*\unit}{0.5}{0.3}{0.22}{\hexs}{orange!50}{\textcolor{white}{\textbf{Data}}}

\node[left, label] at (0,0.5) {Data};

% Timing annotations
% tRCD
\draw[timing, <->] (0.5*\unit, 4.2) -- node[above, font=\scriptsize] {tRCD} (1.5*\unit, 4.2);
% tRP
\draw[timing, <->] (3.5*\unit, 4.2) -- node[above, font=\scriptsize] {tRP} (6.5*\unit, 4.2);
% CL
\draw[timing, <->] (1.5*\unit, -0.2) -- node[below, font=\scriptsize] {CL} (2.2*\unit, -0.2);
...
\vspace{-0.3cm}
\begin{itemize}
\item CAS-to-CAS delay: delay between two CASs within the same row
\item tRP: Row pre-charge time - time to close current row and open new row
\item \textbf{DRAM is not true random-access memory}
  \begin{itemize}
  \item Accessing multiple columns within same row is much faster than accessing different rows
  \end{itemize}
\end{itemize}
\end{frame}
...
\textbf{All signals are referenced to an external clock (100MHz-200MHz)}
\begin{itemize}
\item Automatically synchronizes with the timing of the CPU
\end{itemize}

\vspace{0.2cm}
\textbf{4 banks -- multiple pages (rows) open simultaneously (page per bank)}
\begin{itemize}
\item Accessing columns within each one of the 4 open rows is fast
\end{itemize}

\vspace{0.2cm}
\textbf{Command driven functionality instead of signal driven}
\begin{itemize}
\item ACTIVE: selects both the bank and the row to be activated
  \begin{itemize}
  \item ACTIVE to a new bank can be issued while accessing the current bank
  \end{itemize}
\item READ/WRITE: select column
\end{itemize}

\vspace{0.2cm}
\textbf{Burst oriented read and write accesses}
\begin{itemize}
\item Successive column locations accessed in the given row
\item Burst length is programmable: 1, 2, 4, 8, full-page (may end by burst terminate)
\end{itemize}
\end{frame}

% Slide: SDRAM Features (continued)
\begin{frame}{SDRAM Features (continued)}
\textbf{A user programmable Mode Register}
\begin{itemize}
\item CAS latency, burst length, burst type
\end{itemize}

\vspace{0.3cm}
\textbf{Auto pre-charge:} may close row at last read/write in burst

\vspace{0.3cm}
\textbf{Auto refresh:} internal counters generate refresh address

\vspace{0.5cm}
\begin{block}{Key Advantage}
Multiple banks allow interleaving accesses - while one bank is being accessed, another can be preparing its row, improving overall throughput
\end{block}
\end{frame}
