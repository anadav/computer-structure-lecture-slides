...
\textbf{NAND flash stores multiple bits per cell}

\vspace{0.2cm}
\begin{center}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Type} & \textbf{Bits/Cell} & \textbf{Endurance} & \textbf{Performance} & \textbf{Cost} \\
\hline
\textbf{SLC} (Single) & 1 & \textcolor{green!60!black}{100K cycles} & \textcolor{green!60!black}{Fastest} & \textcolor{red}{Highest} \\
\hline
\textbf{MLC} (Multi) & 2 & 10K cycles & Fast & High \\
\hline
\textbf{TLC} (Triple) & 3 & 3K cycles & Medium & Medium \\
\hline
\textbf{QLC} (Quad) & 4 & \textcolor{red}{1K cycles} & \textcolor{red}{Slower} & \textcolor{green!60!black}{Lowest} \\
\hline
\end{tabular}
\end{center}
...
\textbf{Trade-offs:}
\begin{itemize}
\item More bits per cell $\rightarrow$ higher density, lower cost
\item More bits per cell $\rightarrow$ lower endurance, slower writes
\item \textbf{SLC}: Enterprise, high-performance applications
\item \textbf{TLC/QLC}: Consumer SSDs, cost-sensitive applications
\end{itemize}
\end{frame}
