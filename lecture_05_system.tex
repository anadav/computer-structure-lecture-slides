...
% Circuit Board
\fill[circuit] (-2,-0.5) rectangle (11.5,0.2);
\node[white, font=\tiny] at (4.5,-0.15) {Circuit Board};

% Package Substrate
\fill[substrate] (0.5,0.2) rectangle (10.5,1.5);
\node[white, font=\tiny] at (5.5,0.85) {Package Substrate};

% Package Balls
\foreach \x in {0.8,1.3,...,10.2} {
  \fill[ball] (\x,-0.48) circle (1.5mm);
}
...
\foreach \y/\name in {1.5/Die, 2.2/Die, 2.9/Die, 3.6/Die} {
  \fill[hbm] (0.8,\y) rectangle (3.5,\y+0.6);
  \node[white, font=\tiny] at (1.5,\y+0.3) {HBM DRAM \name};
  % TSVs (yellow bumps)
...
\fill[base] (0.8,1.5) rectangle (6.5,2.3);
\node[white, font=\tiny] at (2,1.9) {Base Die};

% EMIB section
\fill[emib] (3.8,1.5) rectangle (6.3,2.05);
\node[white, font=\tiny] at (5.05,1.78) {EMIB};

% PHY blocks
\fill[emibcolor!70] (3.7,1.6) rectangle (4.4,2.0);
\node[white, font=\tiny] at (4.05,1.8) {PHY};
\fill[emibcolor!70] (4.5,1.6) rectangle (5.2,2.0);
\node[white, font=\tiny] at (4.85,1.8) {PHY};
...
% Base Logic Die
\fill[basecolor!80] (6.6,1.5) rectangle (10.0,2.3);
\node[white, font=\tiny] at (8.3,1.9) {Base Logic Die};

% Compute Dies on right
\fill[compute] (4.8,2.3) rectangle (6.5,2.85);
\node[white, font=\tiny] at (5.65,2.58) {Compute/FPGA/Mem/RF Die};

\fill[compute] (6.8,2.3) rectangle (9.8,2.85);
\node[white, font=\tiny] at (8.3,2.58) {Compute/FPGA/Mem/RF Die};
