...
\node at (0, 1.9) {\footnotesize (Intel Core, Xeon E5)};
...
\node[core] (c1) at (0:1.15) {C1};
\node[core] (c2) at (270:1.15) {C2};
\node[core] (c3) at (180:1.15) {C3};
% L3 slices inside the ring (not overlapping cores)
\node[cache, minimum width=0.35cm, minimum height=0.22cm, font=\tiny] at (0,0.4) {L3};
\node[cache, minimum width=0.35cm, minimum height=0.22cm, font=\tiny] at (0.4,0) {L3};
\node[cache, minimum width=0.35cm, minimum height=0.22cm, font=\tiny] at (0,-0.4) {L3};
\node[cache, minimum width=0.35cm, minimum height=0.22cm, font=\tiny] at (-0.4,0) {L3};
...
• Limited to \textasciitilde 10 cores
};
\end{scope}
...
\node at (0, 1.9) {\footnotesize (Intel Xeon SP)};
...
\node at (0, 1.9) {\footnotesize (AMD Zen)};
