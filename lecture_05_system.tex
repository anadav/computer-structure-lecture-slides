...
% Slide: Real System Topology
\begin{frame}{Real System Topology: lstopo Output}
\begin{center}
\includegraphics[width=0.95\textwidth,height=0.85\textheight,keepaspectratio]{figures/topo.png}
\end{center}

\vspace{0.2cm}
\textbf{lstopo} visualizes the complete hardware topology of a system
\end{frame}

% Slide: Analyzing the Topology
\begin{frame}{Analyzing the System Topology}
\textbf{Key Features from the lstopo Output:}
...
\vspace{0.3cm}
\textbf{Software Impact:} Pin network-intensive threads to cores on Package 1 for best performance with the mlx5 NIC!
\end{frame}
