...
\begin{tikztimingtable}[
  ...
  \extracode
    ...
    \begin{scope}[>=stealth, font=\scriptsize]
      % tRCD
      \draw[<->,thick] (5.15,-3) -- node[midway, fill=white, inner sep=1pt]  {tRCD$>$20ns} (1.15,-3);
      % tRC
...
\begin{itemize}
\item \textbf{tRCD}: ACTIVE to READ/WRITE gap = $\lceil\frac{\text{tRCD(MIN)}}{\text{clock period}}\rceil$
