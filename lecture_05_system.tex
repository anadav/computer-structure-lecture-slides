...
\item \textbf{Hardware layers} process and transmit data:
  ...
  \item \textcolor{green!60!black}{Data Link Layer}: Ensures data integrity (sequence numbers + CRC)
  \item \textcolor{orange}{Physical Layer}: Transmits the packets (connector, voltage levels)
  \end{itemize}
\end{itemize}
