...
\begin{tikztimingtable}[
  ...
  clock & H L H L H L H L H L H L H L H L H L H L H L H L H \\
  cmd   & U 2D{ACT} 2D{NOP} 2D{RD} 2D{RD+PC} 2D{ACT} 2D{NOP} 2D{ACT} 2D{NOP} 2D{RD} 2D{RD} 2D{NOP} 2D{NOP} \\
  \\
  Bank  & U 2D{\textcolor{cyan}{Bank 0}} 2U 2D{\textcolor{cyan}{Bank 0}} 2D{\textcolor{cyan}{Bank 0}} 2D{\textcolor{cyan}{Bank 0}} 2U 2D{\textcolor{blue!30}{Bank 1}} 2U 2D{\textcolor{cyan}{Bank 0}} 2D{\textcolor{blue!30}{Bank 1}} 2U 2U \\
  Addr  & U 2D{\textcolor{red}{Row i}} 2U 2D{\textcolor{cyan}{Col j }} 2D{\textcolor{cyan}{Col k }} 2D{\textcolor{red}{Row l }} 2U 2D{\textcolor{red}{Row m}} 2U 2D{\textcolor{cyan}{Col q }} 2D{\textcolor{blue!30}{Col n }} 2U 2U \\
  \\
  Data  & 11U 2D{\textcolor{cyan!50}{Data j}} 2D{\textcolor{cyan!50}{Data k}} 4U 2D{\textcolor{blue!50}{Data n}} 2D{\textcolor{cyan!50}{Data q}} 2U \\
  \extracode
    % Timing annotations
    \begin{scope}[>=stealth, font=\scriptsize]
      ...
      % CL=2
      \draw[<->,thick] (4*0.75,-0.6) -- node[below] {CL=2} (10*0.75,-0.6);
    \end{scope}
\end{tikztimingtable}
\end{center}
