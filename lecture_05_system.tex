...
% Slide: DDR Generation Evolution (Part 1)
\begin{frame}{DDR Generation Evolution (Part 1)}

\vspace{0.2cm}
\begin{itemize}
\item \textbf{SDR → DDR (2000):}
  \begin{itemize}
  \item 2-bit prefetch: doubles data rate (both clock edges)
  \item Reduced power: 3.3V → 2.5V
  \item Throughput: 266-400 MT/s (2.1-3.2 GB/s)
  \item Clock: 133-200 MHz, CL 2-3 ($\approx$10 ns actual latency)
  \end{itemize}

\vspace{0.3cm}
\item \textbf{DDR → DDR2 (2003):}
  \begin{itemize}
  \item 4-bit prefetch: doubles bandwidth
  \item Reduced power: 1.8V
  \item More banks (8), smaller pages (1KB)
  \item Throughput: 533-800 MT/s (4.2-6.4 GB/s)
  \item Clock: 266-400 MHz, CL 3-5 ($\approx$10 ns - similar to DDR!)
  \end{itemize}

\vspace{0.3cm}
\item \textbf{DDR2 → DDR3 (2007):}
  \begin{itemize}
  \item 8-bit prefetch: doubles bandwidth
  \item Reduced power: 1.5V (1.35V variant available)
  \item Throughput: 1066-1600 MT/s (8.5-12.8 GB/s)
  \item Clock: 533-800 MHz, CL 5-11 ($\approx$11 ns)
  \end{itemize}
\end{itemize}

\vspace{0.2cm}
\textbf{Key insight:} CL increases in cycles, but stays $\approx$10-15ns in absolute time
\end{frame}

% Slide: DDR Generation Evolution (Part 2)
\begin{frame}{DDR Generation Evolution (Part 2)}

\vspace{0.2cm}
\begin{itemize}
\item \textbf{DDR3 → DDR4 (2014):}
  \begin{itemize}
  \item Per-bank prefetch architecture
  \item Reduced power: 1.2V
  \item Bank groups (16 banks in 4 groups)
  \item Throughput: 2133-3200 MT/s (17-25.6 GB/s)
  \item Clock: 1066-1600 MHz, CL 12-18 ($\approx$9-11 ns)
  \end{itemize}

\vspace{0.3cm}
\item \textbf{DDR4 → DDR5 (2021):}
  \begin{itemize}
  \item 16-bit prefetch (burst length 16)
  \item Reduced power: 1.1V
  \item Dual-channel per DIMM, 32 banks
  \item Throughput: 3200-6400 MT/s (25.6-51.2 GB/s)
  \item Clock: 1600-3200 MHz, CL 32-40 ($\approx$12-13 ns)
  \end{itemize}
\end{itemize}

\vspace{0.3cm}
\textbf{Latency pattern across generations:}
\begin{itemize}
\item CL (in cycles): 2 → 4 → 9 → 15 → 36 \textcolor{red}{(looks terrible!)}
\item Actual latency (ns): 10 → 10 → 11 → 10 → 12 \textcolor{blue}{(mostly flat)}
\item Higher clocks compensate for increased CL
\end{itemize}
\end{frame}
