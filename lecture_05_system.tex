...
\item DRAM cells can experience bit flips due to:
  ...
  \end{itemize}
\item \textbf{Error rate:} 2000-6000 correctable errors per GB per year (Google study)
\item At scale: $\sim$2\% of servers encounter ECC faults
\end{itemize}
...
\item \textbf{DDR5 on-die ECC:} Additional protection inside the chip (transparent)
\end{itemize}
\end{frame}
