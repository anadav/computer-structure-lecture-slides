...
\begin{tikztimingtable}[
  ...
  Addr  & U 2D{Row} U 2D{Col} U 2D{Col} U 2D{Col} 5U 2D{Row} U 2D{Col} U 2D{Col} U 2D{Col} U \\
  Data  & 6U 2D{\colorbox{yellow}{Data}} U 2D{Data} U 2D{Data} 8U 2D{Data} U 2D{Data} U 2D{Data} \\
  \extracode
    % Timing annotations
    \begin{scope}[>=stealth]
