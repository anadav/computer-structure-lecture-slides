...
% CCD 1
% CCX 0
\matrix[matrix of nodes, nodes={minicore}, row sep=1pt, column sep=1pt, ampersand replacement=\&] (ccx0) at (-1.4,0.7) {
    {} \& {} \\
    {} \& {} \\
};
% Crossbar in CCX0
...
% CCX 1
\matrix[matrix of nodes, nodes={minicore}, row sep=1pt, column sep=1pt, ampersand replacement=\&] (ccx1) at (-1.4,-0.7) {
    {} \& {} \\
    {} \& {} \\
};
% Crossbar in CCX1
...
\draw[<->, red, thick] (box0.south) -- (box1.north);

% CCD 2
% CCX 2
\matrix[matrix of nodes, nodes={minicore}, row sep=1pt, column sep=1pt, ampersand replacement=\&] (ccx2) at (1.4,0.7) {
    {} \& {} \\
    {} \& {} \\
};
% Crossbar in CCX2
...
% CCX 3
\matrix[matrix of nodes, nodes={minicore}, row sep=1pt, column sep=1pt, ampersand replacement=\&] (ccx3) at (1.4,-0.7) {
    {} \& {} \\
    {} \& {} \\
};
% Crossbar in CCX3
...
\draw[<->, red, thick] (box2.south) -- (box3.north);
...
% I/O Die
\node[iodbox, minimum width=3.5cm, minimum height=0.7cm, below=0.4cm of $(ccd1.south)!0.5!(ccd2.south)$] (iod) {};
\node[font=\scriptsize\bfseries] at ([yshift=0.1cm]iod.center) {I/O Die};
\node[iobox, fill=orange!30] at ([xshift=-0.8cm, yshift=-0.12cm]iod.center) (iomc) {MC};
\node[iobox, fill=purple!30] at ([xshift=0.8cm, yshift=-0.12cm]iod.center) (iopcie) {PCIe};
