...
\foreach \x [count=\i from 0] in {0.3,0.6,...,4.2} {
  \node[circle, fill=gray!60, draw=black!80, minimum size=1, anchor=south] (f2fbump\i) at ($(baselogic.north west) + (\x,0)$) {};
  %\node[circle, fill=gray!60, draw=black!80, minimum size=1mm, anchor=south] at ($(baselogic.north west) + (\x,0.06)$) {};
}
