...
% define cshft as 1mm
\def\cshft{1mm}
\onslide<15->{\draw[green!70!black, very thick] (pic cs:green1addr) circle (8pt);}
\onslide<16->{\draw[green!70!black, very thick] (pic cs:green2) circle (8pt);}
\onslide<17->{\draw[green!70!black, very thick] (pic cs:green3) circle (8pt);}
% Red circle
\onslide<18->{\draw[red!80!black, very thick] (pic cs:red1) circle (8pt);}
\end{tikzpicture}
