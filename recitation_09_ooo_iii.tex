...
% define cshft as 1mm
\def\cshft{1mm}
\onslide<15->{\draw[green circle] (pic cs:green1addr) circle (8pt);}
\onslide<16->{\draw[green circle] (pic cs:green2) circle (8pt);}
\onslide<17->{\draw[green circle] (pic cs:green3) circle (8pt);}
% Red circle
\onslide<18->{\draw[red circle] (pic cs:red1) circle (8pt);}
\end{tikzpicture}
