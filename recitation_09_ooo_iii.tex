...
\textbf{2. Allocation}
\begin{itemize}
    \item Allocate entries in ROB, RS, Load Buffer
    \item Rename destination in RAT
\end{itemize}
\vspace{2mm}

\textbf{3. Dispatch to AGU}
\begin{itemize}
    \item Wait for source operands ready
    \item Dispatch address calculation to AGU
    \item Release RS entry
\end{itemize}
\vspace{2mm}

\textbf{4. Address Calculation}
\begin{itemize}
...
\begin{column}{0.48\textwidth}
\textbf{5. Blocking Check \& Dispatch}
\begin{itemize}
    \item Load Buffer checks memory hazards
...
\begin{itemize}
    ...
    \item Update ROB
    \item Forward to dependent instructions via RS
\end{itemize}
\vspace{2mm}

\textbf{7. Retire \& Release}
\begin{itemize}
    \item Wait for all prior instructions to retire
    \item Commit load
    \item Update RAT
