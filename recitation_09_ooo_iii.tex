...
\onslide<17>{\draw[blue circle] ([xshift=1mm,yshift=\circleyshift] pic cs:blue1) circle (9pt);}
% Arrow from 22 to 24 in T data ready column
\onslide<17>{\draw[arrow style, very thick] ([yshift=-2mm, xshift=2mm] pic cs:arrow1start) -- ([yshift=3mm, xshift=2mm] pic cs:arrow1end);}
\end{tikzpicture}
