...
\matrix[matrix of nodes,
    ...
    RF0 \& \ifx\robOp\empty{ }\else\robOp\fi \& \ifx\robValid\empty{ }\else\robValid\fi \& \ifx\robRdy\empty{ }\else\robRdy\fi \& \ifx\robData\empty{ }\else\robData\fi \& R3 \\
    RF1 \& {} \& {} \& {} \& {} \& {} \\
    RF2 \& {} \& {} \& {} \& {} \& {} \\
    RF3 \& {} \& {} \& {} \& {} \& {} \\
};
...
\matrix[matrix of nodes,
    ...
    \ifx\sbTwoV\empty{ }\else\sbTwoV\fi \& \ifx\sbTwoAddr\empty{ }\else\sbTwoAddr\fi \& \ifx\sbTwoData\empty{ }\else\sbTwoData\fi \& \ifx\sbTwoSnr\empty{ }\else\sbTwoSnr\fi \\
};
...
\node[smallbox, right=0.5cm of loadbuf.east, anchor=west] (dcache) {Data\\Cache};
...
\node[smallbox, right=0.5cm of agu.east, anchor=west] (dtlb) {dTLB};
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Initial State]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Allocation Phase]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Dispatch Phase]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Address Calculation Phase]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Blocking Check \& Dispatch Phase]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Data Return Phase]
...
\end{center}
\vspace{2mm}
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Retire \& Release Phase]
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Complete Load Lifecycle]
A load instruction goes through the following stages in the P6 microarchitecture:
\end{tcolorbox}
\vspace{3mm}
\begin{enumerate}
    \item \textbf{Initial State:} Load waits in the Instruction Queue
    \item \textbf{Allocation:} Allocate entries in ROB, RS, and Load Buffer; rename destination in RAT
    \item \textbf{Dispatch to AGU:} When source operands are ready, dispatch address calculation to AGU; release RS entry
    \item \textbf{Address Calculation:} AGU computes virtual address and updates Load Buffer; pipeline to dTLB
    \item \textbf{Blocking Check \& Dispatch:} Load Buffer checks for memory hazards; if clear, dispatch to Data Cache
    \item \textbf{Data Return:} Cache returns data; update ROB and forward to dependent instructions via RS
    \item \textbf{Retire \& Release:} When all prior instructions retire, commit load; update RAT; release Load Buffer and ROB entries
\end{enumerate}
\end{frame}
