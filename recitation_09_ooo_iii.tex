...
\hline
    ...
    3 & \texttt{st [R1+40]=R3} & - & - & - & 50 & 110 & 1 & R1 & P2 & 40 & 1 & 21 & \makecell{\tiny Std:22\\\tiny Sta:\tikzmarknode{texe3}{2}} & - & 22 & 23 & \onslide<4->{+2=6} \\
    ...
    6 & \texttt{ld R2=[R1+30]} & - & 110 & - & 50 & 110 & 2 & P4 & - & 30 & 3 & - & 4 & {\tiny \makecell{addr blk\\data blk}} & 24 & 25 & \onslide<7->{+1=5} \\
...
\onslide<5>{
\begin{tikzpicture}[remember picture, overlay]
    \node[fill=yellow!30, fill opacity=1, draw=yellow!50, line width=1pt, rounded corners=3mm, font=\small, text width=9.5cm, align=left, anchor=south east]
        at ([yshift=1.3cm, xshift=-0.3cm]current page.south east)
