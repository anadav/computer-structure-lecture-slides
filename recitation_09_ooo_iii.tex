...
% MOB (Memory Order Buffer) - Load Buffer first to establish width
\matrix[matrix of nodes,
        row sep=-\pgflinewidth,
        column sep=-\pgflinewidth,
        inner sep=0pt,
...
\matrix[matrix of nodes,
    ...
    |[text width=2.1cm]| Store Buffer \& {} \& {} \\
    \sbOne \& {} \& {} \\
    \sbTwo \& {} \& {} \\
};

% MOB label and cyan background using fit
\node[labelstyle, above=0.1cm of storebuf.north] (moblabel) {MOB};
...
% Retire (below EXE block)
\matrix[matrix of nodes,
        row sep=-\pgflinewidth,
        column sep=-\pgflinewidth,
        inner sep=0pt,
        label={[labelstyle]above:Retire},
