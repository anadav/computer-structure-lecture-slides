...
\begin{tikzpicture}[remember picture, overlay,
    ...
    % Main cycle nodes
    \node[bluecircle] at ([xshift=-3.5cm] current page.center) (n11) {11};
    ...
    \node[label, below=2mm of n12] (l12) {Addr. Calc:\\PB0+20};
    \node[label, below=2mm of n13] (l13) {Memory\\checks};
    \node[label, below=2mm of n14] (l14) {L1 miss};
    \node[label, below=2mm of n21] (l21) {L2 Hit};

    % Instruction boxes on the left
    \node[bluerect, left=12mm of l11] (load1) {Load};
