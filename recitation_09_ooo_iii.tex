...
\pgfkeys{
    ...
    default/.style = {
        ...
        rat0 = {}, rat1 = {}, rat2 = {}, rat3 = {},
        % ROB first entry
        robOp = {}, robPhys = {}, robValid = {}, robRdy = {}, robData = {},
...
%   robOp, robPhys, robValid, robRdy, robData - ROB entry fields
...
\matrix[matrix of nodes,
    ...
    Op \& {\tiny\begin{tabular}{@{}c@{}}Phys\\Reg\end{tabular}} \& Val \& Rdy \& Data \& DST \\
    \ifx\robOp\empty{ }\else\robOp\fi \& \ifx\robPhys\empty{ }\else\robPhys\fi \& \robValid \& \robRdy \& \robData \& R3 \\
    {} \& {} \& {} \& {} \& {} \& {} \\
    {} \& {} \& {} \& {} \& {} \& {} \\
    {} \& {} \& {} \& {} \& {} \& {} \\
};
...
% Data Cache (right of Load Buffer)
\node[smallbox, right=0.5cm of loadbuf.north east, anchor=north west] (dcache) {Data\\Cache};
...
% dTLB (right of AGU)
\node[smallbox, right=0.5cm of agu.north east, anchor=north west] (dtlb) {dTLB};
