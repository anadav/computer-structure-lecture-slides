...
\onslide<19->{\draw[red circle] ([xshift=\circlexshift,yshift=\circleyshift] pic cs:red2) circle (12pt);}
\onslide<20->{\draw[red circle] ([xshift=\circlexshift,yshift=\circleyshift] pic cs:red3) circle (12pt);}
\onslide<21->{\draw[red circle] ([xshift=\circlexshift,yshift=\circleyshift] pic cs:red4) circle (12pt);}
% Blue circle around T exe
\onslide<22->{\draw[blue circle] ([xshift=\circlexshift,yshift=\circleyshift] pic cs:blue1) circle (9pt);}
\end{tikzpicture}
