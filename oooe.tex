...
\begin{frame}{OOO Machine Pipeline}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        \node[above=2.8cm of current page.center, xshift=-3.5cm, 
              rectangle, draw=blue!50, fill=blue!10, rounded corners, 
              minimum width=5cm, minimum height=0.5cm, font=\small] {Frontend};
        \node[above=2.8cm of current page.center, xshift=3.5cm, 
              rectangle, draw=blue!50, fill=blue!10, rounded corners, 
              minimum width=5cm, minimum height=0.5cm, font=\small] {Backend};
    \end{tikzpicture}
    
    \vspace{0.8cm}
    \begin{columns}[T]
        \begin{column}{0.9\textwidth}
            \textbf{IQ -- Instruction Queue}
            \begin{itemize}
            ...
            \textbf{Buffers may be bypassed -- depending on implementation}
            \begin{itemize}
...
\begin{frame}{Flush at Retire: Misp. Jump Retires}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \node[red, font=\small\bfseries] at ($(current page.north)+(0,-1.3)$) {Flush at Retire};
