...
\node[rectangle callout, draw=red, fill=calloutbg, text width=2.8cm, font=\small, align=center,
      callout absolute pointer={([xshift=-1.2cm, yshift=1cm]current page.center)}]
...
%======================================================================
\begin{frame}[fragile]{Checking Your Budget}\label{frame:budget}
...
{\small \textcolor{codeorange}{\textbf{Note:}} \colorbox{lightgray}{\texttt{/cost}} in Claude Code won't show correct costs --- use the curl command above.}
