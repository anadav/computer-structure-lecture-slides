...
\url{https://openrouter.ai/docs/guides/claude-code-integration}
}
...
{\small \textcolor{codeorange}{\textbf{Note:}} \texttt{ANTHROPIC\_API\_KEY} must be explicitly empty (not omitted).}
...
%======================================================================
\begin{frame}[fragile]{Verifying Your Setup}
...
\begin{itemize}
    ...
    \item \texttt{Model}: Should be \texttt{moonshotai/kimi-k2}
\end{itemize}
...
%======================================================================
\begin{frame}[fragile]{Checking Your Budget: Status Line (1/2)}
...
%======================================================================
\begin{frame}[fragile]{Checking Your Budget: Status Line (2/2)}
...
\begin{center}
\colorbox{black}{\texttt{\textcolor{cyan}{moonshotai/kimi-k2} \textcolor{white}{|} \textcolor{green}{\$9.51}\textcolor{white}{/}\textcolor{yellow}{\$10}}}
\end{center}
...
\textbf{Option 1: VSCode Extension}
\begin{enumerate}
    \item Install ``Claude Code'' from VSCode Marketplace
    \item Configure \colorbox{lightgray}{\texttt{\textasciitilde/.claude/settings.json}} (see ``Configuring'' slide)
    \item In extension settings: enable \textbf{Claude Code: Use Terminal} (checkbox)
    \item Click the Claude logo in the sidebar: \raisebox{-0.3em}{\includegraphics[height=1.2em]{figures/claude.png}}
\end{enumerate}

\vspace{0.3cm}

\textbf{Option 2: Run CLI directly in terminal}
\begin{itemize}
...
{\small Both options are functionally identical --- the extension just adds sidebar integration.}
...
\begin{enumerate}
    ...
    \item \textbf{Out of budget?} Check with the curl command (slide~\ref{frame:budget})
...
{\footnotesize Docs: \url{https://code.claude.com/docs/en/setup}}
