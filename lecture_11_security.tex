    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}[scale=0.7, font=\small,
                ...
                cpu/.style={draw, fill=yellow!30, minimum width=6cm, minimum height=0.8cm, font=\small\bfseries},
                ...
                % Threat Actor (bottom)
                \node[threat, below=2cm of cpu] (provider) {Cloud Provider};
                \node[font=\tiny, below=1pt of provider] {(Untrusted)};
