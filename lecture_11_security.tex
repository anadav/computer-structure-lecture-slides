    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \begin{tikzpicture}[
                ...
                % TPM measurement arrows (blue dashed) to specific PCRs
                \draw[measure] (uefi.east) -- (pcrs-1-1.west);
                \draw[measure] (bootloader.east) -- ++(0.5cm,0) |- (pcrs-2-1.west);
                \draw[measure] (kernel.east) -- ++(0.6cm,0) |- (pcrs-3-1.west);
                \draw[measure] (ima.east) -- ++(0.7cm,0) |- (pcrs-5-1.west);
