    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}[font=\small,
                ...
                \coordinate (barrier-left) at ([yshift=-0.2cm]vm1.south);
                \coordinate (barrier-right) at ([yshift=-0.2cm]vm2.south);

                % Threat Actor - below VMs
                \node[inner sep=0pt, below=1.8cm of cpu] (provider)
                ...
                % Attack arrows from provider toward barrier with X marks
                \draw[->, thick, red] ([xshift=0.3cm]provider.north) -- ([xshift=0.3cm, yshift=-0.5cm]barrier-right)
                    node[pos=0.3, right, font=\tiny] {Read};
                \draw[->, thick, red] ([xshift=-0.3cm]provider.north) -- ([xshift=-0.3cm, yshift=-0.5cm]barrier-left)
                    node[pos=0.3, left, font=\tiny] {Modify};

                % X marks for blocked attacks
                \node[inner sep=0pt] at ([xshift=0.3cm, yshift=-0.35cm]barrier-right)
                    {\includegraphics[width=0.4cm]{figures/noun-x-2222229.png}};
                \node[inner sep=0pt] at ([xshift=-0.3cm, yshift=-0.35cm]barrier-left)
                    {\includegraphics[width=0.4cm]{figures/noun-x-2222229.png}};
