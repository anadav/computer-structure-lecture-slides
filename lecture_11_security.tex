        ...
        \begin{column}{0.45\textwidth}
            ...
            \begin{tikzpicture}[arrow/.style={->, thick}]
                ...
                \matrix[matrix of nodes,
                    ...
                    row sep=-\pgflinewidth,
                    row 1/.style={nodes={draw=none, fill=none, font=\small\bfseries}}] (mem) {
                    Physical Memory \\
                    Page 0 \\
                    Page 1 \\
                ...
                \draw[arrow, green!60!black] (mem-2-1.east) -- (rmp-2-1.west);
                \draw[arrow, green!60!black] (mem-3-1.east) -- (rmp-3-1.west);
                \draw[arrow, orange!60!black] (mem-4-1.east) -- (rmp-4-1.west);
                \draw[arrow, green!60!black] (mem-5-1.east) -- (rmp-5-1.west);
