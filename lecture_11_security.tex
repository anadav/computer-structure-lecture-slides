    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            ...
            \begin{tikzpicture}[
                ...
                \node[font=\scriptsize, below=0.3cm of client] {\tikz\node[num]{\tiny 3}; Verify};
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Ex:} SGX (EPCM), TrustZone (NS bit)
                \item \textcolor{red}{\textbf{Limit:}} Physical attacks (cold boot, bus snooping)
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Ex:} AMD SEV, Intel MKTME
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Ex:} SEV-SNP (RMP), TDX (SEPT)
            \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
