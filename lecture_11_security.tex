...
\begin{frame}{Secure Boot - Chain of Trust}
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \centering
            \begin{tikzpicture}[
                chainlink/.style={draw, thick, minimum width=2.2cm, minimum height=0.6cm,
                                 align=center, font=\small, rounded corners=2pt},
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \begin{tikzpicture}[
                ...
                % TPM measurement arrows (blue dashed) using ++(0.8cm,0) |- pattern
                \draw[measure] (uefi.east) -- ++(0.8cm,0) |- (pcrs-1-1.west);
                \draw[measure] (bootloader.east) -- ++(0.8cm,0) |- (pcrs-2-1.west);
