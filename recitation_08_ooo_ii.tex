...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    \begin{tikzpicture}[
        ...
        codebox/.style={draw, rectangle, fill=correctgreen!20, minimum width=3.5cm}
    ]
    %
    ...
    \ifnum\showCode=1
        \node[codebox, right=1cm of mob, yshift=0.2cm, minimum height=3.5cm] (code) {
            \begin{tabular}{l}
            % Highlight line 1 if requested
            \ifnum\highlightOne=1
                \colorbox{highlightyellow}{\asmcode{ADDI R10,R0,100}}\\
            \else
                \asmcode{ADDI R10,R0,100}\\
            \fi
            % Highlight line 2 if requested
            \ifnum\highlightOne=2
                \colorbox{highlightyellow}{\asmcode{SUB R1,R1,R1}}\\
            \else
                \ifnum\highlightTwo=2
                    \colorbox{highlightorange}{\asmcode{SUB R1,R1,R1}}\\
                \else
            ...
            \ifnum\highlightOne=3
                \colorbox{highlightyellow}{\asmcode{L1: ADDI R4,R0,20}}\\
            \else
                \ifnum\highlightTwo=3
                    \colorbox{highlightorange}{\asmcode{L1: ADDI R4,R0,20}}\\
                \else
                    \asmcode{L1: ADDI R4,R0,20}\\
                \fi
            \fi
            \ifnum\highlightOne=4
                \colorbox{highlightyellow}{\asmcode{LW R5,100(R4)}}\\
            \else
                \ifnum\highlightTwo=4
                    \colorbox{highlightorange}{\asmcode{LW R5,100(R4)}}\\
                \else
                    \asmcode{LW R5,100(R4)}\\
                \fi
            \fi
            \ifnum\highlightOne=5
                \colorbox{highlightyellow}{\asmcode{ADDI R3,R2,2}}\\
            \else
                \ifnum\highlightTwo=5
                    \colorbox{highlightorange}{\asmcode{ADDI R3,R2,2}}\\
                \else
                    \asmcode{ADDI R3,R2,2}\\
                \fi
            \fi
            \ifnum\highlightOne=6
                \colorbox{highlightyellow}{\asmcode{ADDI R5,R3,2}}\\
            \else
                \ifnum\highlightTwo=6
                    \colorbox{highlightorange}{\asmcode{ADDI R5,R3,2}}\\
                \else
                    \asmcode{ADDI R5,R3,2}\\
                \fi
            \fi
            \ifnum\highlightOne=7
                \colorbox{highlightyellow}{\asmcode{ADDI R6,R0,6}}\\
            \else
                \ifnum\highlightTwo=7
                    \colorbox{highlightorange}{\asmcode{ADDI R6,R0,6}}\\
                \else
                    \asmcode{ADDI R6,R0,6}\\
                \fi
            \fi
            \ifnum\highlightOne=8
                \colorbox{highlightyellow}{\asmcode{ADD R7,R5,R0}}\\
            \else
                \ifnum\highlightTwo=8
                    \colorbox{highlightorange}{\asmcode{ADD R7,R5,R0}}\\
                \else
                    \asmcode{ADD R7,R5,R0}\\
                \fi
            \fi
            \ifnum\highlightOne=9
                \colorbox{highlightyellow}{\asmcode{ADDI R8,R0,8}}\\
            \else
                \ifnum\highlightTwo=9
                    \colorbox{highlightorange}{\asmcode{ADDI R8,R0,8}}\\
                \else
                    \asmcode{ADDI R8,R0,8}\\
                \fi
            \fi
            \ifnum\highlightOne=10
                \colorbox{highlightyellow}{\asmcode{ADDI R9,R0,9}}\\
            \else
                \ifnum\highlightTwo=10
                    \colorbox{highlightorange}{\asmcode{ADDI R9,R0,9}}\\
                \else
                    \asmcode{ADDI R9,R0,9}\\
                \fi
            \fi
            \ifnum\highlightOne=11
                \colorbox{highlightyellow}{\asmcode{ADDI R1,R1,1}}\\
            \else
                \ifnum\highlightTwo=11
                    \colorbox{highlightorange}{\asmcode{ADDI R1,R1,1}}\\
                \else
                    \asmcode{ADDI R1,R1,1}\\
                \fi
            \fi
            \ifnum\highlightOne=12
                \colorbox{highlightyellow}{\asmcode{BNE R1,R10,L1}}\\
            \else
                \ifnum\highlightTwo=12
                    \colorbox{highlightorange}{\asmcode{BNE R1,R10,L1}}\\
                \else
                    \asmcode{BNE R1,R10,L1}\\
                \fi
            \fi
            \ifnum\highlightOne=13
                \colorbox{highlightyellow}{\asmcode{L2: ADDI R4,R0,23}}\\
            \else
                \ifnum\highlightTwo=13
                    \colorbox{highlightorange}{\asmcode{L2: ADDI R4,R0,23}}\\
                \else
...
\title{Out-of-Order Execution\\Example Problem}
...
% Initial state
\begin{frame}{Out-of-Order Execution: Initial State}
\OOODiagramKV[
    showcode=1,
]
\end{frame}
...
\OOODiagramKV[
    ...
    rs1=\oldentry{RB4$\leftarrow$R2+2},
    rs2=\oldentry{RB5$\leftarrow$RB4+2},
    robleft0=\srcentrya{\sout{RB0}},
    rob01=\srcentrya{\sout{ADDI R10,R0,100}},
    rob02=\srcentrya{OK},
    robleft1=\srcentryb{\sout{RB1}},
...
\begin{frame}{Out-of-Order Execution: Cycle 6, Execution Completed, Load Issued}
\OOODiagramKV[
    R3=\oldentry{RB4},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 6, Execution Starts}
\OOODiagramKV[
    R3=\oldentry{RB4},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 6, Instruction Decode}
\OOODiagramKV[
    R3=\oldentry{RB4},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 6, Instruction Fetch}
\OOODiagramKV[
    R3=\oldentry{RB4},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 7, Retire}
\OOODiagramKV[
    R3=\newentrya{\sout{RB4}},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 7, Execution Completed}
\OOODiagramKV[
...
\begin{frame}{Out-of-Order Execution: Cycle 7, Execution Starts}
\OOODiagramKV[
    R3=\oldentry{\sout{RB4}},
    R5=\oldentry{RB5},
    R6=\oldentry{RB6},
...
\begin{frame}{Out-of-Order Execution: Cycle 7, Instruction Decode}
\OOODiagramKV[
    R1=\newentrya{RB1},
    R3=\oldentry{\sout{RB4}},
    R5=\oldentry{RB5},
...
\begin{frame}{Out-of-Order Execution: Cycle 7, Second Iteration Fetch}
\OOODiagramKV[
    R1=\newentrya{RB1},
    R3=\oldentry{\sout{RB4}},
    R5=\oldentry{RB5},
