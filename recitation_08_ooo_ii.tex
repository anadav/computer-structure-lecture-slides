...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    |[cell]| \scriptsize RB8 \& |[cell]| \scriptsize \robEightOne \& |[cell]| \scriptsize \robEightTwo \\
    };
    %
...
\subtitle{Pipeline Analysis \& Optimization}
...
\section{Question: OOO Loop Analysis}
...
\begin{columns}
\column{0.5\textwidth}
\begin{minted}[fontsize=\scriptsize, frame=single, bgcolor=gray!10]{text}
R0 = 0
R1 = 0
L1: R4 = 20
    R5 = load 100(R4)
...
\subsection{Part 1: Execution Timeline}

\begin{frame}{Execution Timeline - Second Loop Iteration}
\textbf{Question:} Show the system state when completing the fetch of instruction L1 for the second time.
...
\subsection{Part 2: CPI Calculation}
...
\textbf{Critical Path:} The load instruction creates a 5-cycle latency that affects dependent instructions.
\end{frame}
...
\subsection{Part 3: Does Compiler Optimization Help?}

\begin{frame}[fragile]{Compiler Optimization}
\begin{columns}
\column{0.45\textwidth}
\textbf{Original Code:}
\begin{minted}[fontsize=\tiny, frame=single, bgcolor=gray!10]{text}
R0 = 0
R1 = 0
L1: R4 = 20
    R5 = load 100(R4)
...
\subsection{Part 4: Does Adding an ALU Help?}

\begin{frame}{Proposed Hardware Enhancement}
\textbf{Question:} Adding a third ALU unit - does it improve performance?
