...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    \ifnum\showCode=1
        \node[codebox, anchor=north east, font=\scriptsize, text width=2.8cm, align=left, minimum height=3cm] (code) at ($(current bounding box.north east)+(0.3,-0.5)$) {
            ...
            \ifnum\highlightOne=3
                {\tiny L1:} & \colorbox{highlightyellow}{\asmcode{ADDI R4,R0,20}}\\
            \else
                \ifnum\highlightTwo=3
                    {\tiny L1:} & \colorbox{highlightorange}{\asmcode{ADDI R4,R0,20}}\\
                \else
                    {\tiny L1:} & \asmcode{ADDI R4,R0,20}\\
                \fi
            \fi
            \ifnum\highlightOne=4
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{LW R5,100(R4)}}}\\
            \else
                \ifnum\highlightTwo=4
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{LW R5,100(R4)}}}\\
                \else
                    & \asmcode{LW R5,100(R4)}\\
                \fi
            \fi
            \ifnum\highlightOne=5
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R3,R2,2}}}\\
            \else
                \ifnum\highlightTwo=5
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R3,R2,2}}}\\
                \else
                    & \asmcode{ADDI R3,R2,2}\\
                \fi
            \fi
            \ifnum\highlightOne=6
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R5,R3,2}}}\\
            \else
                \ifnum\highlightTwo=6
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R5,R3,2}}}\\
                \else
                    & \asmcode{ADDI R5,R3,2}\\
                \fi
            \fi
            \ifnum\highlightOne=7
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R6,R0,6}}}\\
            \else
                \ifnum\highlightTwo=7
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R6,R0,6}}}\\
                \else
                    & \asmcode{ADDI R6,R0,6}\\
                \fi
            \fi
            \ifnum\highlightOne=8
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADD R7,R5,R0}}}\\
            \else
                \ifnum\highlightTwo=8
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADD R7,R5,R0}}}\\
                \else
                    & \asmcode{ADD R7,R5,R0}\\
                \fi
            \fi
            \ifnum\highlightOne=9
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R8,R0,8}}}\\
            \else
                \ifnum\highlightTwo=9
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R8,R0,8}}}\\
                \else
                    & \asmcode{ADDI R8,R0,8}\\
                \fi
            \fi
            \ifnum\highlightOne=10
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R9,R0,9}}}\\
            \else
                \ifnum\highlightTwo=10
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R9,R0,9}}}\\
                \else
                    & \asmcode{ADDI R9,R0,9}\\
                \fi
            \fi
            \ifnum\highlightOne=11
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{ADDI R1,R1,1}}}\\
            \else
                \ifnum\highlightTwo=11
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{ADDI R1,R1,1}}}\\
                \else
                    & \asmcode{ADDI R1,R1,1}\\
                \fi
            \fi
            \ifnum\highlightOne=12
                & \multicolumn{1}{l}{\colorbox{highlightyellow}{\asmcode{BNE R1,R10,L1}}}\\
            \else
                \ifnum\highlightTwo=12
                    & \multicolumn{1}{l}{\colorbox{highlightorange}{\asmcode{BNE R1,R10,L1}}}\\
                \else
                    & \asmcode{BNE R1,R10,L1}\\
                \fi
            \fi
            \ifnum\highlightOne=13
                {\tiny L2:} & \colorbox{highlightyellow}{\asmcode{ADDI R4,R0,23}}\\
            \else
                \ifnum\highlightTwo=13
                    {\tiny L2:} & \colorbox{highlightorange}{\asmcode{ADDI R4,R0,23}}\\
                \else
                    {\tiny L2:} & \asmcode{ADDI R4,R0,23}\\
                \fi
            \fi
            \end{tabular}
        };
