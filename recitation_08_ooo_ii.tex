...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    %
    % ROB (Reorder Buffer) - empty structure
    \node[draw, rectangle, minimum width=3cm, minimum height=3.5cm, label=above:{\textbf{ROB}}, below=of rat, xshift=0.5cm] (rob) {};%
    %
    % IDQ (Instruction Decode Queue) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=2.5cm, label=above:{\textbf{IDQ}}, right=of rat, xshift=0.3cm, yshift=1cm] (idq) {};%
    %
    % RS (Reservation Station) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=2.5cm, label=above:{\textbf{RS}}, below=of idq, yshift=0.3cm] (rs) {};%
    %
    % MOB (Memory Order Buffer) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=1.5cm, label=above:{\textbf{MOB}}, right=of rs, xshift=0.3cm] (mob) {};%
    %
    % Execute and Retire blocks
    \node[roundbox, below=of rs, label=right:{\textbf{Execute}}] (execute) {};%
    \node[dashedbox, below=of execute, label=right:{\textbf{Retire}}] (retire) {};%
