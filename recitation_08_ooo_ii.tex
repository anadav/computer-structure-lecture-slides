...
\node[box] at ([yshift=0.8cm]rs.center) {RB6 $\leftarrow$ R0+6};
\node[box] at ([yshift=0.3cm]rs.center) {RB7 $\leftarrow$ rb5+R0};
\node[box] at ([yshift=-0.5cm]rs.center) {RB5 $\leftarrow$ rb4+2};
