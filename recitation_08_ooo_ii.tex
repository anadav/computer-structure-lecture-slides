...
\begin{frame}{Out-of-Order Execution: Cycle 2a}
\OOODiagramKV[
    % PRF mappings
    R1=\newentry{RB1},
    R10=\newentry{RB0},
    idq5=\newentry{\sout{SUB~~R1,R1,R1}},
    idq6=\newentry{\sout{ADDI~R10,R0,100}},
...
\begin{frame}{Out-of-Order Execution: Cycle 2b}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1},
    R10=\oldentry{RB0},
...
\begin{frame}{Out-of-Order Execution: Cycle 3a}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1},
    R10=\oldentry{RB0},
    idq5=\oldentry{LW~~~R5,100(R4)},
    idq6=\oldentry{ADDI~R4,R0,20},
    rs1=\oldentry{RB0$\leftarrow$R0+100},
    rs2=\oldentry{RB1$\leftarrow$R1-R1},
    rob11=\oldentry{ADDI R10,R0,100},
    rob12=\oldentry{INV},
    rob21=\oldentry{SUB~~R1,R1,R1},
    rob22=\oldentry{INV},
    exec1=\newentry{RB0$\leftarrow$RB0+100},
    exec2=\newentry{RB1$\leftarrow$RB1-RB1},
]]
\end{frame}


\begin{frame}{Out-of-Order Execution: Cycle 3b}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1}, R10=\oldentry{RB0},
    R4=\newentry{RB2}, R5=\newentry{RB3},
    idq5=\newentry{\sout{LW~~~R5,100(R4)}},
    idq6=\newentry{\sout{ADDI~R4,R0,20}},
    rs1=\oldentry{RB0$\leftarrow$R0+100},
    rs2=\oldentry{RB1$\leftarrow$R1-R1},
    ...
    rob42=\newentry{INV},
    mob1=\newentry{RB3$\leftarrow$LD(RB2+100)},
    exec1=\oldentry{RB0$\leftarrow$RB0+100},
    exec2=\oldentry{RB1$\leftarrow$RB1-RB1},
]
\end{frame}

\begin{frame}{Out-of-Order Execution: Cycle 3c}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1}, R10=\oldentry{RB0},
    R4=\oldentry{RB2}, R5=\newentry{RB3},
...
\begin{frame}{Out-of-Order Execution: Cycle 4b}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1}, R10=\oldentry{RB0},
    R4=\oldentry{RB2}, R5=\oldentry{RB3},
    idq5=\oldentry{ADDI R5,R3,2},
    idq6=\oldentry{ADDI R3,R2,2},
    rs3=\oldentry{RB2$\leftarrow$R0+20},
    rs4=\oldentry{RB3$\leftarrow$LD(RB2+100)},
    rob11=\oldentry{ADDI R10,R0,100},
    rob12=\newentry{OK},
    ...
    rob42=\oldentry{INV},
    mob1=\oldentry{RB3$\leftarrow$LD(RB2+100)},
    exec1=\newentry{\sout{RB0$\leftarrow$RB0+100}},
    exec2=\newentry{\sout{RB1$\leftarrow$RB1-RB1}},
]
\end{frame}

\begin{frame}{Out-of-Order Execution: Cycle 4c}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1}, R10=\oldentry{RB0},
    R4=\oldentry{RB2}, R5=\oldentry{RB3},
