...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    \node[roundbox, below=of rs] (execute) {};
...
\begin{document}
% Example usage with custom data and markers:
\OOODiagramKV[
    % RAT PRF mappings
    R1=P1, R2=P2, R3=P3, R4=P4, R5=P5,
    R6=P6, R7=P7, R8=P8, R9=P9, R10=P10,
    % ROB cell contents (row-column format)
    rob11=ADD, rob12=P1,
    rob21=SUB, rob22=P2,
    rob31=MUL, rob32=P3,
    rob41=LD, rob42=P4,
    rob51=ST, rob52=P5,
    % Custom ROB markers
    robmark1=head, robmark2=r2, robmark3=r3, 
    robmark4=r4, robmark5=tail,
    % IDQ contents
    idq1=INST1, idq2=INST2, idq3=INST3,
    % RS contents
    rs1=ADD, rs2=MUL, rs3=LD, rs4=BR,
    % Custom RS markers
    rsmark1=alu1, rsmark2=alu2, rsmark3=mem, rsmark4=branch,
    % MOB contents
    mob1=LD, mob2=ST,
    % Custom MOB markers
    mobmark1=load, mobmark2=store,
    % Execute contents
    exec1=ALU, exec2=FPU,
    % Retire contents
    ret1=WB1, ret2=WB2,
    % Custom Retire markers
    retmark1=port0, retmark2=port1
]

% Another example with minimal data:
% \OOODiagramKV[R1=P1, R2=P2, rob11=I1, rs1=ALU]
\end{document}
