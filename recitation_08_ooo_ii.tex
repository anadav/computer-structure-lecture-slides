...
\OOODiagramKV[
    ...
    rs1=\oldentry{\sout{RB4$\leftarrow$R2+R2}},
    rs2=\oldentry{RB5$\leftarrow$RB4+2},
    rs3=\newentrya{RB6$\leftarrow$R0+6},
    rs4=\oldentry{\sout{RB3$\leftarrow$LD(RB2+100)}},
    rs5=\newentryb{RB7$\leftarrow$RB5+R0},
    rob31=\oldentry{ADDI R4,R0,20},
    rob32=\oldentry{OK},
    rob41=\oldentry{LW R5,100(R4)},
    rob42=\oldentry{INV},
...
\OOODiagramKV[
    ...
    rs3=\oldentry{RB6$\leftarrow$R0+6},
    rs5=\oldentry{RB7$\leftarrow$RB5+R0},
    rob31=\srcentrya{\sout{ADDI R4,R0,20}},
    rob32=\srcentrya{OK},
    rob41=\oldentry{LW R5,100(R4)},
    rob42=\oldentry{INV},
    rob51=\oldentry{ADDI R3,R2,2},
...
\begin{frame}{OOOE: Cycle 6, Execution Blocked on Dependencies}
\OOODiagramKV[
    % PRF mappings
    R3=\oldentry{RB4},
    R5=\oldentry{RB5},
    ...
    rs2=\oldentry{RB5$\leftarrow$RB4+2},
    rs3=\oldentry{RB6$\leftarrow$R0+6},
    rs5=\newentrya{RB7$\leftarrow$\textcolor{red}{RB5}+R0},
    rob31=\oldentry{\sout{ADDI R4,R0,20}},
    rob32=\oldentry{OK},
    rob41=\oldentry{LW R5,100(R4)},
    rob42=\oldentry{INV},
    rob51=\oldentry{ADDI R3,R2,2},
...
\OOODiagramKV[
    ...
    R8=\newentryb{RB8},
    R9=\newentrya{RB0},
    idq1=\srcentrya{ADDI R9, R0, 9},
    idq2=\srcentryb{ADDI R8, R0, 8},
...
\OOODiagramKV[
    ...
    rob41=\oldentry{LW R5,100(R4)},
    rob42=\oldentry{INV},
    rob51=\oldentry{\sout{ADDI R3,R2,2}},
    rob52=\oldentry{OK},
    rob61=\oldentry{ADDI R5,R3,2},
    rob62=\newentrya{OK},
    rob71=\oldentry{ADDI R6,R0,6},
...
\begin{frame}{OOOE: Cycle 7, MOB Still Waits for Load}
\OOODiagramKV[
    % PRF mappings
    R3=\oldentry{\sout{RB4}},
    R5=\oldentry{RB5},
...
\begin{frame}{OOOE: Cycle 7, Execution Starts, ALU Limit Reached}
\OOODiagramKV[
    % PRF mappings
    R3=\oldentry{\sout{RB4}},
    R5=\oldentry{RB5},
...
\OOODiagramKV[
    ...
    R8=\oldentry{RB8},
    R9=\oldentry{RB0},
    idq1=\srcentryb{BNE R1, R10, L1},
    idq2=\srcentrya{ADDI R1,R1,1},
...
\begin{frame}{OOOE: Cycle 7, Instruction Fetch, Next Loop Iteration}
\OOODiagramKV[
    % PRF mappings
    R1=\oldentry{RB1},
    R3=\oldentry{\sout{RB4}},
    ...
    idq2=\newentrya{ADDI R4,R0,20},
    rs1=\oldentry{\sout{RB8$\leftarrow$R0+8}},
    rs2=\oldentry{RB1$\leftarrow$R1+1},
    rs3=\oldentry{RB2$\leftarrow$RB1-R10},
    rs4=\oldentry{RB0$\leftarrow$R0+9},
    rs5=\oldentry{\sout{RB7$\leftarrow$RB5+R0}},
    rob11=\oldentry{ADDI R9,R0,9},
    rob12=\oldentry{INV},
    rob21=\oldentry{ADDI R1,R1,1},
    rob22=\oldentry{INV},
    rob31=\oldentry{BNE R1,R10,L1},
    rob32=\oldentry{INV},
    rob41=\oldentry{LW R5,100(R4)},
    rob42=\oldentry{INV},
    rob51=\oldentry{\sout{ADDI R3,R2,2}},
