...
\newcommand{\OOODiagramKV}[1][]{%
    ...
    \tikzstyle{roundbox}=[draw, ellipse, minimum width=3cm, minimum height=1cm]
    \tikzstyle{dashedbox}=[draw, dashed, rectangle, minimum width=3cm, minimum height=0.8cm]
    \tikzstyle{cell}=[minimum width=0.8cm, minimum height=0.3cm]
    
    % RAT (Register Alias Table) with internal table structure
    \node[draw, rectangle, minimum width=2cm, minimum height=4.5cm, label=above:{\textbf{RAT}}] (rat) at (0,0) {};
    
    % Create the 2-column table inside RAT
    \node[matrix of nodes, 
          nodes={cell, draw, anchor=center},
          column sep=-\pgflinewidth,
          row sep=-\pgflinewidth,
          inner sep=0pt,
          ampersand replacement=\&] at (rat.center) {
    ...
    % ROB (Reorder Buffer) - empty structure
    \node[draw, rectangle, minimum width=3cm, minimum height=3.5cm, label=above:{\textbf{ROB}}, right=of rat, xshift=0.5cm] (rob) {};
    
    % IDQ (Instruction Decode Queue) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=2.5cm, label=above:{\textbf{IDQ}}, right=of rob, xshift=0.3cm, yshift=1cm] (idq) {};
    
    % RS (Reservation Station) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=2.5cm, label=above:{\textbf{RS}}, below=of idq, yshift=0.3cm] (rs) {};
    
    % MOB (Memory Order Buffer) - empty structure
    \node[draw, rectangle, minimum width=2.5cm, minimum height=1.5cm, label=above:{\textbf{MOB}}, right=of idq, xshift=0.3cm] (mob) {};
...
\begin{frame}
\OOODiagramKV[R1=P12, R3=P7, R5=P9] 
\end{frame}
