...
0.75 & 1.75 & 1.75 \\
0.8 & 2.25 & 2.0 \\
\rowcolor{yellow!30} 0.85 & 2.5 & 2.25 \\
0.9 & 3.0 & 2.5 \\
0.95 & 3.5 & 2.75 \\
\rowcolor{yellow!30} 1.0 & 4.0 & 3.0 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Small core:}
$4W \geq 0.5 + 500\text{pF} \cdot V^2 \cdot f$\par
From table: $V = 1$V, $f = 3$GHz\par
\vspace{-4mm}
$$P = 0.5 + 500 \cdot 1^2 \cdot 3 = 2\text{W} < 4\text{W} \checkmark$$

\textbf{Large core:}
$4W \geq 1 + 1500\text{pF} \cdot V^2 \cdot f$\par
From table: $V = 0.85$V, $f = 2.5$GHz\par
\vspace{-4mm}
$$P = 1 + 1500 \cdot 0.85^2 \cdot 2.5 = 3.7\text{W} < 4\text{W} \checkmark$$
\end{columns}
\end{frame}
