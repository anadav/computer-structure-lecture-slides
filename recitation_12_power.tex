...
\draw[red, thick, ->] ([xshift=1mm, yshift=0mm]pic cs:lgf1) ++(5mm,0) -- ([xshift=1mm]pic cs:lg1) ++(-5mm,0);
...
% Arrow connecting them - from east of frequency to west of power
\draw[red, thick, ->] ([xshift=1mm, yshift=0mm]pic cs:smf1) ++(5mm,0) -- ([xshift=1mm]pic cs:sm1) ++(-5mm,0);
\end{tikzpicture}
