...
\makecell{Voltage \\ (V)} \\
\hline
0.68 & 1.38 & 0.18 & 0.38 & 1 & 0.7 & 0.6 \\
0.76 & 1.63 & 0.26 & 0.63 & 1.25 & 1 & 0.65 \\
0.87 & \tikzmark{lg1}1.99\tikzmark{lg2} & 0.37 & 0.99 & 1.5 & \tikzmark{lgf1}1.35\tikzmark{lgf2} & 0.7 \\
0.99 & 2.48 & 0.49 & 1.48 & 1.75 & 1.75 & 0.75 \\
1.14 & 3.16 & 0.64 & 2.16 & 2 & 2.25 & 0.8 \\
1.31 & 3.71 & 0.81 & 2.71 & 2.25 & 2.5 & 0.85 \\
1.51 & 4.65 & 1.01 & 3.65 & 2.5 & 3 & 0.9 \\
1.74 & 5.74 & 1.24 & 4.74 & 2.75 & 3.5 & 0.95 \\
\tikzmark{sm1}2.00\tikzmark{sm2} & 7.00 & 1.50 & 6.00 & \tikzmark{smf1}3\tikzmark{smf2} & 4 & 1 \\
\hline
\end{tabular}
};
...
\draw[red, thick] ([xshift=-1mm]pic cs:lg1) ellipse (5mm and 3mm);
% Oval for large core frequency (wider)
\draw[red, thick] ([xshift=-1mm]pic cs:lgf1) ellipse (5mm and 3mm);
% Arrow connecting them
\draw[red, thick, <-] ([xshift=-1mm]pic cs:lg2) -- ([xshift=-2mm]pic cs:lgf1);

% Oval for small core power (wider)
\draw[red, thick] ([xshift=-1mm]pic cs:sm1) ellipse (5mm and 3mm);
% Oval for small core frequency (wider)
\draw[red, thick] ([xshift=-1mm]pic cs:smf1) ellipse (5mm and 3mm);
% Arrow connecting them
...
\alert{Result: Two small cores are better}
\end{columns}
\end{frame}
