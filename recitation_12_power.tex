...
\begin{tikzpicture}[scale=0.5,
    ...
    \matrix[matrix of nodes,
        ...
        |[filled]| \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \& \phantom{X} \& |[filled]| \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \\
        |[filled]| \phantom{X} \& \phantom{X} \& \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \& \phantom{X} \& \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \\
        \phantom{X} \& \phantom{X} \& |[filled]| \phantom{X} \& \phantom{X} \& \phantom{X} \& \phantom{X} \& \phantom{X} \& \phantom{X} \& \phantom{X} \\
    };
