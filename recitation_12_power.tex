...
\subsection{Question 3: L1 Cache Addition}

\begin{frame}{Q3: L1 Cache Addition}
...
\subsection{Question 4: Cache Design Impact}

\begin{frame}{Q4: Cache Design Impact}
...
\subsection{Question 5: Single Thread Performance}

\begin{frame}{Q5: Power/Performance Analysis}
...
\begin{frame}{Q5: Leakage Power Calculation}
\textbf{Question:} Which processor provides best single-thread performance at 4W?
...
\begin{frame}{Q5: Frequency Calculation (4W Budget)}
...
Parameter & Small & Large \\
\midrule
Leakage & \cellcolor{yellow!30}0.5W & \cellcolor{orange!30}1W \\
Cap. & \cellcolor{yellow!30}500 pF & \cellcolor{orange!30}1500 pF \\
\bottomrule
\end{tabular}
\end{table}
...
0.75 & 1.75 & 1.75 \\
0.8 & 2.0 & 2.25 \\
\cellcolor{orange!30}0.85 & 2.25 & \cellcolor{orange!30}2.5 \\
0.9 & 2.5 & 3.0 \\
0.95 & 2.75 & 3.5 \\
\cellcolor{yellow!30}1.0 & \cellcolor{yellow!30}3.0 & 4.0 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Small core:}
$4W \geq \colorbox{yellow!30}{0.5W} + \colorbox{yellow!30}{500\text{pF}} \cdot V^2 \cdot f$\par
From table: $V = \colorbox{yellow!30}{1\text{V}}$, $f = \colorbox{yellow!30}{3\text{GHz}}$\par
\vspace{-4mm}
$$P = \colorbox{yellow!30}{0.5} + \colorbox{yellow!30}{500} \cdot \colorbox{yellow!30}{1}^2 \cdot \colorbox{yellow!30}{3} = 2\text{W} < 4\text{W} \checkmark$$

\textbf{Large core:}
$4W \geq \colorbox{orange!30}{1W} + \colorbox{orange!30}{1500\text{pF}} \cdot V^2 \cdot f$\par
From table: $V = \colorbox{orange!30}{0.85\text{V}}$, $f = \colorbox{orange!30}{2.5\text{GHz}}$\par
\vspace{-4mm}
$$P = \colorbox{orange!30}{1} + \colorbox{orange!30}{1500} \cdot \colorbox{orange!30}{0.85}^2 \cdot \colorbox{orange!30}{2.5} = 3.7\text{W} < 4\text{W} \checkmark$$
\end{columns}
\end{frame}

\begin{frame}{Q5: Performance Comparison}
...
\subsection{Question 6: Multi-Thread Performance}

\begin{frame}{Q6: Multi-Thread Performance (2W per Core)}
...
\subsection{Question 7: Power Table Analysis}

\begin{frame}{Q7: Power Table Analysis (2W per Core)}
