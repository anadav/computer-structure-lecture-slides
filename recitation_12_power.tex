...
\cellcolor{cyan!35}0.85 & 2.25 & \cellcolor{cyan!50}2.5 & 0.81 & 2.71 & 1.31 & \cellcolor{green!40}3.71 \\
0.9 & 2.5 & 3.0 & 1.01 & 3.65 & 1.51 & 4.65 \\
0.95 & 2.75 & 3.5 & 1.24 & 4.74 & 1.74 & 5.74 \\
\cellcolor{orange!40}1.0 & \cellcolor{orange!60}3.0 & 4.0 & 1.50 & 6.00 & \cellcolor{yellow!50}2.00 & 7.00 \\
\hline
\end{tabular}
...
\textbf{Small core:} All points fit!\\
Max at \colorbox{orange!40}{V=1.0V}: \colorbox{orange!60}{f=3.0 GHz}, \colorbox{yellow!50}{P=2.0W}

\vspace{2mm}
\textbf{Large core:}\\
Max at \colorbox{cyan!35}{V=0.85V}: \colorbox{cyan!50}{f=2.5 GHz}, \colorbox{green!40}{P=3.71W}
\end{columns}
\end{frame}
