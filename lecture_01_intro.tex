...
\begin{tikzpicture}
    ...
    \begin{scope}
        \begin{semilogyaxis}[
            ...
            xlabel={Year},
            ylabel={MOSFET Size (nm)},
            ylabel style={font=\footnotesize, text=red!80!black},
            xlabel style={font=\footnotesize, text=red!80!black},
            xmin=1970, xmax=2025,
            ymin=1, ymax=20000,
            grid=none,
            tick label style={font=\scriptsize, text=red!80!black},
            legend pos=north east,
            legend style={font=\scriptsize, fill=white, fill opacity=0.8, draw=red!80!black},
            axis line style={red!80!black, thick},
            tick style={red!80!black},
            axis background/.style={fill=none}
        ]
        % MOSFET scaling data points
        \addplot[red, very thick, mark=*, mark size=2pt, mark options={fill=red}] coordinates {
            (1971, 10000)
            (1974, 6000)
            (1977, 3000)
            (1981, 1500)
