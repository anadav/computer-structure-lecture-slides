...
\begin{tikzpicture}[scale=0.95]
  ...
  \node[anchor=west, font=\footnotesize] at (0, 3.0) {Address Fields};
  \vspace{0.2cm}
  % Bit numbers
  \node[font=\tiny] at (0.3, 2.6) {31};
  \node[font=\tiny] at (2.2, 2.6) {13 12};
  \node[font=\tiny] at (3.4, 2.6) {5 4};
  \node[font=\tiny] at (4.4, 2.6) {0};
  
  % Address fields boxes
  \draw[thick] (0.5, 2.1) rectangle (2.2, 2.4);
  \draw[thick] (2.2, 2.1) rectangle (3.6, 2.4);
  \draw[thick] (3.6, 2.1) rectangle (4.4, 2.4);
  
  \node at (1.35, 2.25) {\tiny Tag};
  \node at (2.9, 2.25) {\tiny Set};
  \node at (4.0, 2.25) {\tiny Offset};
  
  % Arrows pointing down from address fields
  \draw[->, thick] (1.35, 2.1) -- (1.35, 1.6);
  \draw[->, thick] (2.9, 2.1) -- (2.9, 1.3) -- (1.0, 1.3) -- (1.0, 0.6);
  
  % Cache structure - Way #0
  \node[font=\tiny] at (1.4, -1.8) {WAY \#0};
  
  % Tag Array Way 0
  \draw[thick] (0.5, 0.8) rectangle (1.4, -1.0);
  \foreach \y in {0.6, 0.4, 0.2, 0, -0.2, -0.4, -0.6, -0.8}
    \draw (0.5, \y) -- (1.4, \y);
  % Fill some entries green
  \fill[green!30] (0.5, 0.6) rectangle (1.4, 0.4);
  \fill[green!30] (0.5, 0.2) rectangle (1.4, 0);
  \fill[green!30] (0.5, 0) rectangle (1.4, -0.2);
  \fill[green!30] (0.5, -0.2) rectangle (1.4, -0.4);
  \fill[green!30] (0.5, -0.4) rectangle (1.4, -0.6);
  
  \node[font=\tiny] at (0.2, 0.1) {Set\#};
  
  % Data Array Way 0
  \draw[thick] (1.4, 0.8) rectangle (2.5, -1.0);
  \foreach \y in {0.6, 0.4, 0.2, 0, -0.2, -0.4, -0.6, -0.8}
    \draw (1.4, \y) -- (2.5, \y);
  
  \node[font=\tiny, rotate=90] at (0.7, 1.1) {Tag};
  \node[font=\tiny, rotate=90] at (1.95, 1.1) {Line};
  
  \node[font=\tiny] at (0.95, -1.2) {Tag};
  \node[font=\tiny] at (0.95, -1.45) {Array};
  \node[font=\tiny] at (1.95, -1.2) {0 Data 31};
  \node[font=\tiny] at (1.95, -1.45) {Array};
  
  % Cache structure - Way #1
  \node[font=\tiny] at (4.0, -1.8) {WAY \#1};
  
  % Tag Array Way 1
  \draw[thick] (3.2, 0.8) rectangle (4.1, -1.0);
  \foreach \y in {0.6, 0.4, 0.2, 0, -0.2, -0.4, -0.6, -0.8}
    \draw (3.2, \y) -- (4.1, \y);
  % Fill some entries green
  \fill[green!30] (3.2, 0.6) rectangle (4.1, 0.4);
  \fill[green!30] (3.2, 0.2) rectangle (4.1, 0);
  \fill[green!30] (3.2, 0) rectangle (4.1, -0.2);
  \fill[green!30] (3.2, -0.2) rectangle (4.1, -0.4);
  \fill[green!30] (3.2, -0.4) rectangle (4.1, -0.6);
  
  \node[font=\tiny] at (2.9, 0.1) {Set\#};
  
  % Data Array Way 1
  \draw[thick] (4.1, 0.8) rectangle (5.2, -1.0);
  \foreach \y in {0.6, 0.4, 0.2, 0, -0.2, -0.4, -0.6, -0.8}
    \draw (4.1, \y) -- (5.2, \y);
  
  \node[font=\tiny, rotate=90] at (3.4, 1.1) {Tag};
  \node[font=\tiny, rotate=90] at (4.65, 1.1) {Line};
  
  \node[font=\tiny] at (3.65, -1.2) {Tag};
  \node[font=\tiny] at (3.65, -1.45) {Array};
  \node[font=\tiny] at (4.65, -1.2) {0 Data 31};
  \node[font=\tiny] at (4.65, -1.45) {Array};
  
  % Arrow to second way
  \draw[->, thick] (1.35, 1.6) -- (3.6, 1.6) -- (3.6, 0.8);
...
\footnotesize
Line Size: \hspace{0.2cm} 32 bytes = $2^5$ bytes\\
Cache Size: 16KB = $2^{14}$ bytes\\
\#lines = cache size / line size =\\
\hspace{1.2cm} $2^{14} / 2^5 = 2^9$ = 512 lines\\
\#ways: \hspace{0.5cm} 2\\
\#sets = \#lines/\#ways = 256 = $2^8$ sets\\[4pt]

Offset bits: $\log_2$(line size) = 5 bits\\
Set bits: \hspace{0.3cm} $\log_2$(\#sets) = 8 bits\\
Tag bits: \hspace{0.3cm} 32 -- (5+8) = 19 bits\\[4pt]

Address 0x12345678\\
{\scriptsize\texttt{0001 0010 0011 0100 010\textcolor{orange}{1 0110 011}\textcolor{red}{1 1000}}}\\[3pt]
...
% Add this frame to your existing beamer presentation
% Place it after the "Line Fill and Fill Buffers" frame
...
% Arrows with labels
\draw[arrow] (l1.east) -- node[above, label] {64B} (buf1.west);
\draw[arrow] (buf3.east) -- node[above, label] {16B} (l2.west);
