...
\begin{tikzpicture}[scale=0.9]
  % Top labels
  \node[anchor=east, font=\scriptsize] at (0.3, 0.5) {N-1};
  \node[anchor=west, font=\scriptsize] at (2.9, 0.5) {6 5};
  \node[anchor=west, font=\scriptsize] at (3.9, 0.5) {0};
...
\begin{tikzpicture}[scale=0.55]
  ...
  \node[anchor=east, font=\tiny\bfseries] at (0.0, 3.9) {\underline{Block \#}};
  ...
  \node[rectangle, draw, minimum width=0.4cm, minimum height=0.35cm, fill=lightpurple] (cachetag90) at (3.7, 2.6) {};
  \node[font=\tiny] at (3.7, 2.6) {90};
  \node[rectangle, draw, minimum width=0.8cm, minimum height=0.35cm, fill=lightpurple] (cache90) at (4.5, 2.6) {};
  
  \node[rectangle, draw, minimum width=0.4cm, minimum height=0.35cm, fill=lightgreen] (cachetag2) at (3.7, 2.1) {};
  \node[font=\tiny] at (3.7, 2.1) {2};
  \node[rectangle, draw, minimum width=0.8cm, minimum height=0.35cm, fill=lightgreen] (cache2) at (4.5, 2.1) {};
  
  \node[rectangle, draw, minimum width=0.4cm, minimum height=0.35cm, fill=lightblue] (cachetag4) at (3.7, 1.6) {};
  \node[font=\tiny] at (3.7, 1.6) {4};
  \node[rectangle, draw, minimum width=0.8cm, minimum height=0.35cm, fill=lightblue] (cache4) at (4.5, 1.6) {};
  
  \node[rectangle, draw, minimum width=0.4cm, minimum height=0.35cm, fill=lightyellow] (cachetag92) at (3.7, 1.1) {};
  \node[font=\tiny] at (3.7, 1.1) {92};
  \node[rectangle, draw, minimum width=0.8cm, minimum height=0.35cm, fill=lightyellow] (cache92) at (4.5, 1.1) {};
