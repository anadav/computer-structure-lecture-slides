...
\begin{tikzpicture}[scale=0.85]
  ...
  % Memory column title
  \node[anchor=north, font=\bfseries\large] at (1.5, 5.2) {memory};
  
  % Memory blocks
  \node[anchor=east, font=\small\bfseries] at (0.3, 4.5) {\underline{Block \#}};
  \node[anchor=west, font=\small] at (1.8, 4.5) {$\leftarrow$ 64B $\rightarrow$};
  
  % Memory blocks with numbers
  \node[anchor=east, font=\small] at (0.5, 4.0) {0};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem0) at (1.5, 4.0) {};
  
  \node[anchor=east, font=\small] at (0.5, 3.5) {1};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem1) at (1.5, 3.5) {};
  
  \node[anchor=east, font=\small] at (0.5, 3.0) {2};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=lightgreen] (mem2) at (1.5, 3.0) {};
  
  \node[anchor=east, font=\small] at (0.5, 2.5) {3};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem3) at (1.5, 2.5) {};
  
  \node[anchor=east, font=\small] at (0.5, 2.0) {4};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=lightblue] (mem4) at (1.5, 2.0) {};
  
  \node[anchor=east, font=\small] at (0.5, 1.5) {5};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem5) at (1.5, 1.5) {};
  
  \node[anchor=east, font=\small] at (0.5, 1.0) {6};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem6) at (1.5, 1.0) {};
  
  % Dots
  \node[font=\small] at (0.5, 0.5) {.};
  \node[font=\small] at (0.5, 0.3) {.};
  \node[font=\small] at (0.5, 0.1) {.};
  \node[font=\small] at (1.5, 0.3) {$\sim$};
  
  % Bottom memory blocks
  \node[anchor=east, font=\small] at (0.5, -0.3) {90};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=lightpurple] (mem90) at (1.5, -0.3) {};
  
  \node[anchor=east, font=\small] at (0.5, -0.8) {91};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem91) at (1.5, -0.8) {};
  
  \node[anchor=east, font=\small] at (0.5, -1.3) {92};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=lightyellow] (mem92) at (1.5, -1.3) {};
  
  \node[anchor=east, font=\small] at (0.5, -1.8) {93};
  \node[rectangle, draw, thick, minimum width=1.2cm, minimum height=0.4cm, fill=white] (mem93) at (1.5, -1.8) {};
  
  % More dots
  \node[font=\small] at (0.5, -2.2) {.};
  \node[font=\small] at (0.5, -2.4) {.};
  \node[font=\small] at (0.5, -2.6) {.};
  \node[font=\small] at (1.5, -2.4) {$\sim$};
  
  % Cache column
  \node[anchor=north, font=\bfseries\large] at (4.5, 5.2) {cache};
  
  % Cache lines with block numbers
  \node[rectangle, draw, thick, minimum width=0.5cm, minimum height=0.4cm, fill=lightpurple] at (3.8, 3.5) {};
  \node[font=\small] at (3.8, 3.5) {90};
  \node[rectangle, draw, thick, minimum width=1.0cm, minimum height=0.4cm, fill=lightpurple] (cache90) at (4.8, 3.5) {};
  
  \node[rectangle, draw, thick, minimum width=0.5cm, minimum height=0.4cm, fill=lightgreen] at (3.8, 3.0) {};
  \node[font=\small] at (3.8, 3.0) {2};
  \node[rectangle, draw, thick, minimum width=1.0cm, minimum height=0.4cm, fill=lightgreen] (cache2) at (4.8, 3.0) {};
  
  \node[rectangle, draw, thick, minimum width=0.5cm, minimum height=0.4cm, fill=lightblue] at (3.8, 2.5) {};
  \node[font=\small] at (3.8, 2.5) {4};
  \node[rectangle, draw, thick, minimum width=1.0cm, minimum height=0.4cm, fill=lightblue] (cache4) at (4.8, 2.5) {};
  
  \node[rectangle, draw, thick, minimum width=0.5cm, minimum height=0.4cm, fill=lightyellow] at (3.8, 2.0) {};
  \node[font=\small] at (3.8, 2.0) {92};
  \node[rectangle, draw, thick, minimum width=1.0cm, minimum height=0.4cm, fill=lightyellow] (cache92) at (4.8, 2.0) {};
