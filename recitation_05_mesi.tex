...
\section{Question 1: Three-Core MESI}

%==========================================
\begin{frame}{Three-Core MESI Problem -- Setup}
...
\begin{frame}{Three-Core MESI Problem}
\mesitwohdr
\begin{table}[h]
\centering
...
\hline
\rowcolor{gray!20}
\textbf{Operation} & \textbf{P1} & \textbf{P2} & \textbf{P3} & \textbf{P1} & \textbf{P2} & \textbf{P3} & \textbf{Time} & \textbf{Messages} \\
\rowcolor{gray!20}
 & & & & \multicolumn{3}{c|}{CVB} & (ns) & \\
\hline
Initial & I & I & I & 0 & 0 & 0 & 0 & -- \\
\hline
P2 reads A & \onslide<1->{I} & \onslide<1->{E} & \onslide<1->{I} & \onslide<1->{0} & \onslide<1->{1} & \onslide<1->{0} & \onslide<1->{220} & \onslide<1->{\vspace{-3mm}\textcolor{messageblue}{L1 miss $\to$ L2, L2 miss $\to$ Mem, Mem $\to$ L2 data, L2 $\to$ L1 data}} \\
\hline
P2 writes A & \onslide<2->{I} & \onslide<2->{M} & \onslide<2->{I} & \onslide<2->{0} & \onslide<2->{1} & \onslide<2->{0} & \onslide<2->{0} & \onslide<2->{\vspace{-3mm}\textcolor{messageblue}{No messages (silent E$\to$M transition)}} \\
\hline
P1 reads A & \onslide<3->{S} & \onslide<3->{S} & \onslide<3->{I} & \onslide<3->{1} & \onslide<3->{1} & \onslide<3->{0} & \onslide<3->{40} & \onslide<3->{\vspace{-3mm}\textcolor{messageblue}{L1 miss $\to$ L2, L2 snoop $\to$ P2, P2 data $\to$ L2, L2 data $\to$ P1}} \\
\hline
P2 reads A & \onslide<4->{S} & \onslide<4->{S} & \onslide<4->{I} & \onslide<4->{1} & \onslide<4->{1} & \onslide<4->{0} & \onslide<4->{0} & \onslide<4->{\vspace{-3mm}\textcolor{messageblue}{Cache hit -- no messages}} \\
\hline
P3 reads A & \onslide<5->{S} & \onslide<5->{S} & \onslide<5->{S} & \onslide<5->{1} & \onslide<5->{1} & \onslide<5->{1} & \onslide<5->{20} & \onslide<5->{\vspace{-3mm}\textcolor{messageblue}{L1 miss $\to$ L2, L2 hit $\to$ P3 data}} \\
\hline
P3 writes A & \onslide<6->{I} & \onslide<6->{I} & \onslide<6->{M} & \onslide<6->{0} & \onslide<6->{0} & \onslide<6->{1} & \onslide<6->{30} & \onslide<6->{\vspace{-3mm}\textcolor{messageblue}{RFO $\to$ L2, L2 snoop invalidate P1+P2, L2 $\to$ P3 grant}} \\
\hline
\end{tabular}
}
\end{table}
...
%==========================================
\begin{frame}{MESI Coherence Problem -- Setup}
\footnotesize
\textbf{System Configuration:}
\begin{itemize}
...
\vspace{0.5em}
\begin{tcolorbox}[colback=blue!5, colframe=blue!50, fonttitle=\footnotesize, title=Problem]
...
\begin{frame}{MESI Coherence Problem}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|l|>{\raggedright\arraybackslash}p{9cm}|c|c|c|c|}
\hline
\rowcolor{gray!20}
\# & \textbf{Operation} & \textbf{Messages Sent} & \textbf{Time} & \textbf{P0} & \textbf{P1} & \textbf{State} \\
\hline
1 & \makecell[l]{P0\\reads X1} & \onslide<2->{\vspace{-4mm}\textcolor{messageblue}{P0$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P0 data} \textcolor{timecolor}{(3)}} & \onslide<2->{\textcolor{timecolor}{226}} & \onslide<2->{1} & \onslide<2->{0} & \onslide<2->{\textcolor{stateE}{\textbf{E}}} \\
\hline
2 & \makecell[l]{P1\\writes X3} & \textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{226} & 0 & 1 & \textcolor{stateM}{\textbf{M}} \\
\hline
3 & \makecell[l]{P1\\writes X4} & \onslide<3->{\vspace{-4mm}\textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 wb} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM wb} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)}} & \onslide<3->{\textcolor{timecolor}{336}} & \onslide<3->{0} & \onslide<3->{1} & \onslide<3->{\textcolor{stateM}{\textbf{M}}} \\
\hline
4 & \makecell[l]{P1\\writes X5} & \onslide<4->{\vspace{-4mm}\textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$L1 snoop} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$L2 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM wb} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)}} & \onslide<4->{\textcolor{timecolor}{356}} & \onslide<4->{0} & \onslide<4->{1} & \onslide<4->{\textcolor{stateM}{\textbf{M}}} \\
\hline
5 & \makecell[l]{P0\\reads X5} & \onslide<5->{\vspace{-4mm}\textcolor{messageblue}{P0$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$P1 snoop} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{P1$\to$L2 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P0 data} \textcolor{timecolor}{(3)}} & \onslide<5->{\textcolor{timecolor}{86}} & \onslide<5->{1} & \onslide<5->{1} & \onslide<5->{\textcolor{stateS}{\textbf{S}}} \\
\hline
6 & \makecell[l]{P1\\reads X4} & \onslide<6->{\vspace{-4mm}\textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{\{L2 snoops + L2$\to$MEM wb\}} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 data} \textcolor{timecolor}{(3)}} & \onslide<6->{\textcolor{timecolor}{316}} & \onslide<6->{0} & \onslide<6->{1} & \onslide<6->{\textcolor{stateE}{\textbf{E}}} \\
\hline
\end{tabular}
}
\end{table}
...
\only<3>{X3/X4 same L1 set $\Rightarrow$ evict X3 (Modified $\Rightarrow$ writeback). \underline{Underlined} = eviction writes.}%
\only<4>{L2 miss $\Rightarrow$ \textbf{Inclusion}: L2 snoops P1 for X4 (modified), gets writeback. Longest path!}%
\only<5>{L2 hit but P1 has X5 Modified $\Rightarrow$ snoop gets dirty data. Both become \textbf{S}. Shortest path!}%
\only<6>{L1+L2 miss $\Rightarrow$ fetch from memory. X5 evicted from L2 $\Rightarrow$ snoop+writeback. \{braces\} = parallel.}%
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Summary}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\# & \textbf{Operation} & \textbf{Messages Sent} & \textbf{Time} & \textbf{P0} & \textbf{P1} & \textbf{State} \\
\hline
1 & P0 reads X1 & \textcolor{messageblue}{P0$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P0 data} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{226} & 1 & 0 & \textcolor{stateE}{\textbf{E}} \\
\hline
2 & \makecell[l]{P1\\writes X3} & \textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{226} & 0 & 1 & \textcolor{stateM}{\textbf{M}} \\
\hline
3 & \makecell[l]{P1\\writes X4} & \textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 wb} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM wb} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{336} & 0 & 1 & \textcolor{stateM}{\textbf{M}} \\
\hline
4 & \makecell[l]{P1\\writes X5} & \textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$L1 snoop} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$L2 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$MEM wb} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 write} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{356} & 0 & 1 & \textcolor{stateM}{\textbf{M}} \\
\hline
5 & \makecell[l]{P0\\reads X5} & \textcolor{messageblue}{P0$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$P1 snoop} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{P1$\to$L2 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P0 data} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{86} & 1 & 1 & \textcolor{stateS}{\textbf{S}} \\
\hline
6 & \makecell[l]{P1\\reads X4} & \textcolor{messageblue}{P1$\to$L1 miss} \textcolor{timecolor}{(3)}, \textcolor{messageblue}{L1$\to$L2 rd miss} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{\{L2 snoops + L2$\to$MEM wb\}} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$MEM rd} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{MEM$\to$L2 data} \textcolor{timecolor}{(90)}, \textcolor{messageblue}{L2$\to$L1 data} \textcolor{timecolor}{(20)}, \textcolor{messageblue}{L1$\to$P1 data} \textcolor{timecolor}{(3)} & \textcolor{timecolor}{316} & 0 & 1 & \textcolor{stateE}{\textbf{E}} \\
\hline
\end{tabular}
}
\end{table}
...
\begin{tcolorbox}[colback=yellow!10, colframe=orange!60, fonttitle=\footnotesize, title=Key Observations]
\footnotesize
\textbullet~\textcolor{timecolor}{(cycles)}: Time for each message\\
\textbullet~\{Braces\}: Parallel operations\\
\textbullet~wb = writeback, rd = read\\
\textbullet~Direct-mapped $\Rightarrow$ frequent evictions
\end{tcolorbox}

\column{0.48\textwidth}
\begin{tcolorbox}[colback=blue!10, colframe=blue!60, fonttitle=\footnotesize, title=Critical Paths]
\footnotesize
\textbullet~Longest: Step 4 (356ns) -- eviction + snoop + fetch\\
\textbullet~Shortest: Step 5 (86ns) -- data from modified cache\\
\textbullet~Memory writes on evictions \& snoops
\end{tcolorbox}
\end{columns}
\end{frame}
