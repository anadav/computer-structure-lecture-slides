...
\column{0.48\textwidth}
\textbf{Mapping:} X1-X4→same L1 set, X5→diff L1 set\\
X1-X2→same L2 set, X3-X5→diff L2 set
\end{columns}
...
\begin{tabular}{|c|l|>{\raggedright\arraybackslash}p{8cm}|c|c|c|c|}
\hline
\rowcolor{gray!20}
...
\hline
1 & P0 reads X1 & 
\textcolor{messageblue}{P0→L1 miss (3), P0-L1→L2 read miss (20), L2→MEM read (90), MEM→L2 data (90), L2→P0-L1 data (20), P0-L1→P0 data (3)} & 
\textcolor{timecolor}{226} & 
1 & 
0 & 
\cellcolor{stateE}E \\
\hline
2 & P1 writes X3 & 
\textcolor{messageblue}{P1→L1 miss (3), P1-L1→L2 read miss (20), L2→MEM read (90), MEM→L2 data (90), L2→P1-L1 data (20), P1-L1→P1 write (3)} & 
\textcolor{timecolor}{226} & 
0 & 
1 & 
\cellcolor{stateM}M \\
...
3 & P1 writes X4 & 
\only<2>{\textcolor{messageblue}{P1→L1 miss (3), \underline{P1-L1→L2 write (20)}, P1-L1→L2 read miss (20), \underline{L2→MEM write (90)}, L2→MEM read (90), MEM→L2 data (90), L2→P1-L1 data (20), P1→write (3)}}\only<3->{~} & 
\only<2>{\textcolor{timecolor}{336}}\only<3->{~} & 
\only<2>{0}\only<3->{~} & 
\only<2>{1}\only<3->{~} & 
\only<2>{\cellcolor{stateM}M}\only<3->{~} \\
\hline
4 & P1 writes X5 & 
\only<2>{\textcolor{messageblue}{P1→L1 miss (3), P1-L1→L2 read miss (20), \underline{L2→P1-L1 snoop (20)}, \underline{P1-L1→L2 data (20)}, \underline{L2→MEM write (90)}, L2→MEM read (90), MEM→L2 data (90), L2→P1-L1 data (20), P1→write (3)}}\only<3->{~} & 
\only<2>{\textcolor{timecolor}{356}}\only<3->{~} & 
\only<2>{0}\only<3->{~} & 
\only<2>{1}\only<3->{~} & 
\only<2>{\cellcolor{stateM}M}\only<3->{~} \\
\hline
5 & P0 reads X5 & 
\only<2>{\textcolor{messageblue}{P0→L1 miss (3), P0-L1→L2 read miss (20), \textbf{L2→P1-L1 snoop (20)}, \textbf{P1-L1→L2 data (20)}, L2→P0-L1 data (20), P0-L1→P0 data (3)}}\only<3->{~} & 
\only<2>{\textcolor{timecolor}{86}}\only<3->{~} & 
\only<2>{1}\only<3->{~} & 
\only<2>{1}\only<3->{~} & 
\only<2>{\cellcolor{stateS}S}\only<3->{~} \\
\hline
6 & P1 reads X4 & 
\only<2>{\textcolor{messageblue}{P1→L1 miss (3), P1-L1→L2 read miss (20), \{L2→P1-L1 snoop + L2→P0-L1 snoop + L2→MEM write\} (90), L2→MEM read (90), MEM→L2 data (90), L2→P1-L1 data (20), P1-L1→P1 (3)}}\only<3->{~} & 
\only<2>{\textcolor{timecolor}{316}}\only<3->{~} & 
\only<2>{0}\only<3->{~} & 
\only<2>{1}\only<3->{~} & 
\only<2>{\cellcolor{stateE}E}\only<3->{~} \\
\hline
\end{tabular}
\end{table}
