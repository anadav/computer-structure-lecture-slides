...
\begin{frame}{Three-Core MESI Problem -- Step 1}
\mesitwohdr
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
P2 reads A & I & E & I & 0 & 1 & 0 & 220 & \textcolor{messageblue}{L1 miss $\to$ L2, L2 miss $\to$ Mem, Mem $\to$ L2 data, L2 $\to$ L1 data} \\
\hline
P2 writes A & ? & ? & ? & ? & ? & ? & ? & ? \\
\hline
P1 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
...
\footnotesize
Cold miss $\Rightarrow$ full memory round-trip. \textbf{E} state since P2 is the only holder.
\end{tcolorbox}
\end{frame}

\begin{frame}{Three-Core MESI Problem -- Step 2}
\mesitwohdr
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.1}
...
\hline
\rowcolor{yellow!20}
P2 writes A & I & M & I & 0 & 1 & 0 & 0 & \textcolor{messageblue}{No messages (silent E$\to$M transition)} \\
\hline
P1 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
\hline
P2 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black, top=1mm, bottom=1mm]
\footnotesize
\textbf{E$\to$M is free!} Silent transition, no bus traffic. Key advantage of Exclusive state.
\end{tcolorbox}
\end{frame}

\begin{frame}{Three-Core MESI Problem -- Step 3}
\mesitwohdr
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.1}
...
\hline
\rowcolor{yellow!20}
P1 reads A & S & S & I & 1 & 1 & 0 & 40 & \textcolor{messageblue}{P1: L1 miss $\to$ L2, L2 snoop $\to$ P2, P2 data $\to$ L2, L2 data $\to$ P1} \\
\hline
P2 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
\hline
P3 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black, top=1mm, bottom=1mm]
\footnotesize
P2 has Modified $\Rightarrow$ L2 snoops, P2 returns dirty data. Both become \textbf{S}.
\end{tcolorbox}
\end{frame}

\begin{frame}{Three-Core MESI Problem -- Step 4}
\mesitwohdr
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.1}
...
\hline
\rowcolor{yellow!20}
P2 reads A & S & S & I & 1 & 1 & 0 & 0 & \textcolor{messageblue}{Cache hit -- no messages} \\
\hline
P3 reads A & ? & ? & ? & ? & ? & ? & ? & ? \\
\hline
P3 writes A & ? & ? & ? & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black, top=1mm, bottom=1mm]
\footnotesize
L1 cache hit! Data served directly, no bus traffic.
\end{tcolorbox}
\end{frame}

\begin{frame}{Three-Core MESI Problem -- Step 5}
\mesitwohdr
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.1}
...
\hline
\rowcolor{yellow!20}
P3 reads A & S & S & S & 1 & 1 & 1 & 20 & \textcolor{messageblue}{P3: L1 miss $\to$ L2, L2 hit $\to$ P3 data} \\
\hline
P3 writes A & ? & ? & ? & ? & ? & ? & ? & ? \\
\hline
\end{tabular}
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black, top=1mm, bottom=1mm]
\footnotesize
L2 hit on clean data $\Rightarrow$ no snoop needed. All three now in \textbf{S}.
\end{tcolorbox}
\end{frame}

\begin{frame}{Three-Core MESI Problem -- Step 6}
\mesitwohdr
\begin{table}[h]
\centering
\renewcommand{\arraystretch}{1.1}
...
\hline
\rowcolor{yellow!20}
P3 writes A & I & I & M & 0 & 0 & 1 & 30 & \textcolor{messageblue}{P3: RFO $\to$ L2, L2 snoop invalidate P1+P2, L2 $\to$ P3 grant} \\
\hline
\end{tabular}
}
\end{table}
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black, top=1mm, bottom=1mm]
\footnotesize
S$\to$M requires RFO $\Rightarrow$ L2 invalidates P1+P2. P3 gets exclusive ownership.
\end{tcolorbox}
\end{frame}
...
\begin{frame}{MESI Coherence Problem -- Step 1}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{gray!20}
\# & \textbf{Operation} & \textbf{Messages Sent} & \textbf{Time (ns)} & \textbf{P0} & \textbf{P1} & \textbf{State} \\
\hline
\rowcolor{yellow!20}
1 & P0 reads X1 & \textcolor{messageblue}{P0$\to$L1 miss, L1$\to$L2 read miss, L2$\to$MEM read, MEM$\to$L2 data, L2$\to$L1 data} & \textcolor{timecolor}{226} & 1 & 0 & \cellcolor{stateE}E \\
\hline
2 & P1 writes X3 & ? & ? & ? & ? & ? \\
\hline
3 & P1 writes X4 & ? & ? & ? & ? & ? \\
...
\footnotesize
Cold miss $\Rightarrow$ full memory round-trip. \textbf{E} state since P0 is the only holder.
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Step 2}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
2 & P1 writes X3 & \textcolor{messageblue}{P1$\to$L1 miss, L1$\to$L2 read miss, L2$\to$MEM read, MEM$\to$L2 data, L2$\to$L1 data, write} & \textcolor{timecolor}{226} & 0 & 1 & \cellcolor{stateM}M \\
\hline
3 & P1 writes X4 & ? & ? & ? & ? & ? \\
\hline
4 & P1 writes X5 & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black]
\footnotesize
Cold miss for X3 $\Rightarrow$ fetch from memory, then write locally. \textbf{M} state (dirty).
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Step 3}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
3 & P1 writes X4 & \textcolor{messageblue}{L1 miss, \underline{L1$\to$L2 wb X3}, L1$\to$L2 rd miss, \underline{L2$\to$MEM wb}, L2$\to$MEM rd, MEM$\to$L2, L2$\to$L1, wr} & \textcolor{timecolor}{336} & 0 & 1 & \cellcolor{stateM}M \\
\hline
4 & P1 writes X5 & ? & ? & ? & ? & ? \\
\hline
5 & P0 reads X5 & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black]
\footnotesize
X3/X4 same L1 set $\Rightarrow$ evict X3 (Modified $\Rightarrow$ writeback). \underline{Underlined} = eviction writes.
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Step 4}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
4 & P1 writes X5 & \textcolor{messageblue}{L1 miss, L1$\to$L2 rd miss, \underline{L2$\to$L1 snoop X4}, \underline{L1$\to$L2 data}, \underline{L2$\to$MEM wb}, L2$\to$MEM rd, MEM$\to$L2, L2$\to$L1, wr} & \textcolor{timecolor}{356} & 0 & 1 & \cellcolor{stateM}M \\
\hline
5 & P0 reads X5 & ? & ? & ? & ? & ? \\
\hline
6 & P1 reads X4 & ? & ? & ? & ? & ? \\
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black]
\footnotesize
L2 miss $\Rightarrow$ \textbf{Inclusion}: L2 snoops P1 for X4 (modified), gets writeback. Longest path!
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Step 5}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
5 & P0 reads X5 & \textcolor{messageblue}{P0$\to$L1 miss, L1$\to$L2 rd hit, \textbf{L2$\to$P1 snoop}, \textbf{P1$\to$L2 data}, L2$\to$P0 data} & \textcolor{timecolor}{86} & 1 & 1 & \cellcolor{stateS}S \\
\hline
6 & P1 reads X4 & ? & ? & ? & ? & ? \\
\hline
\end{tabular}
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black]
\footnotesize
L2 hit but P1 has X5 Modified $\Rightarrow$ snoop gets dirty data. Both become \textbf{S}. Shortest path!
\end{tcolorbox}
\end{frame}

\begin{frame}{MESI Coherence Problem -- Step 6}
\scriptsize
\mesiheader
\begin{table}[h]
\centering
...
\hline
\rowcolor{yellow!20}
6 & P1 reads X4 & \textcolor{messageblue}{L1 miss, L1$\to$L2 rd miss, \{L2$\to$P0+P1 snoop, L2$\to$MEM wb X5\}, L2$\to$MEM rd, MEM$\to$L2, L2$\to$P1} & \textcolor{timecolor}{316} & 0 & 1 & \cellcolor{stateE}E \\
\hline
\end{tabular}
}
\end{table}
...
\begin{tcolorbox}[colback=green!5, colframe=green!50!black]
\footnotesize
L1+L2 miss $\Rightarrow$ fetch from memory. X5 evicted from L2 $\Rightarrow$ snoop+writeback. \{braces\} = parallel.
\end{tcolorbox}
\end{frame}
...
\footnotesize
\textbullet~\underline{Underlined}: Eviction writebacks\\
\textbullet~\textbf{Bold}: Modified data snoops\\
