...
\subsection{Question 1: Warmup}

%==========================================
\begin{frame}{Q1: MESI Protocol -- 4 Processors}
\small
Four-processor shared-memory system with MESI protocol.\\
\textbf{Fill in the MESI states and CVB values after each operation:}
...
\hline
P0 reads X & \onslide<2->{E} & \onslide<2->{I} & \onslide<2->{I} & \onslide<2->{I} & \onslide<2->{1000} \\
\hline
P1 reads X & \onslide<3->{S} & \onslide<3->{S} & \onslide<3->{I} & \onslide<3->{I} & \onslide<3->{1100} \\
\hline
P2 reads X & \onslide<4->{S} & \onslide<4->{S} & \onslide<4->{S} & \onslide<4->{I} & \onslide<4->{1110} \\
\hline
P3 writes X & \onslide<5->{I} & \onslide<5->{I} & \onslide<5->{I} & \onslide<5->{M} & \onslide<5->{0001} \\
\hline
P0 reads X & \onslide<6->{S} & \onslide<6->{I} & \onslide<6->{I} & \onslide<6->{S} & \onslide<6->{1001} \\
\hline
\end{tabular}
\end{table}
...
\subsection{Question 2: Coherence}

%==========================================
\begin{frame}{Q2: MESI Coherence -- Setup}
...
\subsection{Question 3: Coherence}

%==========================================
\begin{frame}{Q3: MESI Coherence -- Setup}
\footnotesize
\textbf{System Configuration:}
\begin{itemize}
...
\subsection{Question 4: TSO}

%==========================================
\begin{frame}{Q4: Total Store Order}
\small
...
\subsection{Question 5: Release-Consistency}
...
%==========================================
\begin{frame}{Q5: Release-Consistency}
\small
...
%==========================================
\begin{frame}{Q5: Release-Consistency -- Solution}
...
%==========================================
\begin{frame}{Q5: Release-Consistency -- Hardware Intuition}
