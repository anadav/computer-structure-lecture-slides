...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=4, NL=0, Lh=1, Rh=2, w=0.5},
        external pins width=0, below=2mm of tlblabel, font=\tiny] 
...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=8, NL=1, Lh=1, Rh=3, w=0.5},
        below=2mm of cachelabel, external pins width=0, font=\tiny]
