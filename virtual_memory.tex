...
\foreach \way in {0,...,3} {
    ...
    \draw[arrow] (tlbcomp-\way.south) |- (tlbmux.pin \muxpin);
...
\foreach \way in {0,...,3} {
    \pgfmathtruncatemacro{\muxpin}{\way + 1}
    \draw[arrow, gray] (tlbval-1-\way.south) -- ++(0,-0.3) -| ([xshift={-0.3 + 0.2*\way}cm]tlbmux.north);
}
...
\foreach \way in {0,...,3} {
    \pgfmathtruncatemacro{\muxpin}{\way + 1}
    \draw[arrow] (ccomp-\way.south) |- (cachemux.pin \muxpin);
    % Connect to OR gate for hit detection
    \pgfmathtruncatemacro{\inputnum}{\way + 1}
...
\foreach \way in {0,...,3} {
    \pgfmathtruncatemacro{\muxpin}{\way + 1}
    \draw[arrow, gray] (cdata-1-\way.south) -- ++(0,-0.3) -| ([xshift={-0.3 + 0.2*\way}cm]cachemux.north);
}
