...
\begin{tikzpicture}[scale=0.65]
    % TLB structure
    \node[font=\small, above] at (3,4.5) {TLB Set Selection};
    
    % Virtual address
    \draw[thick] (0,3.5) rectangle (6,4);
    \fill[orange!20] (0,3.5) rectangle (3.5,4);
    \fill[yellow!20] (3.5,3.5) rectangle (4.8,4);
    \fill[gray!20] (4.8,3.5) rectangle (6,4);
    
    \node[font=\tiny] at (1.75,3.75) {VPN upper bits};
    \node[font=\tiny] at (4.15,3.75) {Set};
    \node[font=\tiny] at (5.4,3.75) {Offset};
    
    % Arrow to TLB
    \draw[->, thick] (4.15,3.5) -- (4.15,2.8);
    \node[right, font=\tiny] at (4.3,3.15) {Selects set};
    
    % TLB array (4-way set associative)
    \node[font=\small] at (3,2.5) {TLB Set};
    \foreach \way in {0,...,3} {
        \pgfmathsetmacro\y{2 - \way*0.5}
    ...
    % Comparison logic
    \draw[thick, dashed] (0,-0.5) rectangle (3.5,-1);
    \node[font=\tiny] at (1.75,-0.75) {Compare: PCID + TAG};
    
    % Current PCID from CR3
    \draw[thick] (0,-1.5) rectangle (0.8,-1.9);
    \fill[blue!20] (0,-1.5) rectangle (0.8,-1.9);
    \node[font=\tiny] at (0.4,-1.7) {PCID};
    \node[right, font=\tiny] at (0.9,-1.7) {from CR3};
    
    % VPN tag
    \draw[thick] (2.5,-1.5) rectangle (3.5,-1.9);
    \fill[orange!20] (2.5,-1.5) rectangle (3.5,-1.9);
    \node[font=\tiny] at (3,-1.7) {TAG};
    \node[right, font=\tiny] at (3.6,-1.7) {from VA};
    ...
    % Hit/Miss decision
    \node[font=\tiny] at (1.75,-2.3) {Hit if: (PCID match) AND (TAG match)};
\end{tikzpicture}
\end{center}
