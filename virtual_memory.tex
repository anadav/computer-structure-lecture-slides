...
\node[or port, scale=0.4, below right=3mm and 2mm of tlbcomp-1] (tlbor) {};
...
\node[or port, scale=0.4, below right=3mm and 2mm of ccomp-1] (cacheor) {};
...
\foreach \way in {0,...,3} {
    ...
    \draw (tlbcomp-\way.south) -- ++(0,-0.1) -| (tlbor.in \way);
}
...
\foreach \way in {0,...,3} {
    ...
    % Connect to OR gate for hit detection
    \draw (ccomp-\way.south) -- ++(0,-0.1) -| (cacheor.in \way);
}
