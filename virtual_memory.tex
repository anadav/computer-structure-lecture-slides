...
\begin{tikzpicture}[scale=0.9]
    ...
    \definecolor{usercolor}{RGB}{255,255,200}
    ...
    \foreach \i in {0, 1, 2} {
        \begin{scope}[shift={({\i*(\procwidth+\spacing)},0)}]
            ...
            % User space (bottom)
            \fill[usercolor] (0,0) rectangle (\procwidth,\procheight-\kernelheight);
            
            % Labels
            \node at (\procwidth/2, \kernelcenter) {\small Kernel Space};
            \node at (\procwidth/2, \usercenter) {\small User Space};
