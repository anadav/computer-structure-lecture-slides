...
\node[or port, scale=0.4, number inputs=2, rotate=-90, below=8mm of tlbcomp-0] (tlbor) {};

% TLB Way MUX - positioned to match width of value table (2 ways)
\node[muxdemux, muxdemux def={NT=2, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.3, w=1.0}, rotate=180] 
    (tlbmux) at ([yshift=-10mm, xshift=2mm]tlbval-3-0.south east) {};
\node[font=\tiny, rotate=180] at (tlbmux) {Way MUX};
...
\node[muxdemux, muxdemux def={NT=4, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.3, w=2.0}, rotate=180] 
    (cachemux) at ([yshift=-10mm, xshift=4mm]cdata-7-1.south east) {};
\node[font=\tiny, rotate=180] at (cachemux) {Way MUX};
...
\begin{scope}[on background layer]
    \node[bgbox, fill=blue!5, fit=(tlbdec)(tlbtag-0-0)(tlbval-3-1)(tlbcomp-0)(tlbcomp-1)(tlbor)(tlbmux)] (tlbbg) {};
\end{scope}
...
% TLB values to mux - direct connection from each way to corresponding position
\foreach \way in {0,...,1} {
    \draw[arrow, gray] (tlbval-3-\way.south) -- ++(0,-0.8) -| (tlbval-3-\way.south |- tlbmux.north);
}
...
% Cache data to mux - direct connection from each way to corresponding position
\foreach \way in {0,...,3} {
    \draw[arrow, gray] (cdata-7-\way.south) -- ++(0,-0.8) -| (cdata-7-\way.south |- cachemux.north);
}
