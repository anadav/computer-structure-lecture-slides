...
% TLB Tag array (4 sets x 4 ways) - relative to decoder right pins
...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=4, NL=0, Lh=0.3, Rh=1.2, w=0.5}, below=2mm of cachelabel] 
    (cachedec) {};
\node[font=\tiny] at (cachedec) {\rotatebox{90}{Dec}};
...
% Connections
% VPN set to TLB decoder (to top pin)
\draw[arrow] (vset.south) -- ++(0,-0.5) -| (tlbdec.btpin 1);
...
\draw[arrow, orange, thick] (pset.south) -- ++(0,-0.3) -| (cachedec.btpin 1);
