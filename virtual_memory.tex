...
\node[muxdemux, muxdemux def={NT=2, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.8, w=1.0}, external pins width=0, anchor=btpin 1] 
...
\node[muxdemux, muxdemux def={NT=4, NB=1, NL=0, NR=0, Lh=0.3, Rh=1.0, w=2.0}, external pins width=0, anchor=btpin 1] 
...
\foreach \way in {0,...,1} {
    ...
    \draw[arrow, gray] (tlbval-3-\way.south) -- ++(0,-0.3) -| (tlbmux.btpin \muxpin);
}
