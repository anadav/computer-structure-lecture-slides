...
\begin{tikzpicture}[
    ...
    oval/.style={ellipse, draw, thick, minimum width=1cm, minimum height=0.8cm, text centered, font=\tiny},
    arrow/.style={->, thick}]
    \tiny
    % Nodes
    \node[oval, align=center] (va) at {Virtual Address};
    \node[box, align=center, below=of va] (tlb) {TLB Access};
    \node[decision, below=of tlb] (hit) at (0,2.8) {TLB Hit?};
    \node[box, fill=yellow!10, align=center, left=of hit, text width=1.5cm] (pmh) {PMH gets PTE from Page Table in memory};
    \node[box, align=center, below=of pmh] (insert) {Insert PTE into TLB (may need a victim)};
    \node[oval, align=center,below=of hit] (pa) at (2.5,0.8) {Physical Addresses};
