...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=8, NL=1, Lh=1, Rh=3, w=0.5},
        external pins width=0, below right=10mm and 10mm of pset, font=\tiny]
...
% Cache background
\begin{scope}[on background layer]
    \node[bgbox, fill=green!5, fit=(cachelabel)(cachedec)(ctag-0-0)(cdata-7-3)(ccomp-0)(ccomp-3)(cacheor)(cachemux)] (cachebg) {};
\end{scope}
