...
% OR gate for TLB hit/miss - rotated downward
\node[or port, scale=0.4, number inputs=4, rotate=-90, below=3mm of tlbcomp-1] (tlbor) {};

% TLB Way MUX - rotated with wide part up
\node[muxdemux, muxdemux def={NT=4, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.3, w=0.6}, rotate=180, below=8mm of tlbval-3-2] 
    (tlbmux) {};
...
% OR gate for cache hit/miss - rotated downward
\node[or port, scale=0.4, number inputs=4, rotate=-90, below=3mm of ccomp-1] (cacheor) {};

% Cache Way MUX - rotated with wide part up
\node[muxdemux, muxdemux def={NT=4, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.3, w=0.6}, rotate=180, below=8mm of cdata-3-2] 
    (cachemux) {};
...
% TLB values to mux (also to top inputs after rotation)
\foreach \way in {0,...,3} {
    \pgfmathtruncatemacro{\muxpin}{\way + 1}
    \draw[arrow, gray] (tlbval-1-\way.south) -- ++(0,-0.2) -| (tlbmux.pin \muxpin);
}
...
% Cache data to mux (also to top inputs after rotation)
\foreach \way in {0,...,3} {
    \pgfmathtruncatemacro{\muxpin}{\way + 1}
    \draw[arrow, gray] (cdata-1-\way.south) -- ++(0,-0.2) -| (cachemux.pin \muxpin);
}
