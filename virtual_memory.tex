...
\begin{tikzpicture}[scale=0.75]
    % Define styles
    \tikzset{
        tlbentry/.style={draw, thick, minimum height=0.4cm},
    ...
    % CR3/ASID register
    \node[draw, thick, fill=blue!20, minimum width=1.5cm, minimum height=0.5cm] 
        (cr3) at (-4,2) {ASID};
    \node[below=1mm of cr3, font=\tiny] {from CR3/PTBR};
    ...
    \matrix[matrix of nodes, nodes={tlbentry, minimum width=1cm}, 
            column sep=-\pgflinewidth, row sep=3mm,
            font=\tiny] (tlb) at (0,1) {
    ...
    \foreach \way in {0,...,3} {
        ...
        % ASID connections
        \draw[->] (cr3.east) -| ([xshift=-0.2cm]asidcomp\way.west);
