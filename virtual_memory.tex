...
\node[or port, scale=0.4, number inputs=2, rotate=-90, below=8mm of tlbcomp-0, external pins width=0, anchor=bin 2] (tlbor) {};
...
\node[addr, fill=yellow!30, minimum width=0.8cm, below=of cachemux.blpin 1] (dataout) {Data};
