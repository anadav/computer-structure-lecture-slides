...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=4, NL=0, Lh=1, Rh=2, w=0.5}, external pins width=0, below=2mm of tlblabel] 
    (tlbdec) {};
...
\node[muxdemux, muxdemux def={NB=0, NT=1, NR=8, NL=0, Lh=1, Rh=3, w=0.5}, below=2mm of cachelabel, external pins width=0] 
    (cachedec) {};
...
\node[comp, anchor=north] at ([yshift=-3mm]ctag-7-0.south) (ccomp-0) {=};
\foreach \way in {1,...,3} {
    \node[comp, anchor=north] at ([yshift=-3mm]ctag-7-\way.south) (ccomp-\way) {=};
}
...
\node[muxdemux, muxdemux def={NT=4, NB=1, NL=0, NR=0, Lh=0.3, Rh=0.3, w=1.2}, rotate=180, below=10mm of cdata-7-2] 
    (cachemux) {};
...
% Cache background
\begin{scope}[on background layer]
    \node[bgbox, fill=green!5, fit=(cachedec)(ctag-0-0)(cdata-7-3)(ccomp-0)(ccomp-3)(cacheor)(cachemux)] (cachebg) {};
\end{scope}
