...
\node[comp, anchor=north] at (tlbtag-3-0.south) (tlbcomp-0) {=};
\foreach \way in {1,...,1} {
...
\node[or port, scale=0.4, number inputs=2, rotate=-90, below=of tlbcomp-0, external pins width=0, anchor=bin 2] (tlbor) {};
